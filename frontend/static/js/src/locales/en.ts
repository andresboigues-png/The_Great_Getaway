...
export const en = {
    ...
    settings: {
        ...
        devTraffic: 'Traffic',
        devTrafficNote: 'Anonymous — no personal data, hashed IPs, no third-party trackers.',
        devTrafficEmpty: 'No visits logged yet.',
        devUniqueVisitors: 'Unique visitors',
        devTotalVisits: 'Total visits',
        devUnique7d: 'Unique (7d)',
        devUnique30d: 'Unique (30d)',
        devWhen: 'Visits over 30 days',
        devReferrers: 'Where they came from',
        devDevices: 'Devices',
        devRegions: 'Region (approx.)',
        devBrowsers: 'Browsers',
        ...
        poiColCategory: 'Category',
        poiColAnchor: 'Search anchor',
        poiColRating: 'Min. rating',
        poiColStatus: 'Status',
        poiColShow: 'On Home',
        poiExplainAnchor: 'Picks where each pill searches from. Day-aware uses the day you\'ve set as search center on the Home page (falls back to the trip\'s anchor pin). Trip-wide always anchors on the anchor pin so the 50 km wide search covers the whole trip — better for sparse categories like Medical, Sports, Govt, Schools, Public transit.',
        poiExplainRating: 'Hides results below the chosen ★. Restaurants and Hotels default to 4★+ (rating is a meaningful quality signal there); the rest default to "Any rating".',
        poiExplainShow: 'The right-side switch toggles whether each pill appears in the home map\'s pill row. Useful for hiding categories you never use so the row stays compact.',
    ...
    profile: {
        ...
        quotesEmptyOwn: 'No memories yet. When someone shares one about you, it shows up here for you to feature.',
        quotesEmptyVisitor: 'No memories of {name} yet — be the first to share one.',
        quotesError: "Couldn't load memories.",
        quotesHiddenBadge: 'Hidden',
        quotesShow: 'Show',
        quotesHide: 'Hide',
        quotesDelete: 'Delete',
        ...
        memFocusHint: 'Show every {dim} link',
        memFocusNone: 'No {dim} links across groups',
        visibilityLabel: 'Profile visibility',
        visibilityPublic: 'Public',
        visibilityPrivate: 'Private',
        visibilityPublicHint: 'Anyone can find and view your profile',
        visibilityPrivateHint: 'Only you and your followers can find and view your profile',
        visibilityNowPublic: 'Your profile is now public',
        visibilityNowPrivate: 'Your profile is now private',
        ...
        memNoTrip: 'No trip',
        memYearField: 'Year',
        memLinkTrip: 'Link a trip',
        memCommonTripsTitle: 'Shared trips',
        memNoCommonTrips: 'No trips in common yet',
    ...
    search: {
        ...
        featAddDay: 'Add a day',
        featAddExpense: 'Add an expense',
        featAi: 'AI trip planner',
        featBudgets: 'Budgets',
        featInsights: 'Insights',
        featSettlement: 'Settle up',
        featTodo: 'To-do list',
        featTemplates: 'Templates & Discover',
        featCollections: 'Saved trips',
        featCompanions: 'Companions & invites',
        featShare: 'Share trip',
        featFeed: 'Feed',
        featFriends: 'Friends',
        featSettings: 'Settings',
        featPersonalization: 'Theme & language',
        searching: 'Searching…',
        // Row fallbacks.
    ...
    collections: {
        ...
        sortDaysDesc: 'Longest (most days)',
    ...
    transport: {
        ...
        mode_flight: 'Flight',
        mode_mixed: 'Mixed',
        modalTitle: 'Day {n} — getting around',
        ...
        dailyLabel: 'Getting around each day',
        accommodation: 'Accommodation',
        destination: 'Destination',
        carFromArrival: 'Where are you coming from?',
        carFromDeparture: 'Where are you going?',
        seeRoute: 'See route',
    ...
    tripHub: {
        ...
        transportLabel: 'Getting around',
        transportEmpty: 'No transport set yet — set it on a day card in Your Path.',
        transportDaySingle: 'Day {n}',
        transportDayRange: 'Days {from}–{to}',
        transportSuggestBtn: 'Suggest',
        transportRefineBtn: 'Refine with AI',
        transportSuggestDone: {
            one: 'Transport suggested for {count} day',
            other: 'Transport suggested for {count} days',
        },
        transportSuggestNone: 'Nothing to suggest — days are set or lack places.',
        transportRefineCap: 'Daily AI limit reached. Try again tomorrow.',
        transportRefineFail: "Couldn't get AI suggestions — try again later.",
    ...
    pathTab: {
        ...
        transportNotSet: 'No transport set',
    ...
    companions: {
        ...
        pickerIntro: "Everyone travelling on <strong>{trip}</strong>. Add a friend (they get a trip invite) or just a name for someone who isn't on the app.",
        pickerEmpty: 'No companions on this trip yet. Add a friend or a name below.',
        addSectionTitle: 'Add someone',
        addPathFriendTitle: 'Someone on the app',
        addPathFriendHint: 'Pick a friend to invite. Only friends who follow you back show here — add them on the Friends page first.',
        addPathNameTitle: 'Just a name',
        addPathNameHint: "For a traveller who isn't on the app — track their share now, link them to an account later.",
        addFriendBtn: 'Choose friend',
        addInputPlaceholder: 'Name (e.g. Alex)',
        addBtn: 'Add',
        ...
        rowUnlinkBtn: 'Unlink',
        pillYouText: 'You',
        linkMeBtn: 'This is me',
        linkSheetTitle: 'Link to a person',
        ...
        cardCtaEdit: 'Edit travel companions',
    ...
    tripActions: {
        ...
        download: 'Download trip (PDF or ZIP)',
    ...
    dayDetail: {
        ...
        editDayAria: 'Edit day name and date',
        editDayTitle: 'Edit day',
        editDayNameLabel: 'Day name',
        ...
        editNote: 'Edit',
        doneEditing: 'Done',
        notesEmptyHint: 'Nothing planned yet — tap Edit to add.',
        addNote: 'Add note',
        blockDrag: 'Drag to reorder',
        blockUp: 'Move up',
        blockDown: 'Move down',
        photosHeading: 'Photos',
        documentsHeading: 'Documents',
        photosEmpty: 'No photos for this day yet.',
        documentsEmpty: 'No documents for this day yet.',
    ...
    tripMedia: {
        ...
        docsEmptyBody: 'Click <strong>Search Gmail for bookings</strong> to find your confirmation emails, then drop the PDFs / links in via <strong>Add document</strong>. Trip-wide docs (passport, multi-day hotel) live on <strong>Trip-wide</strong>; day-specific ones (museum ticket) tag to a numbered day.',
        docsBucketUnsorted: 'Unsorted',
        docsBucketAnchorTripWide: 'Trip-wide',
        ...
        photosEmptyBody: 'Use <strong>Upload photos</strong> for files on your device, or <strong>Add by link</strong> for a Drive / Dropbox / iCloud share. New photos go to <strong>Trip-wide</strong> (the trip-wide bucket); you can re-tag any of them to a specific day from the dropdown on each card.',
        photosMoveTitle: 'Move to Trip-wide or a numbered day',
        ...
        addDocOptionAnchor: 'Trip-wide (passport, multi-day hotel, return flight…)',
    ...
    modals: {
        ...
        downloadChooserTitle: 'Download trip',
        downloadChooserSubtitle: 'Choose a format',
        downloadChooserCancel: 'Cancel',
        downloadPdfOption: 'PDF document',
        downloadPdfOptionBody: 'A printable plan to share or keep.',
        downloadZipOption: 'ZIP backup',
        downloadZipOptionBody: 'Everything in this trip — re-importable later.',
        downloadZipStatus: 'Preparing…',
        downloadZipError: 'Couldn’t export this trip.',
        newTripImport: 'Import a file',
        importTripStatus: 'Importing…',
        importTripError: 'Couldn’t import this file.',
        importTripTooLarge: 'That file is too large to import.',
    ...
    upload: {
        ...
        splitsCalloutLabel: 'Splits & settlements',
