...
export const en = {
    ...
    profile: {
        ...
        quotesTab: 'Quotes',
        quotesPlaceholder: 'Leave a quote about {name}…',
        quotesPost: 'Post quote',
        quotesPosted: 'Quote sent — {name} can choose to show it.',
        quotesEmptyOwn: 'No quotes yet. When someone leaves one about you, it shows up here for you to approve.',
        quotesEmptyVisitor: 'No quotes about {name} yet — be the first.',
        quotesError: "Couldn't load quotes.",
        quotesHiddenBadge: 'Hidden',
        quotesShow: 'Show',
        quotesHide: 'Hide',
        quotesDelete: 'Delete',
        quotesDeleteTitle: 'Delete quote?',
        quotesDeleteBody: 'This removes the quote for good.',
