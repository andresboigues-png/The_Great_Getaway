import{r as e}from"./rolldown-runtime-C3V63i2j.js";import{r as t,t as n}from"./vendor-react-BRKukhy3.js";import{Bt as r,Ft as i,Gt as a,Jt as o,Nt as s,Ot as c,Pt as l,Rt as u,Vt as d,Wt as f,Xt as p,Yt as m,b as h,it as g,jt as _,k as v,kt as y,tn as b,w as x,y as S}from"../app.bundle.js";import{t as C}from"./store-D4jHeVDp.js";import{n as w}from"./TripContext-lcm1CHgX.js";var T=e(t(),1);function E(e,t,n){let r=m(n,t.fromUserId)?.name,i=m(n,t.toUserId)?.name;if(!r||!i||e[r]===void 0||e[i]===void 0)return;let a=t.euroValue||t.amount||0;e[r]+=a,e[i]-=a}function D(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(f.expenses||[]).filter(t=>t.tripId===e.id),n=p(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i={};r.forEach(e=>i[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]!==void 0&&(i[e.who]+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t||0),0),r=n>0?n:100;for(let[n,a]of Object.entries(e.splits))i[n]!==void 0&&(i[n]-=t*(Number(a)/r))}else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]!==void 0&&(i[t]-=e)})}}let a=(f.settlements||[]).filter(t=>t.tripId===e.id);for(let t of a)E(i,t,e);return{balances:i,roster:r,expenses:t}}function O(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function k(){let e={};for(let t of[...f.trips,...f.archivedTrips||[]])for(let n of p(t))n in e||(e[n]=0);let t=(f.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...f.expenses,...t],r={};for(let e of[...f.trips,...f.archivedTrips||[]])r[e.id]=p(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}let i=new Map;for(let e of[...f.trips,...f.archivedTrips||[]])i.set(e.id,e);for(let t of f.settlements||[]){let n=i.get(t.tripId);n&&E(e,t,n)}return e}function A(e){if(!e)return[];let t=(f.expenses||[]).filter(t=>t.tripId===e.id),n=p(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function j(e){let t=0,n=0;for(let r of f.expenses||[])r.tripId===e&&r.isSettlement&&(t+=1,n+=r.euroValue||0);for(let r of f.settlements||[])r.tripId===e&&(t+=1,n+=r.euroValue||r.amount||0);return{count:t,eurTotal:n}}function M(e,t,n,r){let i=n===`global`?``:N(r),a=`
    ...
    `:`
        ...
        `}function N(e){if(f.trips.length===0)return``;let t=f.trips.find(t=>t.id===e),n=t?j(t.id).eurTotal:0,i=f.trips.map(t=>{let n=j(t.id).eurTotal,i=n>0?` — ${r(n,`EUR`)} ${S(`settlement.settledSuffix`)}`:``;return`<option value="${_(t.id)}"${t.id===e?` selected`:``}>${_(t.name)}${i}</option>`}).join(``);return`
    ...
    `}function F(e,t){let{balances:n}=D(e),i=O(n),a=A(e),o=a.reduce((e,t)=>e+t.paid,0),s=[...a].sort((e,t)=>t.paid-e.paid)[0],c=[...a].sort((e,t)=>e.net-t.net)[0],l=[...a].sort((e,t)=>t.net-e.net)[0],u=_(e?.name||`Trip`),d=o>0?`
            ...
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                ...
                ${s?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${_(s.name)}</div>
                ...
                ${l&&l.net>.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${_(l.name)}</div>
                ...
                ${c&&c.net<-.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${_(c.name)}</div>
    ...
    `:``,f=Object.entries(n).map(([e,t])=>{let n=t>.01,i=t<-.01;return`
            <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                ...
                <div style="flex:1; min-width:0; font-weight:800; color: var(--text-brand-navy); font-size:0.95rem; overflow:hidden; text-overflow:ellipsis;">${_(e)}</div>
            ...
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:16px;">
                <div class="stl-flex-grow-truncate">
                    <div class="stl-flex-row-wrap-6">
                        ...
                        <span class="stl-heading-3">${_(n.to)}</span>
                    </div>
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:18px; margin-bottom:24px;">
            ...
            <div class="card glass stl-card-major">
                <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:12px; margin-bottom:14px;">
                    ...
                    <span class="stl-section-label--shrink-0">${h(`settlement.paymentsCount`,i.length)}</span>
                </div>
                ...
                ${l.map(n=>{let a=i[n],o=a.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                <h4 style="margin:0; font-size:0.7rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary);">${_(c(n))}</h4>
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${h(`settlement.historyDayTotalPlural`,a.length,{amount:r(o,`EUR`)})}</span>
                            </div>
                            <div class="stl-flex-col-8">
                                ${a.map(n=>{let i=(n.who||`?`).charAt(0).toUpperCase(),a=n.method&&n.source===`settlement`?`<span style="display:inline-flex; align-items:center; gap:3px; background:rgba(0,113,227,0.08); color:var(--accent-blue-deep); padding:1px 8px; border-radius:999px; font-size:0.62rem; font-weight:700; text-transform:uppercase; letter-spacing:0.05em;">${_(n.method.replace(/_/g,` `))}</span>`:``,o=n.note&&n.source===`settlement`?`<div style="font-size:0.78rem; color:var(--text-secondary); margin-top:4px; font-style:italic;">"${_(n.note)}"</div>`:``,s=t&&n.source===`expense`?`<button class="edit-settlement-btn" data-settlement-id="${_(n.id)}" type="button"
                                                style="background:rgba(0,113,227,0.08); border:1px solid rgba(0,113,227,0.22); color: var(--accent-blue-deep); padding:5px 12px; border-radius:999px; font-size:0.72rem; font-weight:800; cursor:pointer;">${S(`settlement.historyEditBtn`)}</button>`:``,c=t?`<button class="unsettle-settlement-btn" data-settlement-id="${_(n.id)}" data-source="${_(n.source)}" data-trip-id="${_(e.id)}" type="button"
                                        ...
                                        <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                                            <div style="width:34px; height:34px; border-radius:50%; background:rgba(52,199,89,0.12); color:#1a6b3c; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:0.95rem; flex-shrink:0;">${_(i)}</div>
                                            <div class="stl-flex-grow-truncate">
                                                <div class="stl-flex-row-wrap-6">
                                                    <span class="stl-heading-3">${_(n.who)}</span>
    ...
    `}function R(){let e=k(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),i=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
                ...
                ${t.map(([e,t])=>{let a=i?Math.min(Math.abs(t)/n*100,100):0,o=t>.01,s=t<-.01,c=o?`#1a6b3c`:s?`#a30000`:`var(--text-secondary)`;return`
                        <div style="display:flex; flex-direction:column; gap:10px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                            <div style="display:flex; align-items:center; gap:14px;">
                                ...
                                <div style="flex:1; min-width:0; font-weight:800; color: var(--text-brand-navy); font-size:0.95rem; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">${_(e)}</div>
                        ...
                        <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:16px;">
                            <div class="stl-flex-grow-truncate">
                                <div class="stl-flex-row-wrap-6">
                                    ...
                                    <span style="color:rgba(0,0,0,0.3);">→</span>
                                    <span class="stl-heading-3">${_(e.to)}</span>
                                </div>
        ...
        `:``}
    `}async function z(e,t,n,c,l,d){if(t===n){i(S(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(c)||c<=0){i(S(`settlement.toastAmountInvalid`));return}let p=u(c,l,`EUR`),m=f.trips.find(t=>t.id===e),h=o(m,t)?.linkedUserId,g=o(m,n)?.linkedUserId;if(h&&g){let o=await x({tripId:e,fromUserId:h,toUserId:g,amount:c,currency:l,euroValue:p,...d?.method?{method:d.method}:{},...d?.note?{note:d.note}:{}});o.settlement?(f.settlements.push(o.settlement),a(b.STATE_CHANGED),i(`Recorded ${r(p,`EUR`)} ${t} → ${n} · notified ${n}`)):(console.warn(`[settlement] /api/settlements failed:`,o.error),i(`Settlement failed: ${o.error||`Network error`}`),a(b.STATE_CHANGED));return}let _={id:s(),tripId:e,label:S(`settlement.settlementLabel`,{from:t,to:n}),value:c,euroValue:p,currency:l,who:t,categoryId:f.categories[0]?.id??``,country:S(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};f.expenses.push(_),a(b.STATE_CHANGED),i(`Recorded ${r(p,`EUR`)} ${t} → ${n}`)}async function B(e,t=`expense`){c({title:S(`settlement.toastUnsettleConfirmTitle`),message:S(`settlement.toastUnsettleConfirmMessage`),confirmText:S(`settlement.toastUnsettleConfirmBtn`),onConfirm:async()=>{if(t===`settlement`){let t=await v(e);if(t.error){console.warn(`[settlement] delete failed:`,t.error),i(`Couldn't undo: ${t.error||`Network error`}`);return}f.settlements=f.settlements.filter(t=>t.id!==e),a(b.STATE_CHANGED);return}f.expenses=f.expenses.filter(t=>t.id!==e),a(b.STATE_CHANGED)}})}var V=[{value:`cash`,labelKey:`settlement.methodCash`},{value:`revolut`,labelKey:`settlement.methodRevolut`},{value:`bank_transfer`,labelKey:`settlement.methodBankTransfer`},{value:`wise`,labelKey:`settlement.methodWise`},{value:`paypal`,labelKey:`settlement.methodPayPal`},{value:`custom`,labelKey:`settlement.methodCustom`}];function H(e){let t=p(f.trips.find(t=>t.id===e)).map(e=>`<option value="${_(e)}">${_(e)}</option>`).join(``),n=V.map(e=>`<option value="${_(e.value)}">${_(S(e.labelKey))}</option>`).join(``),r=d(),{root:a,close:o}=y({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                <label class="form-label">${_(S(`settlement.labelFrom`))}</label>
                <select id="manualSettleFrom" class="glass-input stl-card-minor-bg">${t}</select>
                <label class="form-label stl-mt-6">${_(S(`settlement.labelTo`))}</label>
                <select id="manualSettleTo" class="glass-input stl-card-minor-bg">${t}</select>
                <label class="form-label stl-mt-6">${_(S(`settlement.labelAmount`,{currency:r}))}</label>
                ...
                <label class="form-label stl-mt-6">${_(S(`settlement.labelMethod`))}</label>
                <select id="manualSettleMethod" class="glass-input stl-card-minor-bg">${n}</select>
                <label class="form-label stl-mt-6">${_(S(`settlement.labelNote`))} <span class="text-subtitle" style="font-weight:500;">${_(S(`settlement.labelNoteOptional`))}</span></label>
                <input type="text" id="manualSettleNote" class="glass-input" maxlength="240" placeholder="${_(S(`settlement.notePlaceholder`))}" class="stl-card-minor">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
                    <button type="button" id="cancelManualSettleBtn" class="btn-neutral" style="flex:1; border-radius: var(--radius-lg);">${_(S(`settlement.cancelBtn`))}</button>
                    <button type="submit" class="btn-primary" style="flex:2; border-radius: var(--radius-lg);">${_(S(`settlement.recordPaymentBtn`))}</button>
                </div>
            </form>
        `});l(a,`#cancelManualSettleBtn`).onclick=()=>o(),l(a,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let n=l(a,`#manualSettleFrom`).value,s=l(a,`#manualSettleTo`).value,c=parseFloat(l(a,`#manualSettleAmount`).value),u=l(a,`#manualSettleMethod`).value,d=l(a,`#manualSettleNote`).value.trim();if(n===s){i(S(`settlement.toastSenderEqualsReceiver`));return}z(e,n,s,c,r,{method:u,note:d}),o()}}function U(e){let t=f.expenses.find(t=>t.id===e);if(!t)return;let n=p(f.trips.find(e=>e.id===t.tripId)),r=n.map(e=>`<option value="${_(e)}" ${t.who===e?`selected`:``}>${_(e)}</option>`).join(``),o=Object.keys(t.splits||{})[0],s=n.map(e=>`<option value="${_(e)}" ${o===e?`selected`:``}>${_(e)}</option>`).join(``),c=d(),{root:m,close:h}=y({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label stl-mt-6">${_(S(`settlement.labelAmount`,{currency:c}))}</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${u(t.euroValue||0,`EUR`,c).toFixed(2)}" class="glass-input" required class="stl-card-minor">
                <label class="form-label stl-mt-6">${_(S(`settlement.labelDate`))}</label>
                <input type="date" id="editSettleDate" value="${_(t.date||``)}" class="glass-input" required class="stl-card-minor">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
                    <button type="button" id="cancelEditSettleBtn" class="btn-neutral" style="flex:1; border-radius: var(--radius-lg);">${_(S(`settlement.cancelBtn`))}</button>
                    <button type="submit" class="btn-primary" style="flex:2; border-radius: var(--radius-lg);">${_(S(`settlement.updateBtn`))}</button>
                </div>
            </form>
        `});l(m,`#cancelEditSettleBtn`).onclick=()=>h(),l(m,`#editSettlementForm`).onsubmit=e=>{e.preventDefault();let n=l(m,`#editSettleFrom`).value,r=l(m,`#editSettleTo`).value,o=parseFloat(l(m,`#editSettleAmount`).value),s=l(m,`#editSettleDate`).value;if(n===r){i(S(`settlement.toastSenderEqualsReceiver`));return}t.who=n,t.splits={[r]:100},t.value=o,t.currency=c,t.euroValue=u(o,c,`EUR`),t.date=s,t.label=S(`settlement.settlementLabel`,{from:n,to:r}),a(b.STATE_CHANGED),h()}}var W=n();function G(){let e=C(e=>e.trips),t=C(e=>e.activeTripId),n=C(e=>e.expenses),[r,i]=(0,T.useState)(`trip`),[o,s]=(0,T.useState)(()=>t||(e.length>0?e[0].id:null));(0,T.useEffect)(()=>{t&&t!==o&&s(t)},[t,o]),(0,T.useEffect)(()=>{if(o&&!e.find(e=>e.id===o)){let t=e.length>0?e[0].id:null;s(t),t&&(f.activeTripId=t,a(b.STATE_CHANGED))}},[e,o]);let c=e=>{s(e),f.activeTripId=e,a(b.STATE_CHANGED),r===`global`&&i(`trip`)},{trip:l,canEditExpenses:u}=w(o),d=(0,T.useMemo)(()=>M(l,u,r,o),[l,u,r,o,n]),p=(0,T.useRef)(null),m=e=>{let t=e.target;if(!t)return;let n=t.closest(`.settlement-trip-pill`);if(n?.dataset.tripId){c(n.dataset.tripId);return}let r=t.closest(`.settle-tab`);if(r?.dataset.tab){i(r.dataset.tab);return}let a=t.closest(`.settle-debt-btn`);if(a?.dataset.tripId&&a.dataset.from&&a.dataset.to&&a.dataset.amount&&!a.disabled){a.disabled=!0,a.textContent=S(`settlement.recordingBtn`),z(a.dataset.tripId,a.dataset.from,a.dataset.to,parseFloat(a.dataset.amount),`EUR`);return}let o=t.closest(`.open-manual-settle-btn`);if(o?.dataset.tripId){H(o.dataset.tripId);return}let s=t.closest(`.edit-settlement-btn`);if(s?.dataset.settlementId){U(s.dataset.settlementId);return}let l=t.closest(`.unsettle-settlement-btn`);if(l?.dataset.settlementId){let e=l.dataset.source===`settlement`?`settlement`:`expense`;B(l.dataset.settlementId,e);return}},h=(0,T.useRef)(c);return h.current=c,(0,T.useEffect)(()=>{let e=p.current;if(!e)return;let t=e=>{let t=e.target;if(t?.id===`settlementTripSelect`){let e=t;e.value&&h.current(e.value)}};return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,W.jsx)(`div`,{ref:p,onClick:m,dangerouslySetInnerHTML:{__html:d}})}function K(e){g(e,(0,T.createElement)(G))}export{K as mountSettlement};
//# sourceMappingURL=mount-DkddmwYo.js.map