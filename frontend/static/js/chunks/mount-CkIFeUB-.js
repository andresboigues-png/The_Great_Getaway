import{r as e,t}from"./vendor-react-CAxw18f3.js";import{G as n,Q as r,X as i,Y as a,et as o,ft as s,it as c,lt as l,mt as u,n as d,nt as f,ot as p,st as m,t as h,tt as g,ut as _,w as v}from"../app.bundle.js";import{t as y}from"./store-BMbsv_2J.js";var b=e();function x(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(l.expenses||[]).filter(t=>t.tripId===e.id),n=s(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i={};r.forEach(e=>i[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]!==void 0&&(i[e.who]+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))i[n]!==void 0&&(i[n]-=t*(Number(r)/100));else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]!==void 0&&(i[t]-=e)})}}return{balances:i,roster:r,expenses:t}}function S(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function C(){let e={};for(let t of[...l.trips,...l.archivedTrips||[]])for(let n of s(t))n in e||(e[n]=0);let t=(l.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...l.expenses,...t],r={};for(let e of[...l.trips,...l.archivedTrips||[]])r[e.id]=s(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}return e}function w(e){if(!e)return[];let t=(l.expenses||[]).filter(t=>t.tripId===e.id),n=s(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function T(e,t,n,r){let i=E(r),a=`
    ...
    `:`
        ...
        `}function E(e){if(l.trips.length===0)return``;let t=l.trips.find(t=>t.id===e),n=t?(l.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0):0,i=l.trips.map(t=>{let n=(l.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0),i=n>0?` — ${p(n,`EUR`)} ${h(`settlement.settledSuffix`)}`:``;return`<option value="${r(t.id)}"${t.id===e?` selected`:``}>${r(t.name)}${i}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color:#005bb8; font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${p(n,`EUR`)} ${h(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    `}function D(e,t){let n=(l.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).length,r=(e,n,r)=>`
        ...
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color:#002d5b; letter-spacing:-0.02em;">${p(o,`EUR`)}</div>
                </div>
                ${s?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${p(s.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${l&&l.net>.01?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#1a6b3c;">+${p(l.net,`EUR`)}</div>
                    </div>
                `:``}
                ${c&&c.net<-.01?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#a30000;">${p(c.net,`EUR`)}</div>
                    </div>
                `:``}
            </div>
        </div>
    `:``,f=Object.entries(n).map(([e,t])=>{let n=t>.01,i=t<-.01;return`
        ...
        `}).join(``)||`<p class="text-muted" style="padding: 20px; text-align:center;">${h(`settlement.emptyNoCompanions`)}</p>`,m=i.length===0?`<div style="text-align:center; padding: 40px 20px;"><div style="font-size:2.2rem; margin-bottom:8px;">🥂</div><p style="margin:0; font-weight:800; color:#1a6b3c;">${h(`settlement.allSettledTitle`)}</p><p style="margin:6px 0 0; color:var(--text-secondary); font-size:0.85rem;">${h(`settlement.allSettledBody`)}</p></div>`:i.map(n=>`
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:16px;">
                <div style="flex:1; min-width:0;">
                    ...
                    <div style="font-size:1.3rem; font-weight:800; color:#002d5b; letter-spacing:-0.01em; margin-top:2px;">${p(n.amount,`EUR`)}</div>
                </div>
                ${t?`
        ...
        `:``}
    `}function k(e,t){let n=(l.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime());if(n.length===0)return`
                ...
                ${u.map(n=>{let a=i[n],o=a.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                <h4 style="margin:0; font-size:0.7rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary);">${r(c(n))}</h4>
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${d(`settlement.historyDayTotalPlural`,a.length,{amount:p(o,`EUR`)})}</span>
                            </div>
                            <div style="display:flex; flex-direction:column; gap:8px;">
    ...
    `}function A(){let e=C(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),i=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
                    ...
                    ${a.map(e=>`
                        <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:16px;">
                            <div style="flex:1; min-width:0;">
                                ...
                                <div style="font-size:1.3rem; font-weight:800; color:#002d5b; letter-spacing:-0.01em; margin-top:2px;">${p(e.amount,`EUR`)}</div>
                            </div>
                        </div>
                    `).join(``)}
                </div>
        ...
        `:``}
    `}function j(e,t,n,r,i){if(t===n){f(h(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(r)||r<=0){f(h(`settlement.toastAmountInvalid`));return}let a=c(r,i,`EUR`),s={id:o(),tripId:e,label:`Settlement: ${t} → ${n}`,value:r,euroValue:a,currency:i,who:t,categoryId:l.categories[0]?.id??``,country:h(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};l.expenses.push(s),_(u.STATE_CHANGED),f(`Recorded ${p(a,`EUR`)} ${t} → ${n}`)}function M(e){a({title:h(`settlement.toastUnsettleConfirmTitle`),message:h(`settlement.toastUnsettleConfirmMessage`),confirmText:h(`settlement.toastUnsettleConfirmBtn`),onConfirm:()=>{l.expenses=l.expenses.filter(t=>t.id!==e),_(u.STATE_CHANGED)}})}function N(e){let t=s(l.trips.find(t=>t.id===e)).map(e=>`<option value="${r(e)}">${r(e)}</option>`).join(``),n=m(),{root:a,close:o}=i({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
        ...
        `});g(a,`#cancelManualSettleBtn`).onclick=()=>o(),g(a,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let r=g(a,`#manualSettleFrom`).value,i=g(a,`#manualSettleTo`).value,s=parseFloat(g(a,`#manualSettleAmount`).value);if(r===i){f(h(`settlement.toastSenderEqualsReceiver`));return}j(e,r,i,s,n),o()}}function P(e){let t=l.expenses.find(t=>t.id===e);if(!t)return;let n=s(l.trips.find(e=>e.id===t.tripId)),a=n.map(e=>`<option value="${r(e)}" ${t.who===e?`selected`:``}>${r(e)}</option>`).join(``),o=Object.keys(t.splits||{})[0],d=n.map(e=>`<option value="${r(e)}" ${o===e?`selected`:``}>${r(e)}</option>`).join(``),p=m(),{root:v,close:y}=i({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                <label class="form-label">From</label>
                <select id="editSettleFrom" class="glass-input" style="padding: var(--space-3); border-radius: 12px; background:white;">${a}</select>
                <label class="form-label" style="margin-top:6px;">To</label>
                <select id="editSettleTo" class="glass-input" style="padding: var(--space-3); border-radius: 12px; background:white;">${d}</select>
                <label class="form-label" style="margin-top:6px;">Amount (${r(p)})</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${c(t.euroValue||0,`EUR`,p).toFixed(2)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
        ...
        `});g(v,`#cancelEditSettleBtn`).onclick=()=>y(),g(v,`#editSettlementForm`).onsubmit=e=>{e.preventDefault();let n=g(v,`#editSettleFrom`).value,r=g(v,`#editSettleTo`).value,i=parseFloat(g(v,`#editSettleAmount`).value),a=g(v,`#editSettleDate`).value;if(n===r){f(h(`settlement.toastSenderEqualsReceiver`));return}t.who=n,t.splits={[r]:100},t.value=i,t.currency=p,t.euroValue=c(i,p,`EUR`),t.date=a,t.label=`Settlement: ${n} → ${r}`,_(u.STATE_CHANGED),y()}}var F=t();function I(){let e=y(e=>e.trips),t=y(e=>e.activeTripId);y(e=>e.expenses);let[r,i]=(0,b.useState)(`trip`),[a,o]=(0,b.useState)(()=>t||(e.length>0?e[0].id:null));(0,b.useEffect)(()=>{a&&!e.find(e=>e.id===a)&&o(t||(e.length>0?e[0].id:null))},[e,a,t]);let s=e.find(e=>e.id===a)||null,c=n(s),l=(0,b.useMemo)(()=>T(s,c,r,a),[s,c,r,a,y.length]),u=(0,b.useRef)(null);return(0,F.jsx)(`div`,{ref:u,onClick:e=>{let t=e.target;if(!t)return;let n=t.closest(`.settlement-trip-pill`);if(n?.dataset.tripId){o(n.dataset.tripId);return}let r=t.closest(`.settle-tab`);if(r?.dataset.tab){i(r.dataset.tab);return}let a=t.closest(`.settle-debt-btn`);if(a?.dataset.tripId&&a.dataset.from&&a.dataset.to&&a.dataset.amount&&!a.disabled){a.disabled=!0,a.textContent=h(`settlement.recordingBtn`),j(a.dataset.tripId,a.dataset.from,a.dataset.to,parseFloat(a.dataset.amount),`EUR`);return}let s=t.closest(`.open-manual-settle-btn`);if(s?.dataset.tripId){N(s.dataset.tripId);return}let c=t.closest(`.edit-settlement-btn`);if(c?.dataset.settlementId){P(c.dataset.settlementId);return}let l=t.closest(`.unsettle-settlement-btn`);if(l?.dataset.settlementId){M(l.dataset.settlementId);return}},onChange:e=>{let t=e.target;if(t&&t.id===`settlementTripSelect`){let e=t;e.value&&o(e.value)}},dangerouslySetInnerHTML:{__html:l}})}function L(e){v(e,(0,b.createElement)(I))}export{L as mountSettlement};
//# sourceMappingURL=mount-CkIFeUB-.js.map