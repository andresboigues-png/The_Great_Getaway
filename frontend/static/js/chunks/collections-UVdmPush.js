            ...
            ${T.sort((e,t)=>e.dayNumber-t.dayNumber).map(e=>{let t=e.photos||[],n=D.filter(t=>t.dayId===e.id),r=t.length+n.length,i=e.tickets||[],o=O.filter(t=>t.dayId===e.id),s=i.length+o.length,c=Number(e.dayNumber)===0,l=t[0]||n[0]?.src||null,u=!!l;return`
                    <div class="archived-day-block" data-day-id="${a(e.id)}" role="button" tabindex="0" aria-label="View Day ${e.dayNumber}${e.name?` — `+e.name:``}"
                        ...
                        <div class="flex items-center gap-2">
                            <span style="background: ${c?`rgba(52,199,89,0.95)`:`rgba(0,113,227,0.95)`}; color:white; padding: 4px 12px; border-radius:999px; font-size:0.65rem; font-weight:800; text-transform:uppercase; letter-spacing:0.1em;">${c?`⭐ Hub`:`Day ${e.dayNumber}`}</span>
                        </div>
                        <!-- Bottom: name + count chips -->
                        <div>
                            <h3 style="margin:0; font-size:1.4rem; font-weight:800; letter-spacing:-0.02em; color:${u?`#ffffff`:`#002d5b`}; line-height:1.15; ${u?`text-shadow: 0 2px 12px rgba(0,0,0,0.4);`:``}">${a(e.name||(c?`Trip Hub`:`Day ${e.dayNumber}`))}</h3>
