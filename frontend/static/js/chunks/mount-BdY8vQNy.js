import{r as e,t}from"./vendor-react-CYVQMBjw.js";import{$ as n,G as r,J as i,Q as a,U as o,X as s,Y as c,Z as l,it as u,n as d,nt as f,ot as p,q as m,t as h,tt as g,x as _,z as v}from"../app.bundle.js";import{t as y}from"./store-QkOh9Ep7.js";var b=e();function x(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(g.expenses||[]).filter(t=>t.tripId===e.id),n=u(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i={};r.forEach(e=>i[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]!==void 0&&(i[e.who]+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))i[n]!==void 0&&(i[n]-=t*(Number(r)/100));else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]!==void 0&&(i[t]-=e)})}}return{balances:i,roster:r,expenses:t}}function S(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function C(){let e={};for(let t of[...g.trips,...g.archivedTrips||[]])for(let n of u(t))n in e||(e[n]=0);let t=(g.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...g.expenses,...t],r={};for(let e of[...g.trips,...g.archivedTrips||[]])r[e.id]=u(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}return e}function w(e){if(!e)return[];let t=(g.expenses||[]).filter(t=>t.tripId===e.id),n=u(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function T(e,t,n,r){let i=E(r),a=`
        ...
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color:#005bb8; font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${m(n,`EUR`)} ${h(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
        ...
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color:#002d5b; letter-spacing:-0.02em;">${m(o,`EUR`)}</div>
                </div>
                ${s?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${m(s.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${l&&l.net>.01?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#1a6b3c;">+${m(l.net,`EUR`)}</div>
                    </div>
                `:``}
                ${c&&c.net<-.01?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#a30000;">${m(c.net,`EUR`)}</div>
                    </div>
                `:``}
            </div>
        </div>
                ...
                ${l.map(n=>{let a=i[n],o=a.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                ...
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${d(`settlement.historyDayTotalPlural`,a.length,{amount:m(o,`EUR`)})}</span>
                            </div>
                            <div style="display:flex; flex-direction:column; gap:8px;">
    ...
    `}function A(){let e=C(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),i=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        `:``}
    `}function j(e,t,n,r,s){if(t===n){a(h(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(r)||r<=0){a(h(`settlement.toastAmountInvalid`));return}let c=o(r,s,`EUR`),l={id:i(),tripId:e,label:`Settlement: ${t} → ${n}`,value:r,euroValue:c,currency:s,who:t,categoryId:g.categories[0]?.id??``,country:h(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};g.expenses.push(l),f(p.STATE_CHANGED),a(`Recorded ${m(c,`EUR`)} ${t} → ${n}`)}function M(e){l({title:h(`settlement.toastUnsettleConfirmTitle`),message:h(`settlement.toastUnsettleConfirmMessage`),confirmText:h(`settlement.toastUnsettleConfirmBtn`),onConfirm:()=>{g.expenses=g.expenses.filter(t=>t.id!==e),f(p.STATE_CHANGED)}})}function N(e){let t=u(g.trips.find(t=>t.id===e)).map(e=>`<option value="${r(e)}">${r(e)}</option>`).join(``),i=c(),{root:o,close:l}=n({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
        ...
        `});s(o,`#cancelManualSettleBtn`).onclick=()=>l(),s(o,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let n=s(o,`#manualSettleFrom`).value,r=s(o,`#manualSettleTo`).value,c=parseFloat(s(o,`#manualSettleAmount`).value);if(n===r){a(h(`settlement.toastSenderEqualsReceiver`));return}j(e,n,r,c,i),l()}}function P(e){let t=g.expenses.find(t=>t.id===e);if(!t)return;let i=u(g.trips.find(e=>e.id===t.tripId)),l=i.map(e=>`<option value="${r(e)}" ${t.who===e?`selected`:``}>${r(e)}</option>`).join(``),d=Object.keys(t.splits||{})[0],m=i.map(e=>`<option value="${r(e)}" ${d===e?`selected`:``}>${r(e)}</option>`).join(``),_=c(),{root:v,close:y}=n({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
