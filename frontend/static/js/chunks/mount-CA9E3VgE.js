import{r as e,t}from"./vendor-react-CYVQMBjw.js";import{H as n,J as r,K as i,Q as a,W as o,X as s,Y as c,Z as l,at as u,et as d,q as f,rt as p,tt as m,x as h,z as g}from"../app.bundle.js";import{t as _}from"./store-BH9LnXCz.js";var v=e();function y(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(d.expenses||[]).filter(t=>t.tripId===e.id),n=p(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i={};r.forEach(e=>i[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]!==void 0&&(i[e.who]+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))i[n]!==void 0&&(i[n]-=t*(Number(r)/100));else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]!==void 0&&(i[t]-=e)})}}return{balances:i,roster:r,expenses:t}}function b(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function x(){let e={};for(let t of[...d.trips,...d.archivedTrips||[]])for(let n of p(t))n in e||(e[n]=0);let t=(d.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...d.expenses,...t],r={};for(let e of[...d.trips,...d.archivedTrips||[]])r[e.id]=p(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}return e}function S(e){if(!e)return[];let t=(d.expenses||[]).filter(t=>t.tripId===e.id),n=p(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function C(e,t,n,r){let i=`
    ...
    `:`
        ...
        `}function w(e){if(d.trips.length===0)return``;let t=d.trips.find(t=>t.id===e),n=t?(d.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0):0;return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            <select id="settlementTripSelect" class="settlement-trip-select"
                ...
                ${d.trips.map(t=>{let n=(d.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0),r=n>0?` — ${i(n,`EUR`)} settled`:``;return`<option value="${o(t.id)}"${t.id===e?` selected`:``}>${o(t.name)}${r}</option>`}).join(``)}
            </select>
            ${t&&n>0?`
    ...
    `}function T(e,t){let n=(d.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).length,r=(e,n,r)=>`
    ...
    `}function E(e,t){let{balances:n}=y(e),r=b(n),a=S(e),s=a.reduce((e,t)=>e+t.paid,0),c=[...a].sort((e,t)=>t.paid-e.paid)[0],l=[...a].sort((e,t)=>e.net-t.net)[0],u=[...a].sort((e,t)=>t.net-e.net)[0],d=s>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color:#002d5b; letter-spacing:-0.02em;">${i(s,`EUR`)}</div>
                </div>
                ${c?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:1.1rem; font-weight:800; color:#002d5b; margin-top:4px;">${o(c.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${i(c.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${u&&u.net>.01?`
                    <div style="text-align:center; min-width:120px;">
    ...
    `:``,f=Object.entries(n).map(([e,t])=>{let n=t>.01,r=t<-.01;return`
            <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:14px;">
                ...
                <div style="flex:1; min-width:0; font-weight:800; color:#002d5b; font-size:0.95rem; overflow:hidden; text-overflow:ellipsis;">${o(e)}</div>
            ...
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:16px;">
                <div style="flex:1; min-width:0;">
                    <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                        ...
                        <span style="font-weight:800; color:#002d5b; font-size:0.95rem;">${o(n.to)}</span>
                    </div>
        ...
        `:``}
    `}function D(e,t){let n=(d.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime());if(n.length===0)return`
        ...
        `;let r={};for(let e of n){let t=e.date||`undated`;r[t]||(r[t]=[]),r[t].push(e)}let a=new Date().toISOString().slice(0,10),s=new Date;s.setDate(s.getDate()-1);let c=s.toISOString().slice(0,10),l=e=>{if(e===`undated`)return`No date`;if(e===a)return`Today`;if(e===c)return`Yesterday`;let t=new Date(e);return isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{weekday:`short`,month:`short`,day:`numeric`,year:`numeric`})},u=Object.keys(r).sort((e,t)=>e===`undated`?1:t===`undated`?-1:t.localeCompare(e));return`
        <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
            ...
            <div style="display:flex; flex-direction:column; gap:18px;">
                ${u.map(n=>{let a=r[n],s=a.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                <h4 style="margin:0; font-size:0.7rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary);">${o(l(n))}</h4>
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${i(s,`EUR`)} · ${a.length} ${a.length===1?`settlement`:`settlements`}</span>
                            </div>
                            <div style="display:flex; flex-direction:column; gap:8px;">
                                ${a.map(n=>{let r=Object.keys(n.splits||{})[0]||`?`;return`
                                        <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:14px;">
                                            <div style="width:34px; height:34px; border-radius:50%; background:rgba(52,199,89,0.12); color:#1a6b3c; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:0.95rem; flex-shrink:0;">${o((n.who||`?`).charAt(0).toUpperCase())}</div>
                                            <div style="flex:1; min-width:0;">
                                                <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                                                    <span style="font-weight:800; color:#002d5b; font-size:0.95rem;">${o(n.who)}</span>
                                                    <span style="color:rgba(0,0,0,0.3); font-weight:600;">→</span>
                                                    <span style="font-weight:800; color:#002d5b; font-size:0.95rem;">${o(r)}</span>
                                            ...
                                            ${t?`
                                                <div style="display:flex; gap:6px; flex-shrink:0;">
                                                    <button class="edit-settlement-btn" data-settlement-id="${o(n.id)}" type="button"
                                                    ...
                                                    <button class="unsettle-settlement-btn" data-settlement-id="${o(n.id)}" data-trip-id="${o(e.id)}" type="button"
    ...
    `}function O(){let e=x(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),r=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
            ...
            <div style="display:flex; flex-direction:column; gap:8px;">
                ${t.map(([e,t])=>{let a=r?Math.min(Math.abs(t)/n*100,100):0,s=t>.01,c=t<-.01,l=s?`#1a6b3c`:c?`#a30000`:`var(--text-secondary)`;return`
                        <div style="display:flex; flex-direction:column; gap:10px; padding:12px 14px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:14px;">
                            <div style="display:flex; align-items:center; gap:14px;">
                                ...
                                <div style="flex:1; min-width:0; font-weight:800; color:#002d5b; font-size:0.95rem; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">${o(e)}</div>
                            ...
                            ${r?`
                                <div style="height:6px; background: rgba(0,0,0,0.05); border-radius:999px; overflow:hidden; position:relative;">
                                    ${s?`<div style="position:absolute; left:50%; top:0; bottom:0; width:${a/2}%; background:#34c759; border-radius:999px;"></div>`:``}
                                    ${c?`<div style="position:absolute; right:50%; top:0; bottom:0; width:${a/2}%; background:#ff3b30; border-radius:999px;"></div>`:``}
                        ...
                        <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:16px;">
                            <div style="flex:1; min-width:0;">
                                <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                                    ...
                                    <span style="color:rgba(0,0,0,0.3);">→</span>
                                    <span style="font-weight:800; color:#002d5b; font-size:0.95rem;">${o(e.to)}</span>
                                </div>
        ...
        `:``}
    `}function k(e,t,r,a,o){if(t===r){l(`Sender and receiver must be different.`);return}if(!Number.isFinite(a)||a<=0){l(`Amount must be a positive number.`);return}let s=n(a,o,`EUR`),c={id:f(),tripId:e,label:`Settlement: ${t} → ${r}`,value:a,euroValue:s,currency:o,who:t,categoryId:d.categories[0]?.id??``,country:`Settlement`,date:new Date().toISOString().split(`T`)[0]??``,splits:{[r]:100},isSettlement:!0};d.expenses.push(c),m(u.STATE_CHANGED),l(`Recorded ${i(s,`EUR`)} ${t} → ${r}`)}function A(e){s({title:`Unsettle this payment?`,message:`The settlement record is removed and balances revert.`,confirmText:`Unsettle`,onConfirm:()=>{d.expenses=d.expenses.filter(t=>t.id!==e),m(u.STATE_CHANGED)}})}function j(e){let t=p(d.trips.find(t=>t.id===e)).map(e=>`<option value="${o(e)}">${o(e)}</option>`).join(``),n=r(),{root:i,close:s}=a({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">Amount (${o(n)})</label>
        ...
        `});c(i,`#cancelManualSettleBtn`).onclick=()=>s(),c(i,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let r=c(i,`#manualSettleFrom`).value,a=c(i,`#manualSettleTo`).value,o=parseFloat(c(i,`#manualSettleAmount`).value);if(r===a){l(`Sender and receiver must be different.`);return}k(e,r,a,o,n),s()}}function M(e){let t=d.expenses.find(t=>t.id===e);if(!t)return;let i=p(d.trips.find(e=>e.id===t.tripId)),s=i.map(e=>`<option value="${o(e)}" ${t.who===e?`selected`:``}>${o(e)}</option>`).join(``),f=Object.keys(t.splits||{})[0],h=i.map(e=>`<option value="${o(e)}" ${f===e?`selected`:``}>${o(e)}</option>`).join(``),g=r(),{root:_,close:v}=a({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">Amount (${o(g)})</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${n(t.euroValue||0,`EUR`,g).toFixed(2)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
                <label class="form-label" style="margin-top:6px;">Date</label>
                <input type="date" id="editSettleDate" value="${o(t.date||``)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
