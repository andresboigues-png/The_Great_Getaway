import{i as e}from"./rolldown-runtime-Kw0j5LDr.js";import{r as t,t as n}from"./vendor-react-mHyv4XDd.js";import{$t as r,A as i,Bt as a,Ft as o,Gt as s,Ht as c,It as l,Jt as u,Rt as d,S as f,T as p,Vt as m,an as h,dt as g,en as _,in as v,it as y,qt as b,rn as x,un as S,x as C}from"../app.bundle.js";import{t as w}from"./store-DfKQD6T6.js";import{n as T}from"./TripContext-DG2u6Ot3.js";var E=e(t(),1);function D(e,t,n){let r=t.fromName||void 0;if(!r||e[r]===void 0){let i=v(n,t.fromUserId)?.name;i&&e[i]!==void 0&&(r=i)}let i=t.toName||void 0;if(!i||e[i]===void 0){let r=v(n,t.toUserId)?.name;r&&e[r]!==void 0&&(i=r)}if(!r||!i)return;e[r]===void 0&&(e[r]=0),e[i]===void 0&&(e[i]=0);let a=t.euroValue||t.amount||0;e[r]+=a,e[i]-=a}function O(e){if(!e)return{balances:{},roster:[],expenses:[],removedFromRoster:[]};let t=(r.expenses||[]).filter(t=>t.tripId===e.id),n=h(e),i=Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),a=Array.from(new Set([...n,...i])),o=i.filter(e=>!n.includes(e)),s={};a.forEach(e=>s[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(s[e.who]!==void 0&&(s[e.who]+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t||0),0),r=n>0?n:100;for(let[n,i]of Object.entries(e.splits))s[n]!==void 0&&(s[n]-=t*(Number(i)/r))}else{let e=t/Math.max(a.length,1);a.forEach(t=>{s[t]!==void 0&&(s[t]-=e)})}}let c=(r.settlements||[]).filter(t=>t.tripId===e.id);for(let t of c)D(s,t,e);return{balances:s,roster:a,expenses:t,removedFromRoster:o}}var k=.5;function A(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>k?t.push({person:r,amount:i}):i<-k&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<k&&i++,o.amount<k&&a++}return r}function j(){let e={};for(let t of[...r.trips,...r.archivedTrips||[]])for(let n of h(t))n in e||(e[n]=0);let t=new Set,n=[];for(let e of r.expenses)t.has(e.id)||(t.add(e.id),n.push(e));for(let e of r.archivedTrips||[])for(let r of e.expenses||[])t.has(r.id)||(t.add(r.id),n.push(r));for(let t of n)if(t.who&&!(t.who in e)&&(e[t.who]=0),t.splits)for(let n of Object.keys(t.splits))n&&!(n in e)&&(e[n]=0);let i={};for(let e of[...r.trips,...r.archivedTrips||[]])i[e.id]=h(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0){let r=Object.values(t.splits).reduce((e,t)=>e+(Number(t)||0),0);if(r>0)for(let[i,a]of Object.entries(t.splits))e[i]!==void 0&&(e[i]-=n*Number(a)/r)}else{let r=i[t.tripId]||[],a=r.length>0?r:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}let a=new Map;for(let e of[...r.trips,...r.archivedTrips||[]])a.set(e.id,e);let o=new Set,s=[];for(let e of r.settlements||[])o.has(e.id)||(o.add(e.id),s.push(e));for(let e of r.archivedTrips||[]){let t=e.settlements||[];for(let e of t)o.has(e.id)||(o.add(e.id),s.push(e))}for(let t of s){let n=a.get(t.tripId);n||console.warn(`[balances] settlement`,t.id,`trip`,t.tripId,`not in local cache — using snapshot names`),D(e,t,n||null)}return e}function M(e){if(!e)return[];let t=(r.expenses||[]).filter(t=>t.tripId===e.id),n=h(e),i={};n.forEach(e=>i[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]&&(i[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t),0),r=n>0?n:100;for(let[n,a]of Object.entries(e.splits))i[n]&&(i[n].share+=t*(Number(a)/r))}else{let e=t/Math.max(n.length,1);n.forEach(t=>{i[t]&&(i[t].share+=e)})}}return Object.entries(i).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function N(e){let t=0,n=0;for(let i of r.expenses||[])i.tripId===e&&i.isSettlement&&(t+=1,n+=i.euroValue||0);for(let i of r.settlements||[])i.tripId===e&&(t+=1,n+=i.euroValue||i.amount||0);return{count:t,eurTotal:n}}function P(e,t,n,r){let i=n===`global`?``:F(r),a=`
    ...
    `:`
        ...
        `}function F(e){if(r.trips.length===0)return``;let t=r.trips.find(t=>t.id===e),n=t?N(t.id).eurTotal:0,i=r.trips.map(t=>{let n=N(t.id).eurTotal,r=n>0?` — ${b(n,`EUR`)} ${C(`settlement.settledSuffix`)}`:``;return`<option value="${d(t.id)}"${t.id===e?` selected`:``}>${d(t.name)}${r}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color: var(--accent-blue-deep); font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${b(n,`EUR`)} ${C(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    ...
    `}function L(e,t){let{balances:n,removedFromRoster:r}=O(e),i=new Set(r||[]),a=A(n),o=M(e),s=o.reduce((e,t)=>e+t.paid,0),c=[...o].sort((e,t)=>t.paid-e.paid)[0],l=[...o].sort((e,t)=>e.net-t.net)[0],u=[...o].sort((e,t)=>t.net-e.net)[0],p=d(e?.name||`Trip`),m=s>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color: var(--text-brand-navy); letter-spacing:-0.02em;">${b(s,`EUR`)}</div>
                </div>
                ${c?`
                    <div class="stl-center-min-120">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${b(c.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${u&&u.net>.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#1a6b3c;">+${b(u.net,`EUR`)}</div>
                    </div>
                `:``}
                ${l&&l.net<-.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#a30000;">${b(l.net,`EUR`)}</div>
                    </div>
                `:``}
            </div>
        </div>
        ...
        `}).join(``)||`<p class="text-muted" style="padding: 20px; text-align:center;">${C(`settlement.emptyNoCompanions`)}</p>`,g=a.length===0?`<div style="text-align:center; padding: 40px 20px;"><div style="font-size:2.2rem; margin-bottom:8px;">🥂</div><p style="margin:0; font-weight:800; color:#1a6b3c;">${C(`settlement.allSettledTitle`)}</p><p style="margin:6px 0 0; color:var(--text-secondary); font-size:0.85rem;">${C(`settlement.allSettledBody`)}</p></div>`:a.map(n=>`
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:16px;">
                <div class="stl-flex-grow-truncate">
                    ...
                    <div style="font-size:1.3rem; font-weight:800; color: var(--text-brand-navy); letter-spacing:-0.01em; margin-top:2px;">${b(n.amount,`EUR`)}</div>
                </div>
                ${t?`
                ...
                ${c.map(n=>{let i=r[n],a=i.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                ...
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${f(`settlement.historyDayTotalPlural`,i.length,{amount:b(a,`EUR`)})}</span>
                            </div>
                            <div class="stl-flex-col-8">
    ...
    `}function B(){let e=j(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),r=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        `:``}
    `}async function V(e,t,n,i,o,l){if(t===n){c(C(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(i)||i<=0){c(C(`settlement.toastAmountInvalid`));return}if(typeof navigator<`u`&&navigator.onLine===!1){c(C(`errors.offline`));return}let u=s(i,o,`EUR`),d=r.trips.find(t=>t.id===e),f=x(d,t)?.linkedUserId,m=x(d,n)?.linkedUserId;if(f&&m){let a=await p({tripId:e,fromUserId:f,toUserId:m,amount:i,currency:o,euroValue:u,...l?.method?{method:l.method}:{},...l?.note?{note:l.note}:{}});a.settlement?(r.settlements.push(a.settlement),_(S.STATE_CHANGED),c(C(`settlement.toastRecordedNotified`,{amount:b(u,`EUR`),from:t,to:n}))):(console.warn(`[settlement] /api/settlements failed:`,a.error),c(C(`settlement.toastSettlementFailed`,{error:a.error||C(`settlement.toastSettlementFailedNetwork`)})),_(S.STATE_CHANGED));return}let h={id:a(),tripId:e,label:C(`settlement.settlementLabel`,{from:t,to:n}),value:i,euroValue:u,currency:o,who:t,categoryId:r.categories[0]?.id??``,country:C(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};r.expenses.push(h),_(S.STATE_CHANGED),y(h),c(C(`settlement.toastRecorded`,{amount:b(u,`EUR`),from:t,to:n}))}async function H(e,t=`expense`){o({title:C(`settlement.toastUnsettleConfirmTitle`),message:C(`settlement.toastUnsettleConfirmMessage`),confirmText:C(`settlement.toastUnsettleConfirmBtn`),onConfirm:async()=>{if(t===`settlement`){let t=await i(e);if(t.error){console.warn(`[settlement] delete failed:`,t.error),c(`Couldn't undo: ${t.error||`Network error`}`);return}r.settlements=r.settlements.filter(t=>t.id!==e),_(S.STATE_CHANGED);return}r.expenses=r.expenses.filter(t=>t.id!==e),_(S.STATE_CHANGED)}})}var U=[{value:`cash`,labelKey:`settlement.methodCash`},{value:`revolut`,labelKey:`settlement.methodRevolut`},{value:`bank_transfer`,labelKey:`settlement.methodBankTransfer`},{value:`wise`,labelKey:`settlement.methodWise`},{value:`paypal`,labelKey:`settlement.methodPayPal`},{value:`custom`,labelKey:`settlement.methodCustom`}];function W(e){let t=r.trips.find(t=>t.id===e),n=h(t).map(e=>`<option value="${d(e)}">${d(e)}</option>`).join(``),i=U.map(e=>`<option value="${d(e.value)}">${d(C(e.labelKey))}</option>`).join(``),a=u(),{root:s,close:f}=l({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                <label class="form-label">${d(C(`settlement.labelFrom`))}</label>
                <select id="manualSettleFrom" class="glass-input stl-card-minor-bg">${n}</select>
                <label class="form-label stl-mt-6">${d(C(`settlement.labelTo`))}</label>
                <select id="manualSettleTo" class="glass-input stl-card-minor-bg">${n}</select>
                <label class="form-label stl-mt-6">${d(C(`settlement.labelAmount`,{currency:a}))}</label>
                ...
                <label class="form-label stl-mt-6">${d(C(`settlement.labelMethod`))}</label>
                <select id="manualSettleMethod" class="glass-input stl-card-minor-bg">${i}</select>
                <label class="form-label stl-mt-6">${d(C(`settlement.labelNote`))} <span class="text-subtitle" style="font-weight:500;">${d(C(`settlement.labelNoteOptional`))}</span></label>
                <input type="text" id="manualSettleNote" class="glass-input" maxlength="240" placeholder="${d(C(`settlement.notePlaceholder`))}" class="stl-card-minor">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
                    <button type="button" id="cancelManualSettleBtn" class="btn-neutral" style="flex:1; border-radius: var(--radius-lg);">${d(C(`settlement.cancelBtn`))}</button>
                    <button type="submit" class="btn-primary" style="flex:2; border-radius: var(--radius-lg);">${d(C(`settlement.recordPaymentBtn`))}</button>
                </div>
            </form>
        `});m(s,`#cancelManualSettleBtn`).onclick=()=>f(),m(s,`#manualSettleForm`).onsubmit=n=>{n.preventDefault();let r=m(s,`#manualSettleFrom`).value,i=m(s,`#manualSettleTo`).value,l=parseFloat(m(s,`#manualSettleAmount`).value),u=m(s,`#manualSettleMethod`).value,d=m(s,`#manualSettleNote`).value.trim();if(r===i){c(C(`settlement.toastSenderEqualsReceiver`));return}let p=G(t,r,i,a),h=()=>{V(e,r,i,l,a,{method:u,note:d}),f()};if(l>p+.005){o({title:C(`settlement.overpayConfirmTitle`),message:p>.005?C(`settlement.overpayConfirmBody`,{amount:b(l,a),owed:b(p,a),from:r,to:i}):C(`settlement.overpayConfirmBodyNone`,{amount:b(l,a),from:r,to:i}),confirmText:C(`settlement.overpayConfirmBtn`),onConfirm:h});return}h()}}function G(e,t,n,r){if(!e)return 0;let{balances:i}=O(e),a=A(i).find(e=>e.from===t&&e.to===n);return a?s(a.amount,`EUR`,r):0}function K(e){let t=r.expenses.find(t=>t.id===e);if(!t)return;let n=h(r.trips.find(e=>e.id===t.tripId)),i=n.map(e=>`<option value="${d(e)}" ${t.who===e?`selected`:``}>${d(e)}</option>`).join(``),a=Object.keys(t.splits||{})[0],o=n.map(e=>`<option value="${d(e)}" ${a===e?`selected`:``}>${d(e)}</option>`).join(``),f=u(),{root:p,close:g}=l({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label stl-mt-6">${d(C(`settlement.labelAmount`,{currency:f}))}</label>
                ...
                <label class="form-label stl-mt-6">${d(C(`settlement.labelDate`))}</label>
                <input type="date" id="editSettleDate" value="${d(t.date||``)}" class="glass-input" required class="stl-card-minor">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
                    <button type="button" id="cancelEditSettleBtn" class="btn-neutral" style="flex:1; border-radius: var(--radius-lg);">${d(C(`settlement.cancelBtn`))}</button>
                    <button type="submit" class="btn-primary" style="flex:2; border-radius: var(--radius-lg);">${d(C(`settlement.updateBtn`))}</button>
                </div>
            </form>
        `});m(p,`#cancelEditSettleBtn`).onclick=()=>g(),m(p,`#editSettlementForm`).onsubmit=e=>{e.preventDefault();let n=m(p,`#editSettleFrom`).value,r=m(p,`#editSettleTo`).value,i=parseFloat(m(p,`#editSettleAmount`).value),a=m(p,`#editSettleDate`).value;if(n===r){c(C(`settlement.toastSenderEqualsReceiver`));return}t.who=n,t.splits={[r]:100},t.value=i,t.currency=f,t.euroValue=s(i,f,`EUR`),t.date=a,t.label=C(`settlement.settlementLabel`,{from:n,to:r}),_(S.STATE_CHANGED),y(t),g()}}var q=n();function J(){let e=w(e=>e.trips),t=w(e=>e.activeTripId),n=w(e=>e.expenses),[i,a]=(0,E.useState)(`trip`),[o,s]=(0,E.useState)(()=>t||(e.length>0?e[0].id:null));(0,E.useEffect)(()=>{t&&t!==o&&s(t)},[t,o]),(0,E.useEffect)(()=>{if(o&&!e.find(e=>e.id===o)){let t=e.length>0?e[0].id:null;s(t),t&&(r.activeTripId=t,_(S.STATE_CHANGED))}},[e,o]);let c=e=>{s(e),r.activeTripId=e,_(S.STATE_CHANGED),i===`global`&&a(`trip`)},{trip:l,canEditExpenses:u}=T(o),d=(0,E.useMemo)(()=>P(l,u,i,o),[l,u,i,o,n]),f=(0,E.useRef)(null),p=e=>{let t=e.target;if(!t)return;let n=t.closest(`.settlement-trip-pill`);if(n?.dataset.tripId){c(n.dataset.tripId);return}let r=t.closest(`.settle-tab`);if(r?.dataset.tab){a(r.dataset.tab);return}let i=t.closest(`.settle-debt-btn`);if(i?.dataset.tripId&&i.dataset.from&&i.dataset.to&&i.dataset.amount&&!i.disabled){i.disabled=!0,i.textContent=C(`settlement.recordingBtn`),V(i.dataset.tripId,i.dataset.from,i.dataset.to,parseFloat(i.dataset.amount),`EUR`);return}let o=t.closest(`.open-manual-settle-btn`);if(o?.dataset.tripId){W(o.dataset.tripId);return}let s=t.closest(`.edit-settlement-btn`);if(s?.dataset.settlementId){K(s.dataset.settlementId);return}let l=t.closest(`.unsettle-settlement-btn`);if(l?.dataset.settlementId){let e=l.dataset.source===`settlement`?`settlement`:`expense`;H(l.dataset.settlementId,e);return}},m=(0,E.useRef)(c);return m.current=c,(0,E.useEffect)(()=>{let e=f.current;if(!e)return;let t=e=>{let t=e.target;if(t?.id===`settlementTripSelect`){let e=t;e.value&&m.current(e.value)}};return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,q.jsx)(`div`,{ref:f,onClick:p,dangerouslySetInnerHTML:{__html:d}})}function Y(e){g(e,(0,E.createElement)(J))}export{Y as mountSettlement};
//# sourceMappingURL=mount-CEoub018.js.map