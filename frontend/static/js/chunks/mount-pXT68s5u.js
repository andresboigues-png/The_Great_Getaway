import{i as e}from"./rolldown-runtime-Kw0j5LDr.js";import{r as t,t as n}from"./vendor-react-mHyv4XDd.js";import{A as r,Bt as i,Ft as a,Gt as o,Ht as s,It as c,Jt as l,Qt as u,Rt as d,S as f,T as p,Vt as m,Zt as h,cn as g,dt as _,nn as v,qt as y,rn as b,tn as x,x as S}from"../app.bundle.js";import{t as C}from"./store-B5WLpJ2H.js";import{n as w}from"./TripContext-DAQYsSeN.js";var T=e(t(),1);function E(e,t,n){let r=t.fromName||void 0;if(!r||e[r]===void 0){let i=v(n,t.fromUserId)?.name;i&&e[i]!==void 0&&(r=i)}let i=t.toName||void 0;if(!i||e[i]===void 0){let r=v(n,t.toUserId)?.name;r&&e[r]!==void 0&&(i=r)}if(!r||!i||e[r]===void 0||e[i]===void 0)return;let a=t.euroValue||t.amount||0;e[r]+=a,e[i]-=a}function D(e){if(!e)return{balances:{},roster:[],expenses:[],removedFromRoster:[]};let t=(h.expenses||[]).filter(t=>t.tripId===e.id),n=b(e),r=Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i=Array.from(new Set([...n,...r])),a=r.filter(e=>!n.includes(e)),o={};i.forEach(e=>o[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(o[e.who]!==void 0&&(o[e.who]+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t||0),0),r=n>0?n:100;for(let[n,i]of Object.entries(e.splits))o[n]!==void 0&&(o[n]-=t*(Number(i)/r))}else{let e=t/Math.max(i.length,1);i.forEach(t=>{o[t]!==void 0&&(o[t]-=e)})}}let s=(h.settlements||[]).filter(t=>t.tripId===e.id);for(let t of s)E(o,t,e);return{balances:o,roster:i,expenses:t,removedFromRoster:a}}function O(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function k(){let e={};for(let t of[...h.trips,...h.archivedTrips||[]])for(let n of b(t))n in e||(e[n]=0);let t=new Set,n=[];for(let e of h.expenses)t.has(e.id)||(t.add(e.id),n.push(e));for(let e of h.archivedTrips||[])for(let r of e.expenses||[])t.has(r.id)||(t.add(r.id),n.push(r));for(let t of n)if(t.who&&!(t.who in e)&&(e[t.who]=0),t.splits)for(let n of Object.keys(t.splits))n&&!(n in e)&&(e[n]=0);let r={};for(let e of[...h.trips,...h.archivedTrips||[]])r[e.id]=b(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0){let r=Object.values(t.splits).reduce((e,t)=>e+(Number(t)||0),0);if(r>0)for(let[i,a]of Object.entries(t.splits))e[i]!==void 0&&(e[i]-=n*Number(a)/r)}else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}let i=new Map;for(let e of[...h.trips,...h.archivedTrips||[]])i.set(e.id,e);let a=new Set,o=[];for(let e of h.settlements||[])a.has(e.id)||(a.add(e.id),o.push(e));for(let e of h.archivedTrips||[]){let t=e.settlements||[];for(let e of t)a.has(e.id)||(a.add(e.id),o.push(e))}for(let t of o){let n=i.get(t.tripId);n&&E(e,t,n)}return e}function A(e){if(!e)return[];let t=(h.expenses||[]).filter(t=>t.tripId===e.id),n=b(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function j(e){let t=0,n=0;for(let r of h.expenses||[])r.tripId===e&&r.isSettlement&&(t+=1,n+=r.euroValue||0);for(let r of h.settlements||[])r.tripId===e&&(t+=1,n+=r.euroValue||r.amount||0);return{count:t,eurTotal:n}}function M(e,t,n,r){let i=n===`global`?``:N(r),a=`
    ...
    `:`
        ...
        `}function N(e){if(h.trips.length===0)return``;let t=h.trips.find(t=>t.id===e),n=t?j(t.id).eurTotal:0,r=h.trips.map(t=>{let n=j(t.id).eurTotal,r=n>0?` — ${y(n,`EUR`)} ${S(`settlement.settledSuffix`)}`:``;return`<option value="${d(t.id)}"${t.id===e?` selected`:``}>${d(t.name)}${r}</option>`}).join(``);return`
    ...
    `}function F(e,t){let{balances:n,removedFromRoster:r}=D(e),i=new Set(r||[]),a=O(n),o=A(e),s=o.reduce((e,t)=>e+t.paid,0),c=[...o].sort((e,t)=>t.paid-e.paid)[0],l=[...o].sort((e,t)=>e.net-t.net)[0],u=[...o].sort((e,t)=>t.net-e.net)[0],p=d(e?.name||`Trip`),m=s>0?`
    ...
    `}function R(){let e=k(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),r=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        `:``}
    `}async function z(e,t,n,r,a,c){if(t===n){s(S(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(r)||r<=0){s(S(`settlement.toastAmountInvalid`));return}let l=o(r,a,`EUR`),d=h.trips.find(t=>t.id===e),f=x(d,t)?.linkedUserId,m=x(d,n)?.linkedUserId;if(f&&m){let i=await p({tripId:e,fromUserId:f,toUserId:m,amount:r,currency:a,euroValue:l,...c?.method?{method:c.method}:{},...c?.note?{note:c.note}:{}});i.settlement?(h.settlements.push(i.settlement),u(g.STATE_CHANGED),s(`Recorded ${y(l,`EUR`)} ${t} → ${n} · notified ${n}`)):(console.warn(`[settlement] /api/settlements failed:`,i.error),s(`Settlement failed: ${i.error||`Network error`}`),u(g.STATE_CHANGED));return}let _={id:i(),tripId:e,label:S(`settlement.settlementLabel`,{from:t,to:n}),value:r,euroValue:l,currency:a,who:t,categoryId:h.categories[0]?.id??``,country:S(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};h.expenses.push(_),u(g.STATE_CHANGED),s(`Recorded ${y(l,`EUR`)} ${t} → ${n}`)}async function B(e,t=`expense`){a({title:S(`settlement.toastUnsettleConfirmTitle`),message:S(`settlement.toastUnsettleConfirmMessage`),confirmText:S(`settlement.toastUnsettleConfirmBtn`),onConfirm:async()=>{if(t===`settlement`){let t=await r(e);if(t.error){console.warn(`[settlement] delete failed:`,t.error),s(`Couldn't undo: ${t.error||`Network error`}`);return}h.settlements=h.settlements.filter(t=>t.id!==e),u(g.STATE_CHANGED);return}h.expenses=h.expenses.filter(t=>t.id!==e),u(g.STATE_CHANGED)}})}var V=[{value:`cash`,labelKey:`settlement.methodCash`},{value:`revolut`,labelKey:`settlement.methodRevolut`},{value:`bank_transfer`,labelKey:`settlement.methodBankTransfer`},{value:`wise`,labelKey:`settlement.methodWise`},{value:`paypal`,labelKey:`settlement.methodPayPal`},{value:`custom`,labelKey:`settlement.methodCustom`}];function H(e){let t=h.trips.find(t=>t.id===e),n=b(t).map(e=>`<option value="${d(e)}">${d(e)}</option>`).join(``),r=V.map(e=>`<option value="${d(e.value)}">${d(S(e.labelKey))}</option>`).join(``),i=l(),{root:o,close:u}=c({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
