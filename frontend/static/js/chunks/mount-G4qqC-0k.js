import{r as e,t}from"./vendor-react-CAxw18f3.js";import{Q as n,Y as r,Z as i,b as a,c as o,d as s,f as c,lt as l,m as u,nt as d,o as f,p,r as m,s as h,t as g,tt as _,u as v,v as y,w as b}from"../app.bundle.js";var x=e(),S=new Set([`friend_shared_trip`,`friend_reposted_trip`]),C=new Set([`friend_created_trip`,`friend_archived_trip`,`friend_joined_trip`,`new_friendship`]),w={muted:`142,142,147`,like:`255,59,48`,comment:`0,113,227`,repost:`52,199,89`,bookmark:`255,149,0`};function T(e){if(!e)return``;let t=typeof e==`string`&&e.includes(` `)&&!e.includes(`T`)?e.replace(` `,`T`)+`Z`:e,n=new Date(t);return Number.isNaN(n.getTime())?``:n.toISOString().slice(0,10)}function E(e){let t=new Map,n=[];for(let r of e){if(S.has(r.type)){n.push(r);continue}let e=`${r.actor?.id||`anon`}|${r.type}|${T(r.when)}`,i=t.get(e);i||(i=[],t.set(e,i),n.push({__slot:e})),i.push(r)}return n.map(e=>{let n=e.__slot;if(!n)return e;let r=t.get(n)||[];if(r.length===1)return r[0];let i=r[0];return{bundled:!0,id:`bundle_${n}`,type:i.type,actor:i.actor,when:i.when,members:r}})}function D(e){let t=`<strong style="color:#002d5b;">${n(e.actor.name)}</strong>`,r=e.members.length,i=r===1?`trip`:`trips`;switch(e.type){case`friend_created_trip`:return`${t} started planning <strong style="color:#002d5b;">${r} new ${i}</strong>`;case`friend_archived_trip`:return`${t} just completed <strong style="color:#002d5b;">${r} ${i}</strong> 🎉`;case`friend_joined_trip`:return`${t} joined <strong style="color:#002d5b;">${r} ${i}</strong>`;case`new_friendship`:return`You and <strong style="color:#002d5b;">${r} new people</strong> are now friends 🤝`;default:return`${t} did ${r} new things`}}function O(e,t=44){let r=(e?.name||`?`).charAt(0).toUpperCase(),i=`<div style="width:${t}px; height:${t}px; border-radius:50%; background: var(--gradient-day); color:white; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:${Math.round(t*.4)}px; flex-shrink:0; box-shadow: 0 2px 8px rgba(0,113,227,0.18);">${n(r)}</div>`,a=e?.picture?`<img src="${n(e.picture)}" alt="" referrerpolicy="no-referrer"
    ...
    `}var I=new Set;function L(e){e.classList.remove(`tap-pop`),e.offsetWidth,e.classList.add(`tap-pop`),e.addEventListener(`animationend`,()=>{e.classList.remove(`tap-pop`)},{once:!0})}var R=[],z={},B=`posts`,V=!1,H=null,U=null;function W(e){return H!==null&&U===null?(e(),Promise.resolve()):U?U.then(e):(U=(async()=>{try{let e=await h();e.error?(console.warn(`explore fetch failed:`,e.error),H=[]):H=e.items||[]}finally{U=null,e()}})(),U)}function G(e,t,r){let i=l.user?.id;e.innerHTML=`
        <div class="feed-comment-list">${r.length>0?r.map(e=>F(e,e.author?.id===i)).join(``):`<div style="font-size:0.82rem; color:var(--text-secondary); padding:6px 0;">${g(`feed.commentsEmpty`)}</div>`}</div>
    ...
    `;let t=!1,h=e=>{let t=e.coverUrl?`background-image: url('${n(e.coverUrl)}'); background-size: cover; background-position: center;`:`background: linear-gradient(135deg, #00c7be 0%, #007aff 100%);`,r=e.owner.picture?`<img src="${n(e.owner.picture)}" alt="" referrerpolicy="no-referrer" style="width:24px; height:24px; border-radius:50%; object-fit:cover;">`:`<div style="width:24px; height:24px; border-radius:50%; background:rgba(0,113,227,0.18); display:flex; align-items:center; justify-content:center; color:#005bb8; font-size:0.7rem; font-weight:800;">${n((e.owner.firstName||`?`).slice(0,1).toUpperCase())}</div>`;return`
        ...
        `},b=()=>{let r=_(e,`#feedList`);if(!r)return;if(B===`explore`){if(H===null){r.innerHTML=`
                ...
                `;return}if(H.length===0){r.innerHTML=i({accent:`blue`,emoji:`🌍`,title:`No public trips yet`,body:`Be the first — share one of your own to seed the Explore feed for everyone.`});return}r.innerHTML=`
            ...
            `;return}let a=e=>B===`posts`?S.has(e.type):C.has(e.type),o=R.filter(e=>!(!a(e)||V&&!e.is_bookmarked));if(o.length===0){let t,n,a,o;V?(t=g(B===`posts`?`feed.emptyBookmarkedPostsTitle`:`feed.emptyBookmarkedActionsTitle`),n=g(`feed.emptyBookmarkedBody`),a=g(`feed.emptyBookmarkedCta`),o=()=>{V=!1;let t=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);t&&(t.checked=!1),b()}):B===`posts`?(t=g(`feed.emptyPostsTitle`),n=g(`feed.emptyPostsBody`),a=g(`feed.emptyPostsCta`),o=()=>{B=`actions`,b(),e.querySelectorAll(`.home-tabnav__tab`).forEach(e=>e.classList.toggle(`is-active`,e.dataset.feedTab===`actions`))}):(t=g(`feed.emptyActionsTitle`),n=g(`feed.emptyActionsBody`),a=g(`feed.emptyActionsCta`),o=()=>y(`friends`)),r.innerHTML=i({accent:`purple`,emoji:V?`🔖`:`🌱`,title:t,body:n,ctaLabel:a,ctaId:`feedEmptyCtaBtn`});let s=r.querySelector(`#feedEmptyCtaBtn`);s&&(s.onclick=o);return}let s=l.user?.id;r.innerHTML=E(o).map(e=>{if(e.bundled){let t=e,r=j(t.type),i=k(t.when),a=I.has(t.id),o=t.members.map(e=>{let t=A(e),r=!!e.is_bookmarked;return`
            ...
            `}).join(``)},x=async()=>{if(!l.user){t=!0,b();return}try{let e=await m(`/api/feed`);if(!e.ok)return;let t=await e.json();Array.isArray(t)&&(R=t)}catch(e){console.error(`Feed refresh failed:`,e)}finally{t=!0,b()}};e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(t=>{t.onclick=()=>{let n=t.dataset.feedTab;!n||B===n||(B=n,e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(e=>{e.classList.toggle(`is-active`,e.dataset.feedTab===n)}),n===`explore`&&W(b),b())}});let T=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);return T&&T.addEventListener(`change`,()=>{V=!!T.checked,b()}),e.addEventListener(`click`,async e=>{let t=e.target;if(!t)return;let n=t.closest(`.feed-avatar-btn`);if(n?.dataset.feedAvatarUserId){y(`profile`,{userId:n.dataset.feedAvatarUserId});return}let i=t.closest(`.feed-trip-card`);if(i?.dataset.tripId){a(i.dataset.tripId);return}let l=t.closest(`.feed-like-btn`);if(l?.dataset.eventId){let e=l.dataset.eventId,t=l.dataset.liked===`1`,n=!t,r=R.find(t=>t.id===e);r&&(r.is_liked=n,r.like_count=Math.max(0,(r.like_count||0)+(t?-1:1))),l.dataset.liked=n?`1`:`0`,l.style.setProperty(`--accent`,n?w.like:w.muted),l.innerHTML=M(`heart`,n),L(l);let i=l.parentElement?.querySelector(`.feed-action-count`),a=e=>e>=3?String(e):``;i&&r&&(i.textContent=a(r.like_count??0));let o=await p(e);o.ok&&o.body&&r&&(r.is_liked=!!o.body.liked,r.like_count=Number(o.body.count)||0,i&&(i.textContent=a(r.like_count)));return}let m=t.closest(`.feed-bookmark-btn`);if(m?.dataset.eventId){let e=m.dataset.eventId,t=m.dataset.bookmarked!==`1`,n=R.find(t=>t.id===e);n&&(n.is_bookmarked=t),m.dataset.bookmarked=t?`1`:`0`,m.style.setProperty(`--accent`,t?w.bookmark:w.muted),m.innerHTML=M(`bookmark`,t),L(m),V&&!t&&b(),await c(e);return}let h=t.closest(`.feed-bundle-toggle`);if(h?.dataset.bundleId){let e=h.dataset.bundleId;I.has(e)?I.delete(e):I.add(e),b();return}let _=t.closest(`.feed-comment-btn`);if(_?.dataset.eventId){let e=_.dataset.eventId,t=_.closest(`.feed-event`)?.querySelector(`.feed-thread`);if(!t)return;if(t.style.display!==`none`){t.style.display=`none`;return}t.style.display=`block`,z[e]?G(t,e,z[e]):(t.innerHTML=`<div style="font-size:0.82rem; color:var(--text-secondary); padding:6px 0;">${g(`feed.commentsLoading`)}</div>`,z[e]=await o(e)||[],G(t,e,z[e]));let n=t.querySelector(`input[name="body"]`);n&&n.focus();return}let v=t.closest(`.feed-comment-delete-btn`);if(v?.dataset.commentId){let e=Number(v.dataset.commentId),t=v.closest(`.feed-comment-row`),n=v.closest(`.feed-thread`),r=n?.dataset.eventId;t&&t.remove(),r&&z[r]&&(z[r]=z[r].filter(t=>t.id!==e));let i=r?R.find(e=>e.id===r):null;if(i){i.comment_count=Math.max(0,(i.comment_count||0)-1);let e=((n?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=i.comment_count>0?String(i.comment_count):``)}(await f(e)).ok||d(`Couldn't delete — try again in a moment.`);return}let S=t.closest(`.feed-unshare-btn`);if(S?.dataset.postId){let e=Number(S.dataset.postId);r({title:g(`feed.toastUnshareConfirmTitle`),message:g(`feed.toastUnshareConfirmMessage`),confirmText:g(`feed.toastUnshareConfirmBtn`),onConfirm:async()=>{let t=await u(e);if(!t||!t.ok){d(g(`feed.toastUnshareFailed`));return}await x(),d(g(`feed.toastRemovedFromFeed`))}});return}let C=t.closest(`.feed-repost-btn`);if(C?.dataset.postId){let e=Number(C.dataset.postId),t=C.style.getPropertyValue(`--accent`)||w.muted;C.disabled=!0,C.style.setProperty(`--accent`,w.muted);let n=await s(e);n.ok&&n.body?.status!==`same_user`?(d(n.body?.status===`already_reposted`?g(`feed.toastAlreadyReposted`):g(`feed.toastReposted`)),C.style.setProperty(`--accent`,w.repost),C.innerHTML=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>`,L(C)):n.body?.status===`same_user`?(C.disabled=!1,C.style.setProperty(`--accent`,t),d(g(`feed.toastRepostOwnShare`))):(C.disabled=!1,C.style.setProperty(`--accent`,t),d(g(`feed.toastRepostFailed`)));return}}),e.addEventListener(`submit`,async e=>{let t=e.target;if(!t?.classList?.contains(`feed-comment-form`))return;e.preventDefault();let n=t.dataset.eventId;if(!n)return;let r=t.querySelector(`input[name="body"]`),i=r?.value.trim();if(!i)return;let a=t.querySelector(`.feed-comment-submit`);r&&(r.value=``),a&&(a.disabled=!0);let o=await v(n,i);if(a&&(a.disabled=!1),!o.ok||!o.body?.comment){r&&(r.value=i),d(`Couldn't post comment — try again.`);return}let s=o.body.comment;z[n]||(z[n]=[]),z[n].push(s);let c=t.closest(`.feed-thread`);c&&G(c,n,z[n]);let l=c?.querySelector(`input[name="body"]`);l&&l.focus();let u=R.find(e=>e.id===n);if(u){u.comment_count=(u.comment_count||0)+1;let e=((c?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=String(u.comment_count))}}),b(),x(),e}var q=t();function J(){let e=(0,x.useRef)(null);return(0,x.useEffect)(()=>{let t=e.current;t&&(t.innerHTML=``,t.appendChild(K()))},[]),(0,q.jsx)(`div`,{ref:e})}function Y(e){b(e,(0,x.createElement)(J))}export{Y as mountFeed};
//# sourceMappingURL=mount-G4qqC-0k.js.map