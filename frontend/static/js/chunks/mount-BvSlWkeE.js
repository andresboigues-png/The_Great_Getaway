import{r as e,t}from"./vendor-react-CYVQMBjw.js";import{V as n,W as r,X as i,Y as a,Z as o,_ as s,b as c,d as l,et as u,f as d,l as f,o as p,p as m,r as h,s as g,t as _,u as v,x as y}from"../app.bundle.js";var b=e(),x=new Set([`friend_shared_trip`,`friend_reposted_trip`]),S=new Set([`friend_created_trip`,`friend_archived_trip`,`friend_joined_trip`,`new_friendship`]),C={muted:`142,142,147`,like:`255,59,48`,comment:`0,113,227`,repost:`52,199,89`,bookmark:`255,149,0`};function w(e){if(!e)return``;let t=typeof e==`string`&&e.includes(` `)&&!e.includes(`T`)?e.replace(` `,`T`)+`Z`:e,n=new Date(t);return Number.isNaN(n.getTime())?``:n.toISOString().slice(0,10)}function T(e){let t=new Map,n=[];for(let r of e){if(x.has(r.type)){n.push(r);continue}let e=`${r.actor?.id||`anon`}|${r.type}|${w(r.when)}`,i=t.get(e);i||(i=[],t.set(e,i),n.push({__slot:e})),i.push(r)}return n.map(e=>{let n=e.__slot;if(!n)return e;let r=t.get(n)||[];if(r.length===1)return r[0];let i=r[0];return{bundled:!0,id:`bundle_${n}`,type:i.type,actor:i.actor,when:i.when,members:r}})}function E(e){let t=`<strong style="color:#002d5b;">${r(e.actor.name)}</strong>`,n=e.members.length,i=n===1?`trip`:`trips`;switch(e.type){case`friend_created_trip`:return`${t} started planning <strong style="color:#002d5b;">${n} new ${i}</strong>`;case`friend_archived_trip`:return`${t} just completed <strong style="color:#002d5b;">${n} ${i}</strong> 🎉`;case`friend_joined_trip`:return`${t} joined <strong style="color:#002d5b;">${n} ${i}</strong>`;case`new_friendship`:return`You and <strong style="color:#002d5b;">${n} new people</strong> are now friends 🤝`;default:return`${t} did ${n} new things`}}function D(e,t=44){let n=(e?.name||`?`).charAt(0).toUpperCase(),i=`<div style="width:${t}px; height:${t}px; border-radius:50%; background: var(--gradient-day); color:white; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:${Math.round(t*.4)}px; flex-shrink:0; box-shadow: 0 2px 8px rgba(0,113,227,0.18);">${r(n)}</div>`,a=e?.picture?`<img src="${r(e.picture)}" alt="" referrerpolicy="no-referrer"
    ...
    `}function N(e){let t=x.has(e.type),n=!!e.is_bookmarked,i=M({className:`feed-bookmark-btn`,accent:n?C.bookmark:C.muted,dataAttrs:`data-event-id="${r(e.id)}" data-bookmarked="${n?`1`:`0`}"`,title:n?`Remove bookmark`:`Bookmark`,svg:j(`bookmark`,n),marginLeftAuto:!0});if(!t)return`
        ...
        <div class="feed-actions" style="display:flex; align-items:center; gap:10px; margin-top: 10px; padding-top: 10px; border-top: 1px solid rgba(0,45,91,0.06);">
            ${M({className:`feed-like-btn`,accent:a?C.like:C.muted,dataAttrs:`data-event-id="${r(e.id)}" data-liked="${a?`1`:`0`}"`,title:a?`Unlike`:`Like`,svg:j(`heart`,a),count:o,countThreshold:3})}
            ${M({className:`feed-comment-btn`,accent:C.comment,dataAttrs:`data-event-id="${r(e.id)}"`,title:`Comments`,svg:j(`comment`),count:s})}
        ...
        <div class="feed-comment-row" data-comment-id="${e.id}" style="display:flex; align-items:flex-start; gap:10px; padding:8px 0; border-bottom:1px dashed rgba(0,45,91,0.06);">
            ...
            <div style="flex:1; min-width:0;">
                <div style="display:flex; align-items:baseline; gap:8px; flex-wrap:wrap;">
                    ...
                    <span style="font-size:0.7rem; color:var(--text-secondary); font-weight:600; text-transform:uppercase; letter-spacing:0.06em;">${r(O(e.when))}</span>
                </div>
    ...
    `}var F=new Set;function I(e){e.classList.remove(`tap-pop`),e.offsetWidth,e.classList.add(`tap-pop`),e.addEventListener(`animationend`,()=>{e.classList.remove(`tap-pop`)},{once:!0})}var L=[],R={},z=`posts`,B=!1;function V(e,t,n){let i=u.user?.id;e.innerHTML=`
        <div class="feed-comment-list">${n.length>0?n.map(e=>P(e,e.author?.id===i)).join(``):`<div style="font-size:0.82rem; color:var(--text-secondary); padding:6px 0;">${_(`feed.commentsEmpty`)}</div>`}</div>
        ...
        <div style="max-width: 760px; margin: 0 auto;">
            ...
            <div id="feedTabsRow" class="feed-tabs-row">
                ...
                <nav class="home-tabnav home-tabnav--centered" role="tablist" aria-label="Feed sections">
                    <button class="home-tabnav__tab${z===`posts`?` is-active`:``}" data-feed-tab="posts" role="tab" type="button" style="--accent: 88, 86, 214;">${_(`feed.tabPosts`)}</button>
                    <button class="home-tabnav__tab${z===`actions`?` is-active`:``}" data-feed-tab="actions" role="tab" type="button" style="--accent: 255, 149, 0;">${_(`feed.tabActions`)}</button>
                </nav>
    ...
    `;let t=!1,y=()=>{let i=a(e,`#feedList`);if(!i)return;if(!t&&L.length===0){i.innerHTML=`
            ...
            `;return}let o=e=>z===`posts`?x.has(e.type):S.has(e.type),c=L.filter(e=>!(!o(e)||B&&!e.is_bookmarked));if(c.length===0){let t,r,a,o;B?(t=_(z===`posts`?`feed.emptyBookmarkedPostsTitle`:`feed.emptyBookmarkedActionsTitle`),r=_(`feed.emptyBookmarkedBody`),a=_(`feed.emptyBookmarkedCta`),o=()=>{B=!1;let t=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);t&&(t.checked=!1),y()}):z===`posts`?(t=_(`feed.emptyPostsTitle`),r=_(`feed.emptyPostsBody`),a=_(`feed.emptyPostsCta`),o=()=>{z=`actions`,y(),e.querySelectorAll(`.home-tabnav__tab`).forEach(e=>e.classList.toggle(`is-active`,e.dataset.feedTab===`actions`))}):(t=_(`feed.emptyActionsTitle`),r=_(`feed.emptyActionsBody`),a=_(`feed.emptyActionsCta`),o=()=>s(`friends`)),i.innerHTML=n({accent:`purple`,emoji:B?`🔖`:`🌱`,title:t,body:r,ctaLabel:a,ctaId:`feedEmptyCtaBtn`});let c=i.querySelector(`#feedEmptyCtaBtn`);c&&(c.onclick=o);return}let l=u.user?.id;i.innerHTML=T(c).map(e=>{if(e.bundled){let t=e,n=A(t.type),i=O(t.when),a=F.has(t.id),o=t.members.map(e=>{let t=k(e),n=!!e.is_bookmarked;return`
                        <div class="feed-bundle-member" data-event-id="${r(e.id)}" style="display:flex; align-items:center; gap:10px; padding:8px 0; border-top:1px dashed rgba(0,45,91,0.06);">
                            ...
                            <button type="button" class="icon-btn-circle feed-bookmark-btn" style="--accent: ${n?C.bookmark:C.muted};" data-event-id="${r(e.id)}" data-bookmarked="${n?`1`:`0`}" title="${n?`Remove bookmark`:`Bookmark`}" aria-label="${n?`Remove bookmark`:`Bookmark`}">
                                ${j(`bookmark`,n)}
                            </button>
                        </div>
                    `}).join(``);return`
                        ...
                        <div style="display:flex; align-items:flex-start; gap:14px;">
                            ...
                            <div style="flex:1; min-width:0;">
                                <div style="font-size: 0.95rem; line-height:1.4; color: var(--text-secondary);">
                                    <span style="margin-right:6px;">${n.icon}</span>${E(t)}
                                </div>
                ...
                `}let t=e,n=A(t.type),i=O(t.when),a=t.caption?`
            ...
            `:``;return`
                <div class="card glass feed-event" data-event-id="${r(t.id)}"
                    ...
                    <div style="display:flex; align-items:flex-start; gap:14px;">
                        ...
                        <div style="flex:1; min-width:0;">
                            <div style="font-size: 0.95rem; line-height:1.4; color: var(--text-secondary);">
                                <span style="margin-right:6px;">${n.icon}</span>${k(t)}
                            </div>
                            ${i?`<div style="font-size: 0.72rem; color: var(--text-secondary); margin-top: 4px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em;">${r(i)}</div>`:``}
                        </div>
                        ${s}
            ...
            `}).join(``)},b=async()=>{if(!u.user){t=!0,y();return}try{let e=await h(`/api/feed`);if(!e.ok)return;let t=await e.json();Array.isArray(t)&&(L=t)}catch(e){console.error(`Feed refresh failed:`,e)}finally{t=!0,y()}};e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(t=>{t.onclick=()=>{let n=t.dataset.feedTab;!n||z===n||(z=n,e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(e=>{e.classList.toggle(`is-active`,e.dataset.feedTab===n)}),y())}});let w=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);return w&&w.addEventListener(`change`,()=>{B=!!w.checked,y()}),e.addEventListener(`click`,async e=>{let t=e.target;if(!t)return;let n=t.closest(`.feed-avatar-btn`);if(n?.dataset.feedAvatarUserId){s(`profile`,{userId:n.dataset.feedAvatarUserId});return}let r=t.closest(`.feed-trip-card`);if(r?.dataset.tripId){c(r.dataset.tripId);return}let a=t.closest(`.feed-like-btn`);if(a?.dataset.eventId){let e=a.dataset.eventId,t=a.dataset.liked===`1`,n=!t,r=L.find(t=>t.id===e);r&&(r.is_liked=n,r.like_count=Math.max(0,(r.like_count||0)+(t?-1:1))),a.dataset.liked=n?`1`:`0`,a.style.setProperty(`--accent`,n?C.like:C.muted),a.innerHTML=j(`heart`,n),I(a);let i=a.parentElement?.querySelector(`.feed-action-count`),o=e=>e>=3?String(e):``;i&&r&&(i.textContent=o(r.like_count??0));let s=await d(e);s.ok&&s.body&&r&&(r.is_liked=!!s.body.liked,r.like_count=Number(s.body.count)||0,i&&(i.textContent=o(r.like_count)));return}let u=t.closest(`.feed-bookmark-btn`);if(u?.dataset.eventId){let e=u.dataset.eventId,t=u.dataset.bookmarked!==`1`,n=L.find(t=>t.id===e);n&&(n.is_bookmarked=t),u.dataset.bookmarked=t?`1`:`0`,u.style.setProperty(`--accent`,t?C.bookmark:C.muted),u.innerHTML=j(`bookmark`,t),I(u),B&&!t&&y(),await l(e);return}let f=t.closest(`.feed-bundle-toggle`);if(f?.dataset.bundleId){let e=f.dataset.bundleId;F.has(e)?F.delete(e):F.add(e),y();return}let h=t.closest(`.feed-comment-btn`);if(h?.dataset.eventId){let e=h.dataset.eventId,t=h.closest(`.feed-event`)?.querySelector(`.feed-thread`);if(!t)return;if(t.style.display!==`none`){t.style.display=`none`;return}t.style.display=`block`,R[e]?V(t,e,R[e]):(t.innerHTML=`<div style="font-size:0.82rem; color:var(--text-secondary); padding:6px 0;">${_(`feed.commentsLoading`)}</div>`,R[e]=await g(e)||[],V(t,e,R[e]));let n=t.querySelector(`input[name="body"]`);n&&n.focus();return}let x=t.closest(`.feed-comment-delete-btn`);if(x?.dataset.commentId){let e=Number(x.dataset.commentId),t=x.closest(`.feed-comment-row`),n=x.closest(`.feed-thread`),r=n?.dataset.eventId;t&&t.remove(),r&&R[r]&&(R[r]=R[r].filter(t=>t.id!==e));let i=r?L.find(e=>e.id===r):null;if(i){i.comment_count=Math.max(0,(i.comment_count||0)-1);let e=((n?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=i.comment_count>0?String(i.comment_count):``)}(await p(e)).ok||o(`Couldn't delete — try again in a moment.`);return}let S=t.closest(`.feed-unshare-btn`);if(S?.dataset.postId){let e=Number(S.dataset.postId);i({title:_(`feed.toastUnshareConfirmTitle`),message:_(`feed.toastUnshareConfirmMessage`),confirmText:_(`feed.toastUnshareConfirmBtn`),onConfirm:async()=>{let t=await m(e);if(!t||!t.ok){o(_(`feed.toastUnshareFailed`));return}await b(),o(_(`feed.toastRemovedFromFeed`))}});return}let w=t.closest(`.feed-repost-btn`);if(w?.dataset.postId){let e=Number(w.dataset.postId),t=w.style.getPropertyValue(`--accent`)||C.muted;w.disabled=!0,w.style.setProperty(`--accent`,C.muted);let n=await v(e);n.ok&&n.body?.status!==`same_user`?(o(n.body?.status===`already_reposted`?_(`feed.toastAlreadyReposted`):_(`feed.toastReposted`)),w.style.setProperty(`--accent`,C.repost),w.innerHTML=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>`,I(w)):n.body?.status===`same_user`?(w.disabled=!1,w.style.setProperty(`--accent`,t),o(_(`feed.toastRepostOwnShare`))):(w.disabled=!1,w.style.setProperty(`--accent`,t),o(_(`feed.toastRepostFailed`)));return}}),e.addEventListener(`submit`,async e=>{let t=e.target;if(!t?.classList?.contains(`feed-comment-form`))return;e.preventDefault();let n=t.dataset.eventId;if(!n)return;let r=t.querySelector(`input[name="body"]`),i=r?.value.trim();if(!i)return;let a=t.querySelector(`.feed-comment-submit`);r&&(r.value=``),a&&(a.disabled=!0);let s=await f(n,i);if(a&&(a.disabled=!1),!s.ok||!s.body?.comment){r&&(r.value=i),o(`Couldn't post comment — try again.`);return}let c=s.body.comment;R[n]||(R[n]=[]),R[n].push(c);let l=t.closest(`.feed-thread`);l&&V(l,n,R[n]);let u=l?.querySelector(`input[name="body"]`);u&&u.focus();let d=L.find(e=>e.id===n);if(d){d.comment_count=(d.comment_count||0)+1;let e=((l?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=String(d.comment_count))}}),y(),b(),e}var U=t();function W(){let e=(0,b.useRef)(null);return(0,b.useEffect)(()=>{let t=e.current;t&&(t.innerHTML=``,t.appendChild(H()))},[]),(0,U.jsx)(`div`,{ref:e})}function G(e){y(e,(0,b.createElement)(W))}export{G as mountFeed};
//# sourceMappingURL=mount-BvSlWkeE.js.map