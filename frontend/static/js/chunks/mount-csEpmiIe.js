import{i as e}from"./rolldown-runtime-Kw0j5LDr.js";import{r as t,t as n}from"./vendor-react-mHyv4XDd.js";import{A as r,Bt as i,Gt as a,Ht as o,Kt as s,Qt as c,S as l,T as u,Wt as d,Yt as f,Zt as p,at as m,cn as h,ht as g,in as _,ln as v,mn as y,rn as b,sn as x,x as S,zt as C}from"../app.bundle.js";import{t as w}from"./store-CFYrdkNV.js";import{n as T}from"./TripContext-BqUNq4lP.js";var E=e(t(),1);function D(e,t,n){let r=t.fromName||void 0;if(!r||e[r]===void 0){let i=h(n,t.fromUserId)?.name;i&&e[i]!==void 0&&(r=i)}let i=t.toName||void 0;if(!i||e[i]===void 0){let r=h(n,t.toUserId)?.name;r&&e[r]!==void 0&&(i=r)}if(!r||!i)return;e[r]===void 0&&(e[r]=0),e[i]===void 0&&(e[i]=0);let a=t.euroValue||t.amount||0;e[r]+=a,e[i]-=a}function O(e){if(!e)return{balances:{},roster:[],expenses:[],removedFromRoster:[]};let t=(b.expenses||[]).filter(t=>t.tripId===e.id),n=v(e),r=Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i=Array.from(new Set([...n,...r])),a=r.filter(e=>!n.includes(e)),o={};i.forEach(e=>o[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(o[e.who]!==void 0&&(o[e.who]+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t||0),0),r=n>0?n:100;for(let[n,i]of Object.entries(e.splits))o[n]!==void 0&&(o[n]-=t*(Number(i)/r))}else{let e=t/Math.max(i.length,1);i.forEach(t=>{o[t]!==void 0&&(o[t]-=e)})}}let s=(b.settlements||[]).filter(t=>t.tripId===e.id);for(let t of s)D(o,t,e);return{balances:o,roster:i,expenses:t,removedFromRoster:a}}var k=.5;function A(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>k?t.push({person:r,amount:i}):i<-k&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<k&&i++,o.amount<k&&a++}return r}function j(){let e={};for(let t of[...b.trips,...b.archivedTrips||[]])for(let n of v(t))n in e||(e[n]=0);let t=new Set,n=[];for(let e of b.expenses)t.has(e.id)||(t.add(e.id),n.push(e));for(let e of b.archivedTrips||[])for(let r of e.expenses||[])t.has(r.id)||(t.add(r.id),n.push(r));for(let t of n)if(t.who&&!(t.who in e)&&(e[t.who]=0),t.splits)for(let n of Object.keys(t.splits))n&&!(n in e)&&(e[n]=0);let r={};for(let e of[...b.trips,...b.archivedTrips||[]])r[e.id]=v(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0){let r=Object.values(t.splits).reduce((e,t)=>e+(Number(t)||0),0);if(r>0)for(let[i,a]of Object.entries(t.splits))e[i]!==void 0&&(e[i]-=n*Number(a)/r)}else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}let i=new Map;for(let e of[...b.trips,...b.archivedTrips||[]])i.set(e.id,e);let a=new Set,o=[];for(let e of b.settlements||[])a.has(e.id)||(a.add(e.id),o.push(e));for(let e of b.archivedTrips||[]){let t=e.settlements||[];for(let e of t)a.has(e.id)||(a.add(e.id),o.push(e))}for(let t of o){let n=i.get(t.tripId);n||console.warn(`[balances] settlement`,t.id,`trip`,t.tripId,`not in local cache — using snapshot names`),D(e,t,n||null)}return e}function M(e){if(!e)return[];let t=(b.expenses||[]).filter(t=>t.tripId===e.id),n=v(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t),0),i=n>0?n:100;for(let[n,a]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(a)/i))}else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function N(e){let t=0,n=0;for(let r of b.expenses||[])r.tripId===e&&r.isSettlement&&(t+=1,n+=r.euroValue||0);for(let r of b.settlements||[])r.tripId===e&&(t+=1,n+=r.euroValue||r.amount||0);return{count:t,eurTotal:n}}function P(e,t,n,r){let i=n===`global`?``:F(r),a=`
    ...
    `:`
        ...
        `}function F(e){if(b.trips.length===0)return``;let t=b.trips.find(t=>t.id===e),n=t?N(t.id).eurTotal:0,r=b.trips.map(t=>{let n=N(t.id).eurTotal,r=n>0?` — ${p(n,`EUR`)} ${S(`settlement.settledSuffix`)}`:``;return`<option value="${o(t.id)}"${t.id===e?` selected`:``}>${o(t.name)}${r}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color: var(--accent-blue-deep); font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${p(n,`EUR`)} ${S(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    ...
    `}function L(e,t){let{balances:n,removedFromRoster:r}=O(e),i=new Set(r||[]),a=A(n),s=M(e),c=s.reduce((e,t)=>e+t.paid,0),u=[...s].sort((e,t)=>t.paid-e.paid)[0],d=[...s].sort((e,t)=>e.net-t.net)[0],f=[...s].sort((e,t)=>t.net-e.net)[0],m=o(e?.name||`Trip`),h=c>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    <div style="font-size:0.66rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary); margin-bottom:6px;">${S(`settlement.tripTotal`)} · ${m}</div>
                    <div style="font-size:2rem; font-weight:800; color: var(--text-brand-navy); letter-spacing:-0.02em;">${p(c,`EUR`)}</div>
                </div>
                ${u?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${o(u.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${p(u.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${f&&f.net>.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${o(f.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:#1a6b3c;">+${p(f.net,`EUR`)}</div>
                    </div>
                `:``}
                ${d&&d.net<-.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${o(d.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:#a30000;">${p(d.net,`EUR`)}</div>
                    </div>
                `:``}
            </div>
        </div>
    `:``,g=Object.entries(n).map(([e,t])=>{let n=t>.01,r=t<-.01,a=i.has(e)?`<span style="margin-left:6px; padding:1px 6px; border-radius:6px; background:rgba(0,0,0,0.06); color:var(--text-secondary); font-size:0.7rem; font-weight:700; text-transform:uppercase;">removed</span>`:``;return`
            ...
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:16px;">
                <div class="stl-flex-grow-truncate">
                    <div class="stl-flex-row-wrap-6">
                        <span style="font-weight:700; color:var(--text-secondary); font-size:0.78rem;">${o(n.from)}</span>
                        <span style="color:rgba(0,0,0,0.3);">→</span>
                        <span class="stl-heading-3">${o(n.to)}</span>
                    </div>
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:18px; margin-bottom:24px;">
            <div class="card glass stl-card-major">
                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px;">
                    <h3 class="stl-heading-1">${S(`settlement.tripBalancesTitle`)} · ${m}</h3>
            ...
            <div class="card glass stl-card-major">
                <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:12px; margin-bottom:14px;">
                    <div style="min-width:0;">
                        <h3 class="stl-heading-1">${S(`settlement.suggestedPaymentsTitle`)} · ${m}</h3>
        ...
        `:``}
    `}function R(e){let t=[];for(let n of b.expenses||[]){if(!(n.tripId===e.id&&n.isSettlement))continue;let r=Object.keys(n.splits||{})[0]||`?`;t.push({id:n.id,source:`expense`,who:n.who||`?`,to:r,euroValue:n.euroValue||0,date:n.date||``})}for(let n of b.settlements||[]){if(n.tripId!==e.id)continue;let r=h(e,n.fromUserId)?.name,i=h(e,n.toUserId)?.name;!r||!i||t.push({id:n.id,source:`settlement`,who:r,to:i,euroValue:n.euroValue||n.amount||0,date:(n.createdAt||``).slice(0,10),method:n.method??null,note:n.note??null})}return t.sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),t}function z(e,t){let n=R(e);if(n.length===0)return`
                ...
                ${u.map(n=>{let i=r[n],a=i.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                <h4 style="margin:0; font-size:0.7rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary);">${o(c(n))}</h4>
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${l(`settlement.historyDayTotalPlural`,i.length,{amount:p(a,`EUR`)})}</span>
                            </div>
                            <div class="stl-flex-col-8">
                                ${i.map(n=>{let r=(n.who||`?`).charAt(0).toUpperCase(),i=n.method&&n.source===`settlement`?`<span style="display:inline-flex; align-items:center; gap:3px; background:rgba(0,113,227,0.08); color:var(--accent-blue-deep); padding:1px 8px; border-radius:999px; font-size:0.62rem; font-weight:700; text-transform:uppercase; letter-spacing:0.05em;">${o(n.method.replace(/_/g,` `))}</span>`:``,a=n.note&&n.source===`settlement`?`<div style="font-size:0.78rem; color:var(--text-secondary); margin-top:4px; font-style:italic;">"${o(n.note)}"</div>`:``,s=t&&n.source===`expense`?`<button class="edit-settlement-btn" data-settlement-id="${o(n.id)}" type="button"
                                                style="background:rgba(0,113,227,0.08); border:1px solid rgba(0,113,227,0.22); color: var(--accent-blue-deep); padding:5px 12px; border-radius:999px; font-size:0.72rem; font-weight:800; cursor:pointer;">${S(`settlement.historyEditBtn`)}</button>`:``,c=t?`<button class="unsettle-settlement-btn" data-settlement-id="${o(n.id)}" data-source="${o(n.source)}" data-trip-id="${o(e.id)}" type="button"
                                        ...
                                        <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                                            <div style="width:34px; height:34px; border-radius:50%; background:rgba(52,199,89,0.12); color:#1a6b3c; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:0.95rem; flex-shrink:0;">${o(r)}</div>
                                            <div class="stl-flex-grow-truncate">
                                                <div class="stl-flex-row-wrap-6">
                                                    <span class="stl-heading-3">${o(n.who)}</span>
    ...
    `}function B(){let e=j(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),r=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
                ...
                ${t.map(([e,t])=>{let i=r?Math.min(Math.abs(t)/n*100,100):0,a=t>.01,s=t<-.01,c=a?`#1a6b3c`:s?`#a30000`:`var(--text-secondary)`;return`
                        <div style="display:flex; flex-direction:column; gap:10px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                            <div style="display:flex; align-items:center; gap:14px;">
                                ...
                                <div style="flex:1; min-width:0; font-weight:800; color: var(--text-brand-navy); font-size:0.95rem; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">${o(e)}</div>
                ...
                <div style="display:flex; flex-direction:column; gap:10px;">
                    ${i.map(e=>`
                        <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:16px;">
                            <div class="stl-flex-grow-truncate">
                                <div class="stl-flex-row-wrap-6">
                                    <span style="font-weight:700; color:var(--text-secondary); font-size:0.78rem;">${o(e.from)}</span>
                                    <span style="color:rgba(0,0,0,0.3);">→</span>
                                    <span class="stl-heading-3">${o(e.to)}</span>
                                </div>
        ...
        `:``}
    `}async function V(e,t,n,r,i,a){if(t===n){s(S(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(r)||r<=0){s(S(`settlement.toastAmountInvalid`));return}if(typeof navigator<`u`&&navigator.onLine===!1){s(S(`errors.offline`));return}let o=f(r,i,`EUR`),c=b.trips.find(t=>t.id===e),l=x(c,t)?.linkedUserId,h=x(c,n)?.linkedUserId;if(l&&h){let c=await u({tripId:e,fromUserId:l,toUserId:h,amount:r,currency:i,euroValue:o,...a?.method?{method:a.method}:{},...a?.note?{note:a.note}:{}});c.settlement?(b.settlements.push(c.settlement),_(y.STATE_CHANGED),s(S(`settlement.toastRecordedNotified`,{amount:p(o,`EUR`),from:t,to:n}))):(console.warn(`[settlement] /api/settlements failed:`,c.error),s(S(`settlement.toastSettlementFailed`,{error:c.error||S(`settlement.toastSettlementFailedNetwork`)})),_(y.STATE_CHANGED));return}let g={id:d(),tripId:e,label:S(`settlement.settlementLabel`,{from:t,to:n}),value:r,euroValue:o,currency:i,who:t,categoryId:b.categories[0]?.id??``,country:S(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};b.expenses.push(g),_(y.STATE_CHANGED),m(g),s(S(`settlement.toastRecorded`,{amount:p(o,`EUR`),from:t,to:n}))}async function H(e,t=`expense`){C({title:S(`settlement.toastUnsettleConfirmTitle`),message:S(`settlement.toastUnsettleConfirmMessage`),confirmText:S(`settlement.toastUnsettleConfirmBtn`),onConfirm:async()=>{if(t===`settlement`){let t=await r(e);if(t.error){console.warn(`[settlement] delete failed:`,t.error),s(`Couldn't undo: ${t.error||`Network error`}`);return}b.settlements=b.settlements.filter(t=>t.id!==e),_(y.STATE_CHANGED);return}b.expenses=b.expenses.filter(t=>t.id!==e),_(y.STATE_CHANGED)}})}var U=[{value:`cash`,labelKey:`settlement.methodCash`},{value:`revolut`,labelKey:`settlement.methodRevolut`},{value:`bank_transfer`,labelKey:`settlement.methodBankTransfer`},{value:`wise`,labelKey:`settlement.methodWise`},{value:`paypal`,labelKey:`settlement.methodPayPal`},{value:`custom`,labelKey:`settlement.methodCustom`}];function W(e){let t=b.trips.find(t=>t.id===e),n=v(t).map(e=>`<option value="${o(e)}">${o(e)}</option>`).join(``),r=U.map(e=>`<option value="${o(e.value)}">${o(S(e.labelKey))}</option>`).join(``),l=c(),{root:u,close:d}=i({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                <label class="form-label">${o(S(`settlement.labelFrom`))}</label>
                <select id="manualSettleFrom" class="glass-input stl-card-minor-bg">${n}</select>
                <label class="form-label stl-mt-6">${o(S(`settlement.labelTo`))}</label>
                <select id="manualSettleTo" class="glass-input stl-card-minor-bg">${n}</select>
                <label class="form-label stl-mt-6">${o(S(`settlement.labelAmount`,{currency:l}))}</label>
                ...
                <label class="form-label stl-mt-6">${o(S(`settlement.labelMethod`))}</label>
                <select id="manualSettleMethod" class="glass-input stl-card-minor-bg">${r}</select>
                <label class="form-label stl-mt-6">${o(S(`settlement.labelNote`))} <span class="text-subtitle" style="font-weight:500;">${o(S(`settlement.labelNoteOptional`))}</span></label>
                <input type="text" id="manualSettleNote" class="glass-input" maxlength="240" placeholder="${o(S(`settlement.notePlaceholder`))}" class="stl-card-minor">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
                    <button type="button" id="cancelManualSettleBtn" class="btn-neutral" style="flex:1; border-radius: var(--radius-lg);">${o(S(`settlement.cancelBtn`))}</button>
                    <button type="submit" class="btn-primary" style="flex:2; border-radius: var(--radius-lg);">${o(S(`settlement.recordPaymentBtn`))}</button>
                </div>
            </form>
        `});a(u,`#cancelManualSettleBtn`).onclick=()=>d(),a(u,`#manualSettleForm`).onsubmit=n=>{n.preventDefault();let r=a(u,`#manualSettleFrom`).value,i=a(u,`#manualSettleTo`).value,o=parseFloat(a(u,`#manualSettleAmount`).value),c=a(u,`#manualSettleMethod`).value,f=a(u,`#manualSettleNote`).value.trim();if(r===i){s(S(`settlement.toastSenderEqualsReceiver`));return}let m=G(t,r,i,l),h=()=>{V(e,r,i,o,l,{method:c,note:f}),d()};if(o>m+.005){C({title:S(`settlement.overpayConfirmTitle`),message:m>.005?S(`settlement.overpayConfirmBody`,{amount:p(o,l),owed:p(m,l),from:r,to:i}):S(`settlement.overpayConfirmBodyNone`,{amount:p(o,l),from:r,to:i}),confirmText:S(`settlement.overpayConfirmBtn`),onConfirm:h});return}h()}}function G(e,t,n,r){if(!e)return 0;let{balances:i}=O(e),a=A(i).find(e=>e.from===t&&e.to===n);return a?f(a.amount,`EUR`,r):0}function K(e){let t=b.expenses.find(t=>t.id===e);if(!t)return;let n=v(b.trips.find(e=>e.id===t.tripId)),r=n.map(e=>`<option value="${o(e)}" ${t.who===e?`selected`:``}>${o(e)}</option>`).join(``),l=Object.keys(t.splits||{})[0],u=n.map(e=>`<option value="${o(e)}" ${l===e?`selected`:``}>${o(e)}</option>`).join(``),d=c(),{root:p,close:h}=i({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label stl-mt-6">${o(S(`settlement.labelAmount`,{currency:d}))}</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${f(t.euroValue||0,`EUR`,d).toFixed(2)}" class="glass-input" required class="stl-card-minor">
                <label class="form-label stl-mt-6">${o(S(`settlement.labelDate`))}</label>
                <input type="date" id="editSettleDate" value="${o(t.date||``)}" class="glass-input" required class="stl-card-minor">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
                    <button type="button" id="cancelEditSettleBtn" class="btn-neutral" style="flex:1; border-radius: var(--radius-lg);">${o(S(`settlement.cancelBtn`))}</button>
                    <button type="submit" class="btn-primary" style="flex:2; border-radius: var(--radius-lg);">${o(S(`settlement.updateBtn`))}</button>
                </div>
            </form>
        `});a(p,`#cancelEditSettleBtn`).onclick=()=>h(),a(p,`#editSettlementForm`).onsubmit=e=>{e.preventDefault();let n=a(p,`#editSettleFrom`).value,r=a(p,`#editSettleTo`).value,i=parseFloat(a(p,`#editSettleAmount`).value),o=a(p,`#editSettleDate`).value;if(n===r){s(S(`settlement.toastSenderEqualsReceiver`));return}t.who=n,t.splits={[r]:100},t.value=i,t.currency=d,t.euroValue=f(i,d,`EUR`),t.date=o,t.label=S(`settlement.settlementLabel`,{from:n,to:r}),_(y.STATE_CHANGED),m(t),h()}}var q=n();function J(){let e=w(e=>e.trips),t=w(e=>e.activeTripId),n=w(e=>e.expenses),[r,i]=(0,E.useState)(`trip`),[a,o]=(0,E.useState)(()=>t||(e.length>0?e[0].id:null));(0,E.useEffect)(()=>{t&&t!==a&&o(t)},[t,a]),(0,E.useEffect)(()=>{if(a&&!e.find(e=>e.id===a)){let t=e.length>0?e[0].id:null;o(t),t&&(b.activeTripId=t,_(y.STATE_CHANGED))}},[e,a]);let s=e=>{o(e),b.activeTripId=e,_(y.STATE_CHANGED),r===`global`&&i(`trip`)},{trip:c,canEditExpenses:l}=T(a),u=(0,E.useMemo)(()=>P(c,l,r,a),[c,l,r,a,n]),d=(0,E.useRef)(null),f=e=>{let t=e.target;if(!t)return;let n=t.closest(`.settlement-trip-pill`);if(n?.dataset.tripId){s(n.dataset.tripId);return}let r=t.closest(`.settle-tab`);if(r?.dataset.tab){i(r.dataset.tab);return}let a=t.closest(`.settle-debt-btn`);if(a?.dataset.tripId&&a.dataset.from&&a.dataset.to&&a.dataset.amount&&!a.disabled){a.disabled=!0,a.textContent=S(`settlement.recordingBtn`),V(a.dataset.tripId,a.dataset.from,a.dataset.to,parseFloat(a.dataset.amount),`EUR`);return}let o=t.closest(`.open-manual-settle-btn`);if(o?.dataset.tripId){W(o.dataset.tripId);return}let c=t.closest(`.edit-settlement-btn`);if(c?.dataset.settlementId){K(c.dataset.settlementId);return}let l=t.closest(`.unsettle-settlement-btn`);if(l?.dataset.settlementId){let e=l.dataset.source===`settlement`?`settlement`:`expense`;H(l.dataset.settlementId,e);return}},p=(0,E.useRef)(s);return p.current=s,(0,E.useEffect)(()=>{let e=d.current;if(!e)return;let t=e=>{let t=e.target;if(t?.id===`settlementTripSelect`){let e=t;e.value&&p.current(e.value)}};return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,q.jsx)(`div`,{ref:d,onClick:f,dangerouslySetInnerHTML:{__html:u}})}function Y(e){g(e,(0,E.createElement)(J))}export{Y as mountSettlement};
//# sourceMappingURL=mount-csEpmiIe.js.map