import{n as e}from"./rolldown-runtime-Kw0j5LDr.js";import{Mn as t,N as n,Nn as r,Nt as i,_n as a,cn as o,dn as s,gn as c,j as l,on as u,z as d}from"../app.bundle.js";var f=e=>{if(!e||!e.id){a(n(`modals.pdfErrorNoTrip`));return}let t=e.name||n(`feed.tripFallback`),{root:r,close:d}=u({innerHTML:`
    ...
    `,cardStyle:`max-width: 560px; width: min(560px, calc(100vw - 24px)); padding: 0; overflow: hidden; background: white;`});function f(e,t,r,i=!0){let a=!i,o=a?`background:rgba(0,45,91,0.03); border:1px dashed rgba(0,45,91,0.16);`:`background:rgba(0,113,227,0.04); border:1px solid rgba(0,113,227,0.10);`,c=a?`<span style="display:inline-block; margin-left:6px; padding:1px 6px; border-radius:999px; background:rgba(0,45,91,0.06); color:#4a5568; font-size:0.62rem; font-weight:700; letter-spacing:0.01em; vertical-align:middle; white-space:nowrap;">${s(n(`modals.pdfOptOffByDefault`))}</span>`:``;return`
        ...
        `}let p=c(r,`#cancelPdfBtn`),m=c(r,`#submitPdfBtn`),h=c(r,`#pdfBtnLabel`);p&&(p.onclick=()=>d()),m&&(m.onclick=async()=>{let t=r.querySelectorAll(`#pdfExportOptions input[type="checkbox"]`),o={};t.forEach(e=>{o[e.name]=e.checked}),o.locale=l(),m.disabled=!0,h&&(h.textContent=n(`modals.pdfStatusBuilding`));try{let t=await i(`/api/trips/${e.id}/pdf`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(o)});if(!t.ok){let e=``;try{let n=await t.json();n&&typeof n.error==`string`&&(e=n.error)}catch{}a(e||n(`modals.pdfErrorBuild`));return}let r=await t.blob(),s=URL.createObjectURL(r),c=navigator.userAgent||``,l=/iPad|iPhone|iPod/.test(c)||c.includes(`Mac`)&&`ontouchend`in document,u=(e.name||`trip`).replace(/[^A-Za-z0-9 _-]/g,`_`).trim()||`trip`;if(l)window.open(s,`_blank`)||(window.location.href=s),setTimeout(()=>URL.revokeObjectURL(s),6e4);else{let e=document.createElement(`a`);e.href=s,e.download=`${u}.pdf`,document.body.appendChild(e),e.click(),setTimeout(()=>{document.body.removeChild(e),URL.revokeObjectURL(s)},100)}d()}catch{a(n(`modals.pdfErrorNetwork`))}finally{m.disabled=!1,h&&(h.textContent=n(`modals.pdfDownloadBtn`))}})},p=e({importTripFromFile:()=>C,openDownloadChooserModal:()=>x}),m=e=>(e||`trip`).replace(/[^A-Za-z0-9 _-]/g,`_`).trim()||`trip`;function h(e,t){let n=URL.createObjectURL(e),r=navigator.userAgent||``;if(/iPad|iPhone|iPod/.test(r)||r.includes(`Mac`)&&`ontouchend`in document){window.open(n,`_blank`)||(window.location.href=n),setTimeout(()=>URL.revokeObjectURL(n),6e4);return}let i=document.createElement(`a`);i.href=n,i.download=t,document.body.appendChild(i),i.click(),setTimeout(()=>{document.body.removeChild(i),URL.revokeObjectURL(n)},100)}async function g(e){try{let t=await i(`/api/trips/${e.id}/export`);if(!t.ok){let e=``;try{let n=await t.json();n&&typeof n.error==`string`&&(e=n.error)}catch{}return a(e||n(`modals.downloadZipError`)),!1}return h(await t.blob(),`${m(e.name)}.ggtrip.zip`),!0}catch{return a(n(`modals.downloadZipError`)),!1}}var _=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="15" x2="15" y2="15"/><line x1="9" y1="11" x2="12" y2="11"/></svg>`,v=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 8v13H3V8"/><path d="M1 3h22v5H1z"/><line x1="10" y1="12" x2="14" y2="12"/></svg>`,y=`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" style="opacity:0.32; flex-shrink:0;"><polyline points="9 18 15 12 9 6"/></svg>`;function b(e,t,n,r,i){return`
        <button type="button" id="${e}" style="display:flex; align-items:center; gap:14px; width:100%; text-align:left; padding:14px 16px; border-radius:16px; border:1px solid rgba(0,0,0,0.08); background:#fff; cursor:pointer; transition:border-color 0.15s, box-shadow 0.15s, transform 0.1s;"
            ...
            ${y}
        </button>`}var x=e=>{if(!e||!e.id){a(n(`modals.pdfErrorNoTrip`));return}let{root:t,close:r}=u({innerHTML:`
        ...
        </div>`,cardStyle:`max-width: 420px; width: min(420px, calc(100vw - 24px)); background:#fff;`}),i=t.querySelector(`#chooserPdfBtn`),o=t.querySelector(`#chooserZipBtn`),s=t.querySelector(`#chooserCancelBtn`);if(s&&(s.onclick=()=>r()),i&&(i.onclick=()=>{r(),f(e)}),o){let t=o.querySelector(`[data-sub]`);o.onclick=async()=>{if(o.disabled=!0,i&&(i.disabled=!0),t&&(t.textContent=n(`modals.downloadZipStatus`)),await g(e)){r();return}o.disabled=!1,i&&(i.disabled=!1),t&&(t.textContent=n(`modals.downloadZipOptionBodyV2`))}}},S=64*1024*1024;async function C(e){if(e.size&&e.size>S)return{ok:!1,error:n(`modals.importTripTooLarge`)};let a=new FormData;a.append(`file`,e);let o;try{o=await i(`/api/trips/import`,{method:`POST`,body:a})}catch{return{ok:!1,error:n(`modals.importTripError`)}}if(!o.ok){let e=``;try{let t=await o.json();t&&typeof t.error==`string`&&(e=t.error)}catch{}return{ok:!1,error:e||n(`modals.importTripError`)}}let s={};try{s=await o.json()}catch{}return s.tripId?(await d(),t.activeTripId=s.tripId,r(`state:changed`),{ok:!0}):{ok:!1,error:n(`modals.importTripError`)}}export{f as i,x as n,p as r,C as t};
//# sourceMappingURL=tripExport-CI-VAkuZ.js.map