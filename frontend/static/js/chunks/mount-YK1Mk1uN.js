import{r as e}from"./rolldown-runtime-C3V63i2j.js";import{r as t,t as n}from"./vendor-react-BRKukhy3.js";import{At as r,Ct as i,Et as a,Ft as o,It as s,Jt as c,Nt as l,Ot as u,Ut as d,Wt as f,Yt as p,b as m,en as h,it as g,k as _,kt as v,qt as y,w as b,wt as x,y as S}from"../app.bundle.js";import{t as C}from"./store-DBTH-s7D.js";import{n as w}from"./TripContext-DzM3vEmg.js";var T=e(t(),1);function E(e,t,n){let r=c(n,t.fromUserId)?.name,i=c(n,t.toUserId)?.name;if(!r||!i||e[r]===void 0||e[i]===void 0)return;let a=t.euroValue||t.amount||0;e[r]+=a,e[i]-=a}function D(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(d.expenses||[]).filter(t=>t.tripId===e.id),n=p(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i={};r.forEach(e=>i[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]!==void 0&&(i[e.who]+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t||0),0),r=n>0?n:100;for(let[n,a]of Object.entries(e.splits))i[n]!==void 0&&(i[n]-=t*(Number(a)/r))}else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]!==void 0&&(i[t]-=e)})}}let a=(d.settlements||[]).filter(t=>t.tripId===e.id);for(let t of a)E(i,t,e);return{balances:i,roster:r,expenses:t}}function O(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function k(){let e={};for(let t of[...d.trips,...d.archivedTrips||[]])for(let n of p(t))n in e||(e[n]=0);let t=(d.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...d.expenses,...t],r={};for(let e of[...d.trips,...d.archivedTrips||[]])r[e.id]=p(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}let i=new Map;for(let e of[...d.trips,...d.archivedTrips||[]])i.set(e.id,e);for(let t of d.settlements||[]){let n=i.get(t.tripId);n&&E(e,t,n)}return e}function A(e){if(!e)return[];let t=(d.expenses||[]).filter(t=>t.tripId===e.id),n=p(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function j(e){let t=0,n=0;for(let r of d.expenses||[])r.tripId===e&&r.isSettlement&&(t+=1,n+=r.euroValue||0);for(let r of d.settlements||[])r.tripId===e&&(t+=1,n+=r.euroValue||r.amount||0);return{count:t,eurTotal:n}}function M(e,t,n,r){let i=n===`global`?``:N(r),a=`
    ...
    `}async function z(e,t,n,i,a,s){if(t===n){r(S(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(i)||i<=0){r(S(`settlement.toastAmountInvalid`));return}let c=l(i,a,`EUR`),p=d.trips.find(t=>t.id===e),m=y(p,t)?.linkedUserId,g=y(p,n)?.linkedUserId;if(m&&g){let l=await b({tripId:e,fromUserId:m,toUserId:g,amount:i,currency:a,euroValue:c,...s?.method?{method:s.method}:{},...s?.note?{note:s.note}:{}});l.settlement?(d.settlements.push(l.settlement),f(h.STATE_CHANGED),r(`Recorded ${o(c,`EUR`)} ${t} → ${n} · notified ${n}`)):(console.warn(`[settlement] /api/settlements failed:`,l.error),r(`Settlement failed: ${l.error||`Network error`}`),f(h.STATE_CHANGED));return}let _={id:u(),tripId:e,label:`Settlement: ${t} → ${n}`,value:i,euroValue:c,currency:a,who:t,categoryId:d.categories[0]?.id??``,country:S(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};d.expenses.push(_),f(h.STATE_CHANGED),r(`Recorded ${o(c,`EUR`)} ${t} → ${n}`)}async function B(e,t=`expense`){i({title:S(`settlement.toastUnsettleConfirmTitle`),message:S(`settlement.toastUnsettleConfirmMessage`),confirmText:S(`settlement.toastUnsettleConfirmBtn`),onConfirm:async()=>{if(t===`settlement`){let t=await _(e);if(t.error){console.warn(`[settlement] delete failed:`,t.error),r(`Couldn't undo: ${t.error||`Network error`}`);return}d.settlements=d.settlements.filter(t=>t.id!==e),f(h.STATE_CHANGED);return}d.expenses=d.expenses.filter(t=>t.id!==e),f(h.STATE_CHANGED)}})}var V=[{value:`cash`,label:`Cash`},{value:`revolut`,label:`Revolut`},{value:`bank_transfer`,label:`Bank transfer`},{value:`wise`,label:`Wise`},{value:`paypal`,label:`PayPal`},{value:`custom`,label:`Custom`}];function H(e){let t=p(d.trips.find(t=>t.id===e)).map(e=>`<option value="${a(e)}">${a(e)}</option>`).join(``),n=V.map(e=>`<option value="${a(e.value)}">${a(e.label)}</option>`).join(``),i=s(),{root:o,close:c}=x({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label stl-mt-6">Amount (${a(i)})</label>
        ...
        `});v(o,`#cancelManualSettleBtn`).onclick=()=>c(),v(o,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let n=v(o,`#manualSettleFrom`).value,a=v(o,`#manualSettleTo`).value,s=parseFloat(v(o,`#manualSettleAmount`).value),l=v(o,`#manualSettleMethod`).value,u=v(o,`#manualSettleNote`).value.trim();if(n===a){r(S(`settlement.toastSenderEqualsReceiver`));return}z(e,n,a,s,i,{method:l,note:u}),c()}}function U(e){let t=d.expenses.find(t=>t.id===e);if(!t)return;let n=p(d.trips.find(e=>e.id===t.tripId)),i=n.map(e=>`<option value="${a(e)}" ${t.who===e?`selected`:``}>${a(e)}</option>`).join(``),o=Object.keys(t.splits||{})[0],c=n.map(e=>`<option value="${a(e)}" ${o===e?`selected`:``}>${a(e)}</option>`).join(``),u=s(),{root:m,close:g}=x({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label stl-mt-6">Amount (${a(u)})</label>
