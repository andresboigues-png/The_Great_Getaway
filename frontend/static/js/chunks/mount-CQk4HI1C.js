import{r as e,t}from"./vendor-react-CAxw18f3.js";import{$ as n,H as r,K as i,Q as a,S as o,Y as s,Z as c,at as l,ct as u,et as d,n as f,nt as p,ot as m,q as h,rt as g,t as _,ut as v}from"../app.bundle.js";import{t as y}from"./store-DIded1pE.js";var b=e();function x(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(l.expenses||[]).filter(t=>t.tripId===e.id),n=u(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i={};r.forEach(e=>i[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]!==void 0&&(i[e.who]+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))i[n]!==void 0&&(i[n]-=t*(Number(r)/100));else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]!==void 0&&(i[t]-=e)})}}return{balances:i,roster:r,expenses:t}}function S(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function C(){let e={};for(let t of[...l.trips,...l.archivedTrips||[]])for(let n of u(t))n in e||(e[n]=0);let t=(l.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...l.expenses,...t],r={};for(let e of[...l.trips,...l.archivedTrips||[]])r[e.id]=u(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}return e}function w(e){if(!e)return[];let t=(l.expenses||[]).filter(t=>t.tripId===e.id),n=u(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function T(e,t,n,r){let i=E(r),a=`
    ...
    `:`
        ...
        `}function E(e){if(l.trips.length===0)return``;let t=l.trips.find(t=>t.id===e),n=t?(l.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0):0,r=l.trips.map(t=>{let n=(l.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0),r=n>0?` — ${p(n,`EUR`)} ${_(`settlement.settledSuffix`)}`:``;return`<option value="${s(t.id)}"${t.id===e?` selected`:``}>${s(t.name)}${r}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color:#005bb8; font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${p(n,`EUR`)} ${_(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    ...
    `}function O(e,t){let{balances:n}=x(e),r=S(n),i=w(e),a=i.reduce((e,t)=>e+t.paid,0),o=[...i].sort((e,t)=>t.paid-e.paid)[0],c=[...i].sort((e,t)=>e.net-t.net)[0],l=[...i].sort((e,t)=>t.net-e.net)[0],u=a>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color:#002d5b; letter-spacing:-0.02em;">${p(a,`EUR`)}</div>
                </div>
                ${o?`
                ...
                ${u.map(n=>{let i=r[n],a=i.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                ...
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${f(`settlement.historyDayTotalPlural`,i.length,{amount:p(a,`EUR`)})}</span>
                            </div>
                            <div style="display:flex; flex-direction:column; gap:8px;">
    ...
    `}function A(){let e=C(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),r=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        `:``}
    `}function j(e,t,r,i,a){if(t===r){n(_(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(i)||i<=0){n(_(`settlement.toastAmountInvalid`));return}let o=d(i,a,`EUR`),s={id:c(),tripId:e,label:`Settlement: ${t} → ${r}`,value:i,euroValue:o,currency:a,who:t,categoryId:l.categories[0]?.id??``,country:_(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[r]:100},isSettlement:!0};l.expenses.push(s),m(v.STATE_CHANGED),n(`Recorded ${p(o,`EUR`)} ${t} → ${r}`)}function M(e){i({title:_(`settlement.toastUnsettleConfirmTitle`),message:_(`settlement.toastUnsettleConfirmMessage`),confirmText:_(`settlement.toastUnsettleConfirmBtn`),onConfirm:()=>{l.expenses=l.expenses.filter(t=>t.id!==e),m(v.STATE_CHANGED)}})}function N(e){let t=u(l.trips.find(t=>t.id===e)).map(e=>`<option value="${s(e)}">${s(e)}</option>`).join(``),r=g(),{root:i,close:o}=h({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">Amount (${s(r)})</label>
        ...
        `});a(i,`#cancelManualSettleBtn`).onclick=()=>o(),a(i,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let s=a(i,`#manualSettleFrom`).value,c=a(i,`#manualSettleTo`).value,l=parseFloat(a(i,`#manualSettleAmount`).value);if(s===c){n(_(`settlement.toastSenderEqualsReceiver`));return}j(e,s,c,l,r),o()}}function P(e){let t=l.expenses.find(t=>t.id===e);if(!t)return;let r=u(l.trips.find(e=>e.id===t.tripId)),i=r.map(e=>`<option value="${s(e)}" ${t.who===e?`selected`:``}>${s(e)}</option>`).join(``),o=Object.keys(t.splits||{})[0],c=r.map(e=>`<option value="${s(e)}" ${o===e?`selected`:``}>${s(e)}</option>`).join(``),f=g(),{root:p,close:y}=h({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">To</label>
                <select id="editSettleTo" class="glass-input" style="padding: var(--space-3); border-radius: 12px; background:white;">${c}</select>
                <label class="form-label" style="margin-top:6px;">Amount (${s(f)})</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${d(t.euroValue||0,`EUR`,f).toFixed(2)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
