import{r as e,t}from"./vendor-react-CYVQMBjw.js";import{$ as n,G as r,H as i,J as a,Q as o,U as s,X as c,Y as l,it as u,n as d,nt as f,ot as p,q as m,t as h,tt as g,x as _,z as v}from"../app.bundle.js";import{t as y}from"./store-QkOh9Ep7.js";var b=e();function x(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(g.expenses||[]).filter(t=>t.tripId===e.id),n=u(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i={};r.forEach(e=>i[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]!==void 0&&(i[e.who]+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))i[n]!==void 0&&(i[n]-=t*(Number(r)/100));else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]!==void 0&&(i[t]-=e)})}}return{balances:i,roster:r,expenses:t}}function S(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function C(){let e={};for(let t of[...g.trips,...g.archivedTrips||[]])for(let n of u(t))n in e||(e[n]=0);let t=(g.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...g.expenses,...t],r={};for(let e of[...g.trips,...g.archivedTrips||[]])r[e.id]=u(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}return e}function w(e){if(!e)return[];let t=(g.expenses||[]).filter(t=>t.tripId===e.id),n=u(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function T(e,t,n,r){let i=E(r),a=`
    ...
    `:`
        ...
        `}function E(e){if(g.trips.length===0)return``;let t=g.trips.find(t=>t.id===e),n=t?(g.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0):0,i=g.trips.map(t=>{let n=(g.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0),i=n>0?` — ${o(n,`EUR`)} ${h(`settlement.settledSuffix`)}`:``;return`<option value="${r(t.id)}"${t.id===e?` selected`:``}>${r(t.name)}${i}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color:#005bb8; font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${o(n,`EUR`)} ${h(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    `}function D(e,t){let n=(g.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).length,r=(e,n,r)=>`
    ...
    `}function O(e,t){let{balances:n}=x(e),i=S(n),a=w(e),s=a.reduce((e,t)=>e+t.paid,0),c=[...a].sort((e,t)=>t.paid-e.paid)[0],l=[...a].sort((e,t)=>e.net-t.net)[0],u=[...a].sort((e,t)=>t.net-e.net)[0],f=s>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color:#002d5b; letter-spacing:-0.02em;">${o(s,`EUR`)}</div>
                </div>
                ${c?`
    ...
    `:``,p=Object.entries(n).map(([e,t])=>{let n=t>.01,i=t<-.01;return`
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:18px; margin-bottom:24px;">
            ...
            <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
                <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:12px; margin-bottom:14px;">
                    ...
                    <span style="font-size:0.7rem; font-weight:800; color:var(--text-secondary); text-transform:uppercase; letter-spacing:0.1em; flex-shrink:0;">${d(`settlement.paymentsCount`,i.length)}</span>
                </div>
        ...
        `:``}
    `}function k(e,t){let n=(g.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime());if(n.length===0)return`
        ...
        `;let i={};for(let e of n){let t=e.date||`undated`;i[t]||(i[t]=[]),i[t].push(e)}let a=new Date().toISOString().slice(0,10),s=new Date;s.setDate(s.getDate()-1);let c=s.toISOString().slice(0,10),l=e=>{if(e===`undated`)return h(`settlement.historyDateNoDate`);if(e===a)return h(`settlement.historyDateToday`);if(e===c)return h(`settlement.historyDateYesterday`);let t=new Date(e);return isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{weekday:`short`,month:`short`,day:`numeric`,year:`numeric`})},u=Object.keys(i).sort((e,t)=>e===`undated`?1:t===`undated`?-1:t.localeCompare(e));return`
        <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
            ...
            <div style="display:flex; flex-direction:column; gap:18px;">
                ${u.map(n=>{let a=i[n],s=a.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                ...
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${d(`settlement.historyDayTotalPlural`,a.length,{amount:o(s,`EUR`)})}</span>
                            </div>
                            <div style="display:flex; flex-direction:column; gap:8px;">
    ...
    `}function A(){let e=C(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),i=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
            ...
            <div style="display:flex; flex-direction:column; gap:8px;">
                ${t.map(([e,t])=>{let a=i?Math.min(Math.abs(t)/n*100,100):0,s=t>.01,c=t<-.01,l=s?`#1a6b3c`:c?`#a30000`:`var(--text-secondary)`;return`
        ...
        `:``}
    `}function j(e,t,n,r,i){if(t===n){l(h(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(r)||r<=0){l(h(`settlement.toastAmountInvalid`));return}let a=c(r,i,`EUR`),s={id:m(),tripId:e,label:`Settlement: ${t} → ${n}`,value:r,euroValue:a,currency:i,who:t,categoryId:g.categories[0]?.id??``,country:h(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};g.expenses.push(s),f(p.STATE_CHANGED),l(`Recorded ${o(a,`EUR`)} ${t} → ${n}`)}function M(e){i({title:h(`settlement.toastUnsettleConfirmTitle`),message:h(`settlement.toastUnsettleConfirmMessage`),confirmText:h(`settlement.toastUnsettleConfirmBtn`),onConfirm:()=>{g.expenses=g.expenses.filter(t=>t.id!==e),f(p.STATE_CHANGED)}})}function N(e){let t=u(g.trips.find(t=>t.id===e)).map(e=>`<option value="${r(e)}">${r(e)}</option>`).join(``),i=n(),{root:o,close:c}=s({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">Amount (${r(i)})</label>
        ...
        `});a(o,`#cancelManualSettleBtn`).onclick=()=>c(),a(o,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let n=a(o,`#manualSettleFrom`).value,r=a(o,`#manualSettleTo`).value,s=parseFloat(a(o,`#manualSettleAmount`).value);if(n===r){l(h(`settlement.toastSenderEqualsReceiver`));return}j(e,n,r,s,i),c()}}function P(e){let t=g.expenses.find(t=>t.id===e);if(!t)return;let i=u(g.trips.find(e=>e.id===t.tripId)),o=i.map(e=>`<option value="${r(e)}" ${t.who===e?`selected`:``}>${r(e)}</option>`).join(``),d=Object.keys(t.splits||{})[0],m=i.map(e=>`<option value="${r(e)}" ${d===e?`selected`:``}>${r(e)}</option>`).join(``),_=n(),{root:v,close:y}=s({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">To</label>
                <select id="editSettleTo" class="glass-input" style="padding: var(--space-3); border-radius: 12px; background:white;">${m}</select>
                <label class="form-label" style="margin-top:6px;">Amount (${r(_)})</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${c(t.euroValue||0,`EUR`,_).toFixed(2)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
