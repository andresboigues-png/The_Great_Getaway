import{i as e}from"./rolldown-runtime-Kw0j5LDr.js";import{r as t,t as n}from"./vendor-react-mHyv4XDd.js";import{$t as r,C as i,E as a,Gt as o,Jt as s,Lt as c,Qt as l,Rt as u,S as d,Ut as f,Zt as p,an as m,dn as h,en as g,gn as _,j as v,ln as y,on as b,ot as x,pt as S,qt as C,un as w}from"../app.bundle.js";import{t as T}from"./store-XOF4JpMS.js";import{n as E}from"./TripContext-G4-7hAib.js";var D=e(t(),1);function O(e,t,n){let r=t=>{let n=(t||``).split(/\s+/)[0];return n&&e[n]!==void 0?n:void 0},i=t.fromName||void 0;if(!i||e[i]===void 0){let a=w(n,t.fromUserId)?.name;i=a&&e[a]!==void 0?a:r(i)??i}let a=t.toName||void 0;if(!a||e[a]===void 0){let i=w(n,t.toUserId)?.name;a=i&&e[i]!==void 0?i:r(a)??a}if(!i||!a)return;e[i]===void 0&&(e[i]=0),e[a]===void 0&&(e[a]=0);let o=t.euroValue||t.amount||0;e[i]+=o,e[a]-=o}function k(e){if(!e)return{balances:{},roster:[],expenses:[],removedFromRoster:[]};let t=(m.expenses||[]).filter(t=>t.tripId===e.id),n=h(e),r=Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),i=Array.from(new Set([...n,...r])),a=r.filter(e=>!n.includes(e)),o={};i.forEach(e=>o[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(o[e.who]!==void 0&&(o[e.who]+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t||0),0),r=n>0?n:100;for(let[n,i]of Object.entries(e.splits))o[n]!==void 0&&(o[n]-=t*(Number(i)/r))}else{let e=t/Math.max(i.length,1);i.forEach(t=>{o[t]!==void 0&&(o[t]-=e)})}}let s=(m.settlements||[]).filter(t=>t.tripId===e.id);for(let t of s)O(o,t,e);return{balances:o,roster:i,expenses:t,removedFromRoster:a}}var A=.01;function j(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>A?t.push({person:r,amount:i}):i<-A&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<A&&i++,o.amount<A&&a++}return r}function M(){let e={};for(let t of[...m.trips,...m.archivedTrips||[]])for(let n of h(t))n in e||(e[n]=0);let t=new Set,n=[];for(let e of m.expenses)t.has(e.id)||(t.add(e.id),n.push(e));for(let e of m.archivedTrips||[])for(let r of e.expenses||[])t.has(r.id)||(t.add(r.id),n.push(r));for(let t of n)if(t.who&&!(t.who in e)&&(e[t.who]=0),t.splits)for(let n of Object.keys(t.splits))n&&!(n in e)&&(e[n]=0);let r={};for(let e of[...m.trips,...m.archivedTrips||[]])r[e.id]=h(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0){let r=Object.values(t.splits).reduce((e,t)=>e+(Number(t)||0),0);if(r>0)for(let[i,a]of Object.entries(t.splits))e[i]!==void 0&&(e[i]-=n*Number(a)/r)}else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}let i=new Map;for(let e of[...m.trips,...m.archivedTrips||[]])i.set(e.id,e);let a=new Set,o=[];for(let e of m.settlements||[])a.has(e.id)||(a.add(e.id),o.push(e));for(let e of m.archivedTrips||[]){let t=e.settlements||[];for(let e of t)a.has(e.id)||(a.add(e.id),o.push(e))}for(let t of o){let n=i.get(t.tripId);n||console.warn(`[balances] settlement`,t.id,`trip`,t.tripId,`not in local cache — using snapshot names`),O(e,t,n||null)}return e}function N(e){if(!e)return[];let t=(m.expenses||[]).filter(t=>t.tripId===e.id),n=h(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0){let n=Object.values(e.splits).reduce((e,t)=>e+Number(t),0),i=n>0?n:100;for(let[n,a]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(a)/i))}else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function P(e){let t=0,n=0;for(let r of m.expenses||[])r.tripId===e&&r.isSettlement&&(t+=1,n+=r.euroValue||0);for(let r of m.settlements||[])r.tripId===e&&(t+=1,n+=r.euroValue||r.amount||0);return{count:t,eurTotal:n}}function F(e,t,n,r){let i=n===`global`?``:I(r),a=`
    ...
    `:`
        ...
        `}function I(e){if(m.trips.length===0)return``;let t=m.trips.find(t=>t.id===e),n=t?P(t.id).eurTotal:0,i=m.trips.map(t=>{let n=P(t.id).eurTotal,i=n>0?` — ${r(n,`EUR`)} ${d(`settlement.settledSuffix`)}`:``;return`<option value="${f(t.id)}"${t.id===e?` selected`:``}>${f(t.name)}${i}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color: var(--accent-blue-deep); font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${r(n,`EUR`)} ${d(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    ...
    `}function R(e){let t={};for(let n of m.expenses||[]){if(n.tripId!==e||n.isSettlement)continue;let r=(n.currency||`EUR`).toUpperCase();t[r]=(t[r]||0)+(n.euroValue||n.value||0)}let n=null,r=-1;for(let[e,i]of Object.entries(t))i>r&&(r=i,n=e);return n}function z(e,t){if(!t||t===g())return``;let n=p(Math.abs(e),`EUR`,t);return`<span style="display:block; font-size:0.72rem; font-weight:600; color:var(--text-secondary); margin-top:1px;">≈ ${f(l(t))}${n.toFixed(2)}</span>`}function B(e,t){let{balances:n,removedFromRoster:a}=k(e),o=new Set(a||[]),s=j(n),c=R(e.id),l=N(e),u=l.reduce((e,t)=>e+t.paid,0),p=[...l].sort((e,t)=>t.paid-e.paid)[0],m=[...l].sort((e,t)=>e.net-t.net)[0],h=[...l].sort((e,t)=>t.net-e.net)[0],g=f(e?.name||`Trip`),_=u>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    <div style="font-size:0.66rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary); margin-bottom:6px;">${d(`settlement.tripTotal`)} · ${g}</div>
                    <div style="font-size:2rem; font-weight:800; color: var(--text-brand-navy); letter-spacing:-0.02em;">${r(u,`EUR`)}</div>
                </div>
                ${p?`
                    <div class="stl-center-min-120">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${r(p.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${h&&h.net>.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${f(h.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:#1a6b3c;">+${r(h.net,`EUR`)}</div>
                    </div>
                `:``}
                ${m&&m.net<-.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#a30000;">${r(m.net,`EUR`)}</div>
                    </div>
                `:``}
            </div>
        </div>
    `:``,v=Object.entries(n).map(([e,t])=>{let n=t>.01,i=t<-.01,a=o.has(e)?`<span style="margin-left:6px; padding:1px 6px; border-radius:6px; background:rgba(0,0,0,0.06); color:var(--text-secondary); font-size:0.7rem; font-weight:700; text-transform:uppercase;">removed</span>`:``;return`
            <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                ...
                <div style="flex:1; min-width:0; font-weight:800; color: var(--text-brand-navy); font-size:0.95rem; overflow:hidden; text-overflow:ellipsis;">${f(e)}${a}</div>
                <div style="font-weight:800; color: ${n?`#1a6b3c`:i?`#a30000`:`var(--text-secondary)`}; font-size:1rem; text-align:right;">
                    ${n?`+`:``}${r(t,`EUR`)}${z(t,c)}
                </div>
            </div>
        `}).join(``)||`<p class="text-muted" style="padding: 20px; text-align:center;">${d(`settlement.emptyNoCompanions`)}</p>`,y=s.length===0?`<div style="text-align:center; padding: 40px 20px;"><div style="font-size:2.2rem; margin-bottom:8px;">🥂</div><p style="margin:0; font-weight:800; color:#1a6b3c;">${d(`settlement.allSettledTitle`)}</p><p style="margin:6px 0 0; color:var(--text-secondary); font-size:0.85rem;">${d(`settlement.allSettledBody`)}</p></div>`:s.map(n=>`
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:16px;">
                <div class="stl-flex-grow-truncate">
                    ...
                    <div style="font-size:1.3rem; font-weight:800; color: var(--text-brand-navy); letter-spacing:-0.01em; margin-top:2px;">${r(n.amount,`EUR`)}${z(n.amount,c)}</div>
                </div>
                ${t?`
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:18px; margin-bottom:24px;">
            <div class="card glass stl-card-major">
                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px;">
                    <h3 class="stl-heading-1">${d(`settlement.tripBalancesTitle`)} · ${g}</h3>
            ...
            <div class="card glass stl-card-major">
                <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:12px; margin-bottom:14px;">
                    <div style="min-width:0;">
                        <h3 class="stl-heading-1">${d(`settlement.suggestedPaymentsTitle`)} · ${g}</h3>
        ...
        `:``}
    `}function V(e){let t=[];for(let n of m.expenses||[]){if(!(n.tripId===e.id&&n.isSettlement))continue;let r=Object.keys(n.splits||{})[0]||`?`;t.push({id:n.id,source:`expense`,who:n.who||`?`,to:r,euroValue:n.euroValue||0,date:n.date||``})}for(let n of m.settlements||[]){if(n.tripId!==e.id)continue;let r=n.fromName||w(e,n.fromUserId)?.name,i=n.toName||w(e,n.toUserId)?.name;!r||!i||t.push({id:n.id,source:`settlement`,who:r,to:i,euroValue:n.euroValue||n.amount||0,date:(n.createdAt||``).slice(0,10),method:n.method??null,note:n.note??null})}return t.sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),t}function H(e,t){let n=V(e);if(n.length===0)return`
        ...
        `;let a={};for(let e of n){let t=e.date||`undated`;a[t]||(a[t]=[]),a[t].push(e)}let o=new Date().toISOString().slice(0,10),s=new Date;s.setDate(s.getDate()-1);let c=s.toISOString().slice(0,10),l=e=>{if(e===`undated`)return d(`settlement.historyDateNoDate`);if(e===o)return d(`settlement.historyDateToday`);if(e===c)return d(`settlement.historyDateYesterday`);let t=new Date(e);return isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{weekday:`short`,month:`short`,day:`numeric`,year:`numeric`})},u=Object.keys(a).sort((e,t)=>e===`undated`?1:t===`undated`?-1:t.localeCompare(e));return`
        <div class="card glass stl-card-major">
            ...
            <div style="display:flex; flex-direction:column; gap:18px;">
                ${u.map(n=>{let o=a[n],s=o.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                <h4 style="margin:0; font-size:0.7rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary);">${f(l(n))}</h4>
                            ...
                            <div class="stl-flex-col-8">
                                ${o.map(n=>{let i=(n.who||`?`).charAt(0).toUpperCase(),a=n.method&&n.source===`settlement`?`<span style="display:inline-flex; align-items:center; gap:3px; background:rgba(0,113,227,0.08); color:var(--accent-blue-deep); padding:1px 8px; border-radius:999px; font-size:0.62rem; font-weight:700; text-transform:uppercase; letter-spacing:0.05em;">${f(n.method.replace(/_/g,` `))}</span>`:``,o=n.note&&n.source===`settlement`?`<div style="font-size:0.78rem; color:var(--text-secondary); margin-top:4px; font-style:italic;">"${f(n.note)}"</div>`:``,s=t&&n.source===`expense`?`<button class="edit-settlement-btn" data-settlement-id="${f(n.id)}" type="button"
                                                style="background:rgba(0,113,227,0.08); border:1px solid rgba(0,113,227,0.22); color: var(--accent-blue-deep); padding:5px 12px; border-radius:999px; font-size:0.72rem; font-weight:800; cursor:pointer;">${d(`settlement.historyEditBtn`)}</button>`:``,c=t?`<button class="unsettle-settlement-btn" data-settlement-id="${f(n.id)}" data-source="${f(n.source)}" data-trip-id="${f(e.id)}" type="button"
                                        ...
                                        <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                                            <div style="width:34px; height:34px; border-radius:50%; background:rgba(52,199,89,0.12); color:#1a6b3c; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:0.95rem; flex-shrink:0;">${f(i)}</div>
                                            <div class="stl-flex-grow-truncate">
                                                <div class="stl-flex-row-wrap-6">
    ...
    `}function U(){let e=M(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),i=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        `:``}
    `}async function W(e,t,n,i,c,l){if(t===n){s(d(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(i)||i<=0){s(d(`settlement.toastAmountInvalid`));return}if(typeof navigator<`u`&&navigator.onLine===!1){s(d(`errors.offline`));return}let u=p(i,c,`EUR`),f=m.trips.find(t=>t.id===e),h=y(f,t)?.linkedUserId,g=y(f,n)?.linkedUserId;if(h&&g){let o=await a({tripId:e,fromUserId:h,toUserId:g,amount:i,currency:c,euroValue:u,...l?.method?{method:l.method}:{},...l?.note?{note:l.note}:{}});o.settlement?(m.settlements.push(o.settlement),b(_.STATE_CHANGED),s(d(`settlement.toastRecordedNotified`,{amount:r(u,`EUR`),from:t,to:n}))):(console.warn(`[settlement] /api/settlements failed:`,o.error),s(d(`settlement.toastSettlementFailed`,{error:o.error||d(`settlement.toastSettlementFailedNetwork`)})),b(_.STATE_CHANGED));return}let v={id:o(),tripId:e,label:d(`settlement.settlementLabel`,{from:t,to:n}),value:i,euroValue:u,currency:c,who:t,categoryId:m.categories[0]?.id??``,country:d(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};m.expenses.push(v),b(_.STATE_CHANGED),x(v),s(d(`settlement.toastRecorded`,{amount:r(u,`EUR`),from:t,to:n}))}async function G(e,t=`expense`){c({title:d(`settlement.toastUnsettleConfirmTitle`),message:d(`settlement.toastUnsettleConfirmMessage`),confirmText:d(`settlement.toastUnsettleConfirmBtn`),onConfirm:async()=>{if(t===`settlement`){let t=await v(e);if(t.error){console.warn(`[settlement] delete failed:`,t.error),s(`Couldn't undo: ${t.error||`Network error`}`);return}m.settlements=m.settlements.filter(t=>t.id!==e),b(_.STATE_CHANGED);return}m.expenses=m.expenses.filter(t=>t.id!==e),b(_.STATE_CHANGED)}})}var K=[{value:`cash`,labelKey:`settlement.methodCash`},{value:`revolut`,labelKey:`settlement.methodRevolut`},{value:`bank_transfer`,labelKey:`settlement.methodBankTransfer`},{value:`wise`,labelKey:`settlement.methodWise`},{value:`paypal`,labelKey:`settlement.methodPayPal`},{value:`custom`,labelKey:`settlement.methodCustom`}];function q(e){let t=m.trips.find(t=>t.id===e),n=h(t).map(e=>`<option value="${f(e)}">${f(e)}</option>`).join(``),i=K.map(e=>`<option value="${f(e.value)}">${f(d(e.labelKey))}</option>`).join(``),a=g(),{root:o,close:l}=u({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
        ...
        `});C(o,`#cancelManualSettleBtn`).onclick=()=>l(),C(o,`#manualSettleForm`).onsubmit=n=>{n.preventDefault();let i=C(o,`#manualSettleFrom`).value,u=C(o,`#manualSettleTo`).value,f=parseFloat(C(o,`#manualSettleAmount`).value),p=C(o,`#manualSettleMethod`).value,m=C(o,`#manualSettleNote`).value.trim();if(i===u){s(d(`settlement.toastSenderEqualsReceiver`));return}let h=J(t,i,u,a),g=()=>{W(e,i,u,f,a,{method:p,note:m}),l()};if(f>h+.005){c({title:d(`settlement.overpayConfirmTitle`),message:h>.005?d(`settlement.overpayConfirmBody`,{amount:r(f,a),owed:r(h,a),from:i,to:u}):d(`settlement.overpayConfirmBodyNone`,{amount:r(f,a),from:i,to:u}),confirmText:d(`settlement.overpayConfirmBtn`),onConfirm:g});return}g()}}function J(e,t,n,r){if(!e)return 0;let{balances:i}=k(e),a=j(i).find(e=>e.from===t&&e.to===n);return a?p(a.amount,`EUR`,r):0}function Y(e){let t=m.expenses.find(t=>t.id===e);if(!t)return;let n=h(m.trips.find(e=>e.id===t.tripId)),r=n.map(e=>`<option value="${f(e)}" ${t.who===e?`selected`:``}>${f(e)}</option>`).join(``),i=Object.keys(t.splits||{})[0],a=n.map(e=>`<option value="${f(e)}" ${i===e?`selected`:``}>${f(e)}</option>`).join(``),o=g(),{root:c,close:l}=u({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label stl-mt-6">${f(d(`settlement.labelAmount`,{currency:o}))}</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${p(t.euroValue||0,`EUR`,o).toFixed(2)}" class="glass-input" required class="stl-card-minor">
        ...
        `});C(c,`#cancelEditSettleBtn`).onclick=()=>l(),C(c,`#editSettlementForm`).onsubmit=e=>{e.preventDefault();let n=C(c,`#editSettleFrom`).value,r=C(c,`#editSettleTo`).value,i=parseFloat(C(c,`#editSettleAmount`).value),a=C(c,`#editSettleDate`).value;if(n===r){s(d(`settlement.toastSenderEqualsReceiver`));return}t.who=n,t.splits={[r]:100},t.value=i,t.currency=o,t.euroValue=p(i,o,`EUR`),t.date=a,t.label=d(`settlement.settlementLabel`,{from:n,to:r}),b(_.STATE_CHANGED),x(t),l()}}var X=n();function Z(){let e=T(e=>e.trips),t=T(e=>e.activeTripId),n=T(e=>e.expenses),[r,i]=(0,D.useState)(`trip`),[a,o]=(0,D.useState)(()=>t||(e.length>0?e[0].id:null));(0,D.useEffect)(()=>{t&&t!==a&&o(t)},[t,a]),(0,D.useEffect)(()=>{if(a&&!e.find(e=>e.id===a)){let t=e.length>0?e[0].id:null;o(t),t&&(m.activeTripId=t,b(_.STATE_CHANGED))}},[e,a]);let s=e=>{o(e),m.activeTripId=e,b(_.STATE_CHANGED),r===`global`&&i(`trip`)},{trip:c,canEditExpenses:l}=E(a),u=(0,D.useMemo)(()=>F(c,l,r,a),[c,l,r,a,n]),f=(0,D.useRef)(null),p=e=>{let t=e.target;if(!t)return;let n=t.closest(`.settlement-trip-pill`);if(n?.dataset.tripId){s(n.dataset.tripId);return}let r=t.closest(`.settle-tab`);if(r?.dataset.tab){i(r.dataset.tab);return}let a=t.closest(`.settle-debt-btn`);if(a?.dataset.tripId&&a.dataset.from&&a.dataset.to&&a.dataset.amount&&!a.disabled){a.disabled=!0,a.textContent=d(`settlement.recordingBtn`),W(a.dataset.tripId,a.dataset.from,a.dataset.to,parseFloat(a.dataset.amount),`EUR`);return}let o=t.closest(`.open-manual-settle-btn`);if(o?.dataset.tripId){q(o.dataset.tripId);return}let c=t.closest(`.edit-settlement-btn`);if(c?.dataset.settlementId){Y(c.dataset.settlementId);return}let l=t.closest(`.unsettle-settlement-btn`);if(l?.dataset.settlementId){let e=l.dataset.source===`settlement`?`settlement`:`expense`;G(l.dataset.settlementId,e);return}},h=(0,D.useRef)(s);return h.current=s,(0,D.useEffect)(()=>{let e=f.current;if(!e)return;let t=e=>{let t=e.target;if(t?.id===`settlementTripSelect`){let e=t;e.value&&h.current(e.value)}};return e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,X.jsx)(`div`,{ref:f,onClick:p,dangerouslySetInnerHTML:{__html:u}})}function Q(e){S(e,(0,D.createElement)(Z))}export{Q as mountSettlement};
//# sourceMappingURL=mount-CW27Vzws.js.map