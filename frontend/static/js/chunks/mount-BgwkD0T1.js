import{r as e,t}from"./vendor-react-CAxw18f3.js";import{At as n,Dt as r,Et as i,Pt as a,Rt as o,St as s,bt as c,gt as l,ht as u,i as d,j as f,jt as p,r as m,ut as h,vt as g,wt as _,xt as v}from"../app.bundle.js";import{t as y}from"./store-DdeMPdKF.js";var b=e();function x(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(n.expenses||[]).filter(t=>t.tripId===e.id),r=a(e),i=r.length>0?r:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),o={};i.forEach(e=>o[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(o[e.who]!==void 0&&(o[e.who]+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))o[n]!==void 0&&(o[n]-=t*(Number(r)/100));else{let e=t/Math.max(i.length,1);i.forEach(t=>{o[t]!==void 0&&(o[t]-=e)})}}return{balances:o,roster:i,expenses:t}}function S(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function C(){let e={};for(let t of[...n.trips,...n.archivedTrips||[]])for(let n of a(t))n in e||(e[n]=0);let t=(n.archivedTrips||[]).flatMap(e=>e.expenses||[]),r=[...n.expenses,...t],i={};for(let e of[...n.trips,...n.archivedTrips||[]])i[e.id]=a(e);for(let t of r){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let r=i[t.tripId]||[],a=r.length>0?r:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}return e}function w(e){if(!e)return[];let t=(n.expenses||[]).filter(t=>t.tripId===e.id),r=a(e),i={};r.forEach(e=>i[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(i[e.who]&&(i[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))i[n]&&(i[n].share+=t*(Number(r)/100));else{let e=t/Math.max(r.length,1);r.forEach(t=>{i[t]&&(i[t].share+=e)})}}return Object.entries(i).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function T(e,t,n,r){let i=E(r),a=`
    ...
    `:`
        ...
        `}function E(e){if(n.trips.length===0)return``;let t=n.trips.find(t=>t.id===e),r=t?(n.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0):0,a=n.trips.map(t=>{let r=(n.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0),a=r>0?` — ${i(r,`EUR`)} ${m(`settlement.settledSuffix`)}`:``;return`<option value="${g(t.id)}"${t.id===e?` selected`:``}>${g(t.name)}${a}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&r>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color:#005bb8; font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${i(r,`EUR`)} ${m(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    `}function D(e,t){let r=(n.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).length,i=(e,n,r)=>`
    ...
    `;return`
        <nav style="display:flex; gap:36px; border-bottom: 1px solid rgba(0,113,227,0.25); margin: 22px 0 22px; padding: 0 4px;">
            ${i(`trip`,m(`settlement.tabThisTrip`))}
            ${i(`history`,m(`settlement.tabHistory`),r)}
            ${i(`global`,m(`settlement.tabCrossTrip`))}
        </nav>
        ...
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color:#002d5b; letter-spacing:-0.02em;">${i(o,`EUR`)}</div>
                </div>
                ${s?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${i(s.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${l&&l.net>.01?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:1.1rem; font-weight:800; color:#002d5b; margin-top:4px;">${g(l.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:#1a6b3c;">+${i(l.net,`EUR`)}</div>
                    </div>
                `:``}
                ${c&&c.net<-.01?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:#a30000;">${i(c.net,`EUR`)}</div>
                    </div>
                `:``}
            </div>
        </div>
    `:``,f=Object.entries(n).map(([e,t])=>{let n=t>.01,r=t<-.01;return`
        ...
        `}).join(``)||`<p class="text-muted" style="padding: 20px; text-align:center;">${m(`settlement.emptyNoCompanions`)}</p>`,p=r.length===0?`<div style="text-align:center; padding: 40px 20px;"><div style="font-size:2.2rem; margin-bottom:8px;">🥂</div><p style="margin:0; font-weight:800; color:#1a6b3c;">${m(`settlement.allSettledTitle`)}</p><p style="margin:6px 0 0; color:var(--text-secondary); font-size:0.85rem;">${m(`settlement.allSettledBody`)}</p></div>`:r.map(n=>`
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:16px;">
                <div style="flex:1; min-width:0;">
                    ...
                    <div style="font-size:1.3rem; font-weight:800; color:#002d5b; letter-spacing:-0.01em; margin-top:2px;">${i(n.amount,`EUR`)}</div>
                </div>
                ${t?`
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:18px; margin-bottom:24px;">
            <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px;">
                    ...
                    <span style="font-size:0.7rem; font-weight:800; color:var(--text-secondary); text-transform:uppercase; letter-spacing:0.1em;">${d(`settlement.peopleCount`,Object.keys(n).length)}</span>
                </div>
            ...
            <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
                <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:12px; margin-bottom:14px;">
                    ...
                    <span style="font-size:0.7rem; font-weight:800; color:var(--text-secondary); text-transform:uppercase; letter-spacing:0.1em; flex-shrink:0;">${d(`settlement.paymentsCount`,r.length)}</span>
                </div>
        ...
        `:``}
    `}function k(e,t){let r=(n.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime());if(r.length===0)return`
        ...
        `;let a={};for(let e of r){let t=e.date||`undated`;a[t]||(a[t]=[]),a[t].push(e)}let o=new Date().toISOString().slice(0,10),s=new Date;s.setDate(s.getDate()-1);let c=s.toISOString().slice(0,10),l=e=>{if(e===`undated`)return m(`settlement.historyDateNoDate`);if(e===o)return m(`settlement.historyDateToday`);if(e===c)return m(`settlement.historyDateYesterday`);let t=new Date(e);return isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{weekday:`short`,month:`short`,day:`numeric`,year:`numeric`})},u=Object.keys(a).sort((e,t)=>e===`undated`?1:t===`undated`?-1:t.localeCompare(e));return`
        <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:16px;">
                ...
                <span style="font-size:0.7rem; font-weight:800; color:var(--text-secondary); text-transform:uppercase; letter-spacing:0.1em;">${m(`settlement.historyRecorded`,{count:r.length})}</span>
            </div>
            <div style="display:flex; flex-direction:column; gap:18px;">
                ${u.map(n=>{let r=a[n],o=r.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                <h4 style="margin:0; font-size:0.7rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary);">${g(l(n))}</h4>
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${d(`settlement.historyDayTotalPlural`,r.length,{amount:i(o,`EUR`)})}</span>
                            </div>
                            <div style="display:flex; flex-direction:column; gap:8px;">
                                ${r.map(n=>{let r=Object.keys(n.splits||{})[0]||`?`;return`
                                        <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:14px;">
                                            ...
                                            <div style="font-size:1rem; font-weight:800; color:#1a6b3c; flex-shrink:0;">${i(n.euroValue||0,`EUR`)}</div>
                                            ${t?`
    ...
    `}function A(){let e=C(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),r=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
                    ...
                    ${a.map(e=>`
                        <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:16px;">
                            <div style="flex:1; min-width:0;">
                                ...
                                <div style="font-size:1.3rem; font-weight:800; color:#002d5b; letter-spacing:-0.01em; margin-top:2px;">${i(e.amount,`EUR`)}</div>
                            </div>
                        </div>
                    `).join(``)}
                </div>
        ...
        `:``}
    `}function j(e,t,r,a,l){if(t===r){s(m(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(a)||a<=0){s(m(`settlement.toastAmountInvalid`));return}let u=_(a,l,`EUR`),d={id:c(),tripId:e,label:`Settlement: ${t} → ${r}`,value:a,euroValue:u,currency:l,who:t,categoryId:n.categories[0]?.id??``,country:m(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[r]:100},isSettlement:!0};n.expenses.push(d),p(o.STATE_CHANGED),s(`Recorded ${i(u,`EUR`)} ${t} → ${r}`)}function M(e){u({title:m(`settlement.toastUnsettleConfirmTitle`),message:m(`settlement.toastUnsettleConfirmMessage`),confirmText:m(`settlement.toastUnsettleConfirmBtn`),onConfirm:()=>{n.expenses=n.expenses.filter(t=>t.id!==e),p(o.STATE_CHANGED)}})}function N(e){let t=a(n.trips.find(t=>t.id===e)).map(e=>`<option value="${g(e)}">${g(e)}</option>`).join(``),i=r(),{root:o,close:c}=l({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">Amount (${g(i)})</label>
        ...
        `});v(o,`#cancelManualSettleBtn`).onclick=()=>c(),v(o,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let n=v(o,`#manualSettleFrom`).value,r=v(o,`#manualSettleTo`).value,a=parseFloat(v(o,`#manualSettleAmount`).value);if(n===r){s(m(`settlement.toastSenderEqualsReceiver`));return}j(e,n,r,a,i),c()}}function P(e){let t=n.expenses.find(t=>t.id===e);if(!t)return;let i=a(n.trips.find(e=>e.id===t.tripId)),c=i.map(e=>`<option value="${g(e)}" ${t.who===e?`selected`:``}>${g(e)}</option>`).join(``),u=Object.keys(t.splits||{})[0],d=i.map(e=>`<option value="${g(e)}" ${u===e?`selected`:``}>${g(e)}</option>`).join(``),f=r(),{root:h,close:y}=l({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">To</label>
                <select id="editSettleTo" class="glass-input" style="padding: var(--space-3); border-radius: 12px; background:white;">${d}</select>
                <label class="form-label" style="margin-top:6px;">Amount (${g(f)})</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${_(t.euroValue||0,`EUR`,f).toFixed(2)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
                <label class="form-label" style="margin-top:6px;">Date</label>
                <input type="date" id="editSettleDate" value="${g(t.date||``)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
