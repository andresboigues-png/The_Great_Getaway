import{r as e,t}from"./vendor-react-CAxw18f3.js";import{At as n,D as r,St as i,T as a,_ as o,_t as s,a as c,d as l,ht as u,j as d,l as f,m as p,p as m,r as h,u as g,v as _,vt as v,xt as y,y as b}from"../app.bundle.js";var x=e(),S=new Set([`friend_shared_trip`,`friend_reposted_trip`]),C=new Set([`friend_created_trip`,`friend_archived_trip`,`friend_joined_trip`,`new_friendship`]),w={muted:`142,142,147`,like:`255,59,48`,comment:`0,113,227`,repost:`52,199,89`,bookmark:`255,149,0`};function T(e){if(!e)return``;let t=typeof e==`string`&&e.includes(` `)&&!e.includes(`T`)?e.replace(` `,`T`)+`Z`:e,n=new Date(t);return Number.isNaN(n.getTime())?``:n.toISOString().slice(0,10)}function E(e){let t=new Map,n=[];for(let r of e){if(S.has(r.type)){n.push(r);continue}let e=`${r.actor?.id||`anon`}|${r.type}|${T(r.when)}`,i=t.get(e);i||(i=[],t.set(e,i),n.push({__slot:e})),i.push(r)}return n.map(e=>{let n=e.__slot;if(!n)return e;let r=t.get(n)||[];if(r.length===1)return r[0];let i=r[0];return{bundled:!0,id:`bundle_${n}`,type:i.type,actor:i.actor,when:i.when,members:r}})}function D(e){let t=`<strong style="color:#002d5b;">${v(e.actor.name)}</strong>`,n=e.members.length,r=n===1?`trip`:`trips`;switch(e.type){case`friend_created_trip`:return`${t} started planning <strong style="color:#002d5b;">${n} new ${r}</strong>`;case`friend_archived_trip`:return`${t} just completed <strong style="color:#002d5b;">${n} ${r}</strong> 🎉`;case`friend_joined_trip`:return`${t} joined <strong style="color:#002d5b;">${n} ${r}</strong>`;case`new_friendship`:return`You and <strong style="color:#002d5b;">${n} new people</strong> are now friends 🤝`;default:return`${t} did ${n} new things`}}function O(e,t=44){let n=(e?.name||`?`).charAt(0).toUpperCase(),r=`<div style="width:${t}px; height:${t}px; border-radius:50%; background: var(--gradient-day); color:white; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:${Math.round(t*.4)}px; flex-shrink:0; box-shadow: 0 2px 8px rgba(0,113,227,0.18);">${v(n)}</div>`,i=e?.picture?`<img src="${v(e.picture)}" alt="" referrerpolicy="no-referrer"
        ...
        style="background:transparent; border:0; padding:0; margin:0; cursor:pointer; line-height:0; flex-shrink:0; border-radius:50%;">${i}</button>`:i}function k(e){if(!e)return``;let t=typeof e==`string`&&e.includes(` `)&&!e.includes(`T`)?e.replace(` `,`T`)+`Z`:e,n=new Date(t).getTime();if(Number.isNaN(n))return``;let r=Date.now()-n,i=Math.floor(r/1e3);if(i<60)return`just now`;let a=Math.floor(i/60);if(a<60)return`${a}m ago`;let o=Math.floor(a/60);if(o<24)return`${o}h ago`;let s=Math.floor(o/24);return s<7?`${s}d ago`:new Date(n).toLocaleDateString(`en-US`,{month:`short`,day:`numeric`})}function A(e){let t=n.user?.id,r=t&&e.actor?.id===t?`<strong style="color:#002d5b;">You</strong>`:`<strong style="color:#002d5b;">${v(e.actor.name)}</strong>`,i=e.trip?`<strong style="color:#002d5b;">${v(e.trip.name||e.trip.country||`a trip`)}</strong>`:``;switch(e.type){case`friend_created_trip`:return`${r} started planning a new trip — ${i}${e.trip?.country?` (${v(e.trip.country)})`:``}`;case`friend_archived_trip`:return`${r} just completed their trip to <strong style="color:#002d5b;">${v(e.trip?.country||e.trip?.name||`somewhere`)}</strong> 🎉`;case`friend_joined_trip`:return`${r} joined the trip ${i}`;case`new_friendship`:return`You and ${r} are now friends 🤝`;case`friend_shared_trip`:return`${r} shared a trip — ${i}${e.trip?.country?` (${v(e.trip.country)})`:``}`;case`friend_reposted_trip`:{let n=!!t&&e.original_sharer?.id===t;return`${r} reposted ${e.original_sharer?n?`<strong style="color:#002d5b;">your</strong> share`:`<strong style="color:#002d5b;">${v(e.original_sharer.name)}</strong>'s trip`:`someone`} — ${i}${e.trip?.country?` (${v(e.trip.country)})`:``}`}default:return`${r} did something new`}}function j(e){switch(e){case`friend_created_trip`:return{color:`#0071e3`,icon:`🗺️`};case`friend_archived_trip`:return{color:`#34c759`,icon:`🏁`};case`friend_joined_trip`:return{color:`#ff9500`,icon:`👥`};case`new_friendship`:return{color:`#9b59b6`,icon:`🤝`};case`friend_shared_trip`:return{color:`#5856d6`,icon:`📣`};case`friend_reposted_trip`:return{color:`#5856d6`,icon:`🔁`};default:return{color:`#8e8e93`,icon:`✨`}}}function M(e,t=!1){let n=t?` fill="currentColor"`:``,r=``;switch(e){case`heart`:r=`<path${n} d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>`;break;case`comment`:r=`<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>`;break;case`repost`:r=`<polyline points="17 1 21 5 17 9"></polyline><path d="M3 11V9a4 4 0 0 1 4-4h14"></path><polyline points="7 23 3 19 7 15"></polyline><path d="M21 13v2a4 4 0 0 1-4 4H3"></path>`;break;case`bookmark`:r=`<path${n} d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>`;break}return`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">`+r+`</svg>`}function N(e){let t=`display:inline-flex; align-items:center; gap:6px;${e.marginLeftAuto?` margin-left:auto;`:``}`,n=e.countThreshold??1,r=typeof e.count==`number`,i=r&&e.count>=n?String(e.count):``;return`
        <span style="${t}">
    ...
    `}var I=new Set;function L(e){e.classList.remove(`tap-pop`),e.offsetWidth,e.classList.add(`tap-pop`),e.addEventListener(`animationend`,()=>{e.classList.remove(`tap-pop`)},{once:!0})}var R=[],z={},B=`posts`,V=!1,H=null,U=null;function W(e){return H!==null&&U===null?(e(),Promise.resolve()):U?U.then(e):(U=(async()=>{try{let e=await g();e.error?(console.warn(`explore fetch failed:`,e.error),H=[]):H=e.items||[]}finally{U=null,e()}})(),U)}function G(e,t,r){let i=n.user?.id;e.innerHTML=`
        <div class="feed-comment-list">${r.length>0?r.map(e=>F(e,e.author?.id===i)).join(``):`<div style="font-size:0.82rem; color:var(--text-secondary); padding:6px 0;">${h(`feed.commentsEmpty`)}</div>`}</div>
        <form class="feed-comment-form" data-event-id="${v(t)}" style="display:flex; gap:8px; margin-top:10px;">
            ...
            <button type="submit" class="feed-comment-submit" title="Post comment" aria-label="Post comment"
                style="background:var(--accent-blue); color:white; border:0; padding:8px 16px; border-radius:999px; font-size:0.82rem; font-weight:800; cursor:pointer;">${h(`feed.commentSubmit`)}</button>
        </form>
    `}function K(){let e=document.createElement(`div`);e.style.cssText=`font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text',sans-serif;`,e.innerHTML=`
        <div style="max-width: 760px; margin: 0 auto;">
            <div style="padding:32px 0 24px; text-align:center;">
                <h1 style="margin:0 0 6px;font-size:2.8rem;font-weight:800;letter-spacing:-0.04em;background:var(--gradient-title);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">${h(`feed.title`)}</h1>
                <p style="margin:0;color:var(--text-secondary);font-size:1rem;">${h(`feed.subtitle`)}</p>
            </div>
            ...
            <div id="feedTabsRow" class="feed-tabs-row">
                ...
                <nav class="home-tabnav home-tabnav--centered" role="tablist" aria-label="Feed sections">
                    <button class="home-tabnav__tab${B===`posts`?` is-active`:``}" data-feed-tab="posts" role="tab" type="button" style="--accent: 88, 86, 214;">${h(`feed.tabPosts`)}</button>
                    <button class="home-tabnav__tab${B===`actions`?` is-active`:``}" data-feed-tab="actions" role="tab" type="button" style="--accent: 255, 149, 0;">${h(`feed.tabActions`)}</button>
    ...
    `;let t=!1,d=e=>{let t=e.coverUrl?`background-image: url('${v(e.coverUrl)}'); background-size: cover; background-position: center;`:`background: linear-gradient(135deg, #00c7be 0%, #007aff 100%);`,n=e.owner.picture?`<img src="${v(e.owner.picture)}" alt="" referrerpolicy="no-referrer" style="width:24px; height:24px; border-radius:50%; object-fit:cover;">`:`<div style="width:24px; height:24px; border-radius:50%; background:rgba(0,113,227,0.18); display:flex; align-items:center; justify-content:center; color:#005bb8; font-size:0.7rem; font-weight:800;">${v((e.owner.firstName||`?`).slice(0,1).toUpperCase())}</div>`;return`
        ...
        `},g=()=>{let r=y(e,`#feedList`);if(!r)return;if(B===`explore`){if(H===null){r.innerHTML=`
                ...
                `;return}if(H.length===0){r.innerHTML=s({accent:`blue`,emoji:`🌍`,title:`No public trips yet`,body:`Be the first — share one of your own to seed the Explore feed for everyone.`});return}r.innerHTML=`
            ...
            `;return}if(!t&&R.length===0){r.innerHTML=`
                <div class="card glass" style="padding: 32px; border-radius: 24px; text-align:center;">
                    ...
                    <div style="color: var(--text-secondary); font-size: 0.88rem; font-weight: 600;">${h(`feed.loading`)}</div>
                </div>
            `;return}let i=e=>B===`posts`?S.has(e.type):C.has(e.type),o=R.filter(e=>!(!i(e)||V&&!e.is_bookmarked));if(o.length===0){let t,n,i,o;V?(t=h(B===`posts`?`feed.emptyBookmarkedPostsTitle`:`feed.emptyBookmarkedActionsTitle`),n=h(`feed.emptyBookmarkedBody`),i=h(`feed.emptyBookmarkedCta`),o=()=>{V=!1;let t=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);t&&(t.checked=!1),g()}):B===`posts`?(t=h(`feed.emptyPostsTitle`),n=h(`feed.emptyPostsBody`),i=h(`feed.emptyPostsCta`),o=()=>{B=`actions`,g(),e.querySelectorAll(`.home-tabnav__tab`).forEach(e=>e.classList.toggle(`is-active`,e.dataset.feedTab===`actions`))}):(t=h(`feed.emptyActionsTitle`),n=h(`feed.emptyActionsBody`),i=h(`feed.emptyActionsCta`),o=()=>a(`friends`)),r.innerHTML=s({accent:`purple`,emoji:V?`🔖`:`🌱`,title:t,body:n,ctaLabel:i,ctaId:`feedEmptyCtaBtn`});let c=r.querySelector(`#feedEmptyCtaBtn`);c&&(c.onclick=o);return}let c=n.user?.id;r.innerHTML=E(o).map(e=>{if(e.bundled){let t=e,n=j(t.type),r=k(t.when),i=I.has(t.id),a=t.members.map(e=>{let t=A(e),n=!!e.is_bookmarked;return`
                    ...
                    <div class="card glass feed-event feed-bundle" data-bundle-id="${v(t.id)}"
                        ...
                        <div style="display:flex; align-items:flex-start; gap:14px;">
                            ...
                            <button type="button" class="feed-bundle-toggle" data-bundle-id="${v(t.id)}"
                                style="background:transparent; border:0; color:#005bb8; cursor:pointer; padding:4px 10px; font-size:0.78rem; font-weight:800; flex-shrink:0;">${h(i?`feed.bundleCollapse`:`feed.bundleViewAll`)}</button>
                        </div>
            ...
            `:``,a=(t.type===`friend_shared_trip`||t.type===`friend_reposted_trip`)&&t.trip?.id?(()=>{let e=t.trip.country?v(t.trip.country):``;return`
                    <button type="button" class="feed-trip-card" data-trip-id="${v(t.trip.id)}"
                        ...
                        <div style="flex:1; min-width:0;">
                            <div style="font-weight:800; color:#002d5b; font-size:0.98rem; line-height:1.25; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">${v(t.trip.name||h(`feed.tripFallback`))}</div>
                ...
                `})():``,o=t.type===`friend_shared_trip`&&t.actor?.id===c&&t.post_id?`
            ...
            `}).join(``)},x=async()=>{if(!n.user){t=!0,g();return}try{let e=await c(`/api/feed`);if(!e.ok)return;let t=await e.json();Array.isArray(t)&&(R=t)}catch(e){console.error(`Feed refresh failed:`,e)}finally{t=!0,g()}};e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(t=>{t.onclick=()=>{let n=t.dataset.feedTab;!n||B===n||(B=n,e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(e=>{e.classList.toggle(`is-active`,e.dataset.feedTab===n)}),n===`explore`&&W(g),g())}});let T=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);return T&&T.addEventListener(`change`,()=>{V=!!T.checked,g()}),e.addEventListener(`click`,async e=>{let t=e.target;if(!t)return;let n=t.closest(`.feed-avatar-btn`);if(n?.dataset.feedAvatarUserId){a(`profile`,{userId:n.dataset.feedAvatarUserId});return}let s=t.closest(`.feed-trip-card`);if(s?.dataset.tripId){r(s.dataset.tripId);return}let c=t.closest(`.feed-like-btn`);if(c?.dataset.eventId){let e=c.dataset.eventId,t=c.dataset.liked===`1`,n=!t,r=R.find(t=>t.id===e);r&&(r.is_liked=n,r.like_count=Math.max(0,(r.like_count||0)+(t?-1:1))),c.dataset.liked=n?`1`:`0`,c.style.setProperty(`--accent`,n?w.like:w.muted),c.innerHTML=M(`heart`,n),L(c);let i=c.parentElement?.querySelector(`.feed-action-count`),a=e=>e>=3?String(e):``;i&&r&&(i.textContent=a(r.like_count??0));let o=await _(e);o.ok&&o.body&&r&&(r.is_liked=!!o.body.liked,r.like_count=Number(o.body.count)||0,i&&(i.textContent=a(r.like_count)));return}let d=t.closest(`.feed-bookmark-btn`);if(d?.dataset.eventId){let e=d.dataset.eventId,t=d.dataset.bookmarked!==`1`,n=R.find(t=>t.id===e);n&&(n.is_bookmarked=t),d.dataset.bookmarked=t?`1`:`0`,d.style.setProperty(`--accent`,t?w.bookmark:w.muted),d.innerHTML=M(`bookmark`,t),L(d),V&&!t&&g(),await o(e);return}let m=t.closest(`.feed-bundle-toggle`);if(m?.dataset.bundleId){let e=m.dataset.bundleId;I.has(e)?I.delete(e):I.add(e),g();return}let v=t.closest(`.feed-comment-btn`);if(v?.dataset.eventId){let e=v.dataset.eventId,t=v.closest(`.feed-event`)?.querySelector(`.feed-thread`);if(!t)return;if(t.style.display!==`none`){t.style.display=`none`;return}t.style.display=`block`,z[e]?G(t,e,z[e]):(t.innerHTML=`<div style="font-size:0.82rem; color:var(--text-secondary); padding:6px 0;">${h(`feed.commentsLoading`)}</div>`,z[e]=await l(e)||[],G(t,e,z[e]));let n=t.querySelector(`input[name="body"]`);n&&n.focus();return}let y=t.closest(`.feed-comment-delete-btn`);if(y?.dataset.commentId){let e=Number(y.dataset.commentId),t=y.closest(`.feed-comment-row`),n=y.closest(`.feed-thread`),r=n?.dataset.eventId;t&&t.remove(),r&&z[r]&&(z[r]=z[r].filter(t=>t.id!==e));let a=r?R.find(e=>e.id===r):null;if(a){a.comment_count=Math.max(0,(a.comment_count||0)-1);let e=((n?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=a.comment_count>0?String(a.comment_count):``)}(await f(e)).ok||i(`Couldn't delete — try again in a moment.`);return}let S=t.closest(`.feed-unshare-btn`);if(S?.dataset.postId){let e=Number(S.dataset.postId);u({title:h(`feed.toastUnshareConfirmTitle`),message:h(`feed.toastUnshareConfirmMessage`),confirmText:h(`feed.toastUnshareConfirmBtn`),onConfirm:async()=>{let t=await b(e);if(!t||!t.ok){i(h(`feed.toastUnshareFailed`));return}await x(),i(h(`feed.toastRemovedFromFeed`))}});return}let C=t.closest(`.feed-repost-btn`);if(C?.dataset.postId){let e=Number(C.dataset.postId),t=C.style.getPropertyValue(`--accent`)||w.muted;C.disabled=!0,C.style.setProperty(`--accent`,w.muted);let n=await p(e);n.ok&&n.body?.status!==`same_user`?(i(n.body?.status===`already_reposted`?h(`feed.toastAlreadyReposted`):h(`feed.toastReposted`)),C.style.setProperty(`--accent`,w.repost),C.innerHTML=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>`,L(C)):n.body?.status===`same_user`?(C.disabled=!1,C.style.setProperty(`--accent`,t),i(h(`feed.toastRepostOwnShare`))):(C.disabled=!1,C.style.setProperty(`--accent`,t),i(h(`feed.toastRepostFailed`)));return}}),e.addEventListener(`submit`,async e=>{let t=e.target;if(!t?.classList?.contains(`feed-comment-form`))return;e.preventDefault();let n=t.dataset.eventId;if(!n)return;let r=t.querySelector(`input[name="body"]`),a=r?.value.trim();if(!a)return;let o=t.querySelector(`.feed-comment-submit`);r&&(r.value=``),o&&(o.disabled=!0);let s=await m(n,a);if(o&&(o.disabled=!1),!s.ok||!s.body?.comment){r&&(r.value=a),i(`Couldn't post comment — try again.`);return}let c=s.body.comment;z[n]||(z[n]=[]),z[n].push(c);let l=t.closest(`.feed-thread`);l&&G(l,n,z[n]);let u=l?.querySelector(`input[name="body"]`);u&&u.focus();let d=R.find(e=>e.id===n);if(d){d.comment_count=(d.comment_count||0)+1;let e=((l?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=String(d.comment_count))}}),g(),x(),e}var q=t();function J(){let e=(0,x.useRef)(null);return(0,x.useEffect)(()=>{let t=e.current;t&&(t.innerHTML=``,t.appendChild(K()))},[]),(0,q.jsx)(`div`,{ref:e})}function Y(e){d(e,(0,x.createElement)(J))}export{Y as mountFeed};
//# sourceMappingURL=mount-CI8WV9d9.js.map