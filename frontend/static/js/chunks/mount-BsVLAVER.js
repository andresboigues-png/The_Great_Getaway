import{i as e}from"./rolldown-runtime-Kw0j5LDr.js";import{r as t,t as n}from"./vendor-react-mHyv4XDd.js";import{$t as r,A as i,C as a,En as o,Gt as s,Kt as c,V as l,Zt as u,bn as d,d as f,f as p,fn as m,gn as h,hn as g,k as _,l as v,ln as y,nn as b,ot as x,p as S,sn as C,st as w,tn as T,u as E,un as D,xn as O,xt as k,yn as A}from"../app.bundle.js";import{t as j}from"./store-BlFt_WN9.js";import{n as M}from"./TripContext-CVd3u4qR.js";var N=e(t(),1);function P(e){let t=0,n=0;for(let r of g.expenses||[])r.tripId===e&&r.isSettlement&&(t+=1,n+=r.euroValue||0);for(let r of g.settlements||[])r.tripId===e&&(t+=1,n+=r.euroValue||r.amount||0);return{count:t,eurTotal:n}}function F(e,t,n,r){let i=n===`global`?``:I(r),a=`
    ...
    `:`
        ...
        `}function I(e){if(g.trips.length===0)return``;let t=g.trips.find(t=>t.id===e),n=t?P(t.id).eurTotal:0,r=g.trips.map(t=>{let n=P(t.id).eurTotal,r=n>0?` — ${y(n,`EUR`)} ${_(`settlement.settledSuffix`)}`:``;return`<option value="${u(t.id)}"${t.id===e?` selected`:``}>${u(t.name)}${r}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&n>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color: var(--accent-blue-deep); font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${y(n,`EUR`)} ${_(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    ...
    `}function R(e){let t={};for(let n of g.expenses||[]){if(n.tripId!==e||n.isSettlement)continue;let r=(n.currency||`EUR`).toUpperCase();t[r]=(t[r]||0)+(n.euroValue??n.value??0)}let n=null,r=-1;for(let[e,i]of Object.entries(t))i>r&&(r=i,n=e);return n}function z(e,t){return!t||t===D().toUpperCase()?``:`<span style="display:block; font-size:0.72rem; font-weight:600; color:var(--text-secondary); margin-top:1px;">≈ ${u(a(C(Math.abs(e),`EUR`,t),t))}</span>`}function B(e,t){let{balances:n,removedFromRoster:r}=f(e),o=new Set(r||[]),{byCurrency:s}=p(e),c=[];for(let[e,t]of Object.entries(s))for(let n of S(t))c.push({from:n.from,to:n.to,amount:n.amount,currency:e});c.sort((e,t)=>e.from.localeCompare(t.from)||e.to.localeCompare(t.to)||e.currency.localeCompare(t.currency));let l=R(e.id),d=E(e),h=d.reduce((e,t)=>e+t.paid,0),g=[...d].sort((e,t)=>t.paid-e.paid)[0],v=Object.entries(n).map(([e,t])=>({name:e,net:t})),b=[...v].sort((e,t)=>e.net-t.net)[0],x=[...v].sort((e,t)=>t.net-e.net)[0],w=u(e?.name||`Trip`),T=h>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    <div style="font-size:0.66rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary); margin-bottom:6px;">${_(`settlement.tripTotal`)} · ${w}</div>
                    <div style="font-size:2rem; font-weight:800; color: var(--text-brand-navy); letter-spacing:-0.02em;">${y(h,`EUR`)}</div>
                </div>
                ${g?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${u(g.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${y(g.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${x&&x.net>.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${u(x.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:#1a6b3c;">+${y(x.net,`EUR`)}</div>
                    </div>
                `:``}
                ${b&&b.net<-.01?`
                    <div class="stl-center-min-120">
                        ...
                        <div class="stl-heading-2">${u(b.name)}</div>
                        <div style="font-size:0.78rem; font-weight:700; color:#a30000;">${y(b.net,`EUR`)}</div>
                    </div>
                `:``}
            </div>
        </div>
        ...
        `}).join(``)||`<p class="text-muted" style="padding: 20px; text-align:center;">${_(`settlement.emptyNoCompanions`)}</p>`,O=c.length===0?`<div style="text-align:center; padding: 40px 20px;"><div style="font-size:2.2rem; margin-bottom:8px;">🥂</div><p style="margin:0; font-weight:800; color:#1a6b3c;">${_(`settlement.allSettledTitle`)}</p><p style="margin:6px 0 0; color:var(--text-secondary); font-size:0.85rem;">${_(`settlement.allSettledBody`)}</p></div>`:c.map(n=>{let r=m(n.currency)?` <span style="font-weight:600; color:var(--text-secondary); font-size:0.8rem;">≈ ${u(y(C(n.amount,n.currency,`EUR`),`EUR`))}</span>`:``;return`
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:16px;">
                <div class="stl-flex-grow-truncate">
                    ...
                    <div style="font-size:1.3rem; font-weight:800; color: var(--text-brand-navy); letter-spacing:-0.01em; margin-top:2px;">${u(a(n.amount,n.currency))}${r}</div>
                </div>
                ${t?`
                    <button class="btn-primary settle-debt-btn" data-trip-id="${u(e.id)}" data-from="${u(n.from)}" data-to="${u(n.to)}" data-amount="${n.amount}" data-currency="${u(n.currency)}"
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:18px; margin-bottom:24px;">
            <div class="card glass stl-card-major">
                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px;">
                    <h3 class="stl-heading-1">${_(`settlement.tripBalancesTitle`)} · ${w}</h3>
            ...
            <div class="card glass stl-card-major">
                <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:12px; margin-bottom:14px;">
                    <div style="min-width:0;">
                        <h3 class="stl-heading-1">${_(`settlement.suggestedPaymentsTitle`)} · ${w}</h3>
                ...
                ${l.map(n=>{let a=r[n],o=a.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                ...
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${i(`settlement.historyDayTotalPlural`,a.length,{amount:y(o,`EUR`)})}</span>
                            </div>
                            <div class="stl-flex-col-8">
                                ${a.map(n=>{let r=(n.who||`?`).charAt(0).toUpperCase(),i=n.method&&n.source===`settlement`?`<span style="display:inline-flex; align-items:center; gap:3px; background:rgba(0,113,227,0.08); color:var(--accent-blue-deep); padding:1px 8px; border-radius:999px; font-size:0.62rem; font-weight:700; text-transform:uppercase; letter-spacing:0.05em;">${u(n.method.replace(/_/g,` `))}</span>`:``,a=n.note&&n.source===`settlement`?`<div style="font-size:0.78rem; color:var(--text-secondary); margin-top:4px; font-style:italic;">"${u(n.note)}"</div>`:``,o=t&&n.source===`expense`?`<button class="edit-settlement-btn" data-settlement-id="${u(n.id)}" type="button"
                                                style="background:rgba(0,113,227,0.08); border:1px solid rgba(0,113,227,0.22); color: var(--accent-blue-deep); padding:5px 12px; border-radius:999px; font-size:0.72rem; font-weight:800; cursor:pointer;">${_(`settlement.historyEditBtn`)}</button>`:``,s=t?`<button class="unsettle-settlement-btn" data-settlement-id="${u(n.id)}" data-source="${u(n.source)}" data-trip-id="${u(e.id)}" type="button"
                                        ...
                                        <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background: var(--card-bg); border:1px solid var(--border-subtle); border-radius:14px;">
                                            <div style="width:34px; height:34px; border-radius:50%; background:rgba(52,199,89,0.12); color:#1a6b3c; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:0.95rem; flex-shrink:0;">${u(r)}</div>
                                            <div class="stl-flex-grow-truncate">
                                                <div class="stl-flex-row-wrap-6">
    ...
    `}function U(){let e=v(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),n=Math.max(...Object.values(e).map(Math.abs),1),r=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
            <div class="card glass" style="padding: 48px 32px; text-align:center; border-radius: 28px; border:1.5px dashed rgba(0,113,227,0.3); background: rgba(0,113,227,0.04);">
                <div style="font-size:2.5rem; margin-bottom: 8px;">🌍</div>
        ...
        `:``}
    `}var W=new Set;async function G(e,t,n,i,a,s){if(t===n){b(_(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(i)||i<=0){b(_(`settlement.toastAmountInvalid`));return}if(typeof navigator<`u`&&navigator.onLine===!1){b(_(`errors.offline`));return}let c=C(i,a,`EUR`),u=g.trips.find(t=>t.id===e),d=A(u,t),f=A(u,n),p=`${e}::${t}::${n}::${i}`;if(!W.has(p)){W.add(p);try{if(d&&f){let r=await x({tripId:e,fromUserId:d,toUserId:f,amount:i,currency:a,euroValue:c,...s?.method?{method:s.method}:{},...s?.note?{note:s.note}:{}});r.settlement?(g.settlements=[...g.settlements,r.settlement],h(o.STATE_CHANGED),b(_(`settlement.toastRecordedNotified`,{amount:y(c,`EUR`),from:t,to:n}))):(console.warn(`[settlement] /api/settlements failed:`,r.error),b(_(`settlement.toastSettlementFailed`,{error:r.error||_(`settlement.toastSettlementFailedNetwork`)})),h(o.STATE_CHANGED));return}let u={id:r(),tripId:e,label:_(`settlement.settlementLabel`,{from:t,to:n}),value:i,euroValue:c,currency:a,who:t,categoryId:g.categories[0]?.id??``,country:_(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[n]:100},isSettlement:!0};g.expenses=[...g.expenses,u],h(o.STATE_CHANGED),l(u),b(_(`settlement.toastRecorded`,{amount:y(c,`EUR`),from:t,to:n}))}finally{W.delete(p)}}}async function K(e,t=`expense`){s({title:_(`settlement.toastUnsettleConfirmTitle`),message:_(`settlement.toastUnsettleConfirmMessage`),confirmText:_(`settlement.toastUnsettleConfirmBtn`),onConfirm:()=>{(async()=>{if(t===`settlement`){let t=await w(e);if(t.error){console.warn(`[settlement] delete failed:`,t.error),b(`Couldn't undo: ${t.error||`Network error`}`);return}g.settlements=g.settlements.filter(t=>t.id!==e),h(o.STATE_CHANGED);return}g.expenses=g.expenses.filter(t=>t.id!==e),h(o.STATE_CHANGED)})()}})}var q=[{value:`cash`,labelKey:`settlement.methodCash`},{value:`revolut`,labelKey:`settlement.methodRevolut`},{value:`bank_transfer`,labelKey:`settlement.methodBankTransfer`},{value:`wise`,labelKey:`settlement.methodWise`},{value:`paypal`,labelKey:`settlement.methodPayPal`},{value:`custom`,labelKey:`settlement.methodCustom`}];function J(e){let t=g.trips.find(t=>t.id===e),n=O(t).map(e=>`<option value="${u(e)}">${u(e)}</option>`).join(``),r=q.map(e=>`<option value="${u(e.value)}">${u(_(e.labelKey))}</option>`).join(``),i=D(),o=p(t).byCurrency,l=Object.keys(o),d=(R(t?.id??``)||i).toUpperCase(),f=(l.length>0?l:[i.toUpperCase()]).map(e=>`<option value="${u(e)}" ${e===d?`selected`:``}>${u(e)}</option>`).join(``),{root:m,close:h}=c({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                <label class="form-label">${u(_(`settlement.labelFrom`))}</label>
                <select id="manualSettleFrom" class="glass-input stl-card-minor-bg">${n}</select>
                <label class="form-label stl-mt-6">${u(_(`settlement.labelTo`))}</label>
                <select id="manualSettleTo" class="glass-input stl-card-minor-bg">${n}</select>
                <label class="form-label stl-mt-6">${u(_(`settlement.labelAmount`,{currency:d}))}</label>
                <div style="display:flex; gap:8px;">
                    ...
                    <select id="manualSettleCurrency" class="glass-input stl-card-minor-bg" style="flex:1;" aria-label="${u(_(`settlement.labelAmount`,{currency:``}))}">${f}</select>
                </div>
                <label class="form-label stl-mt-6">${u(_(`settlement.labelMethod`))}</label>
                <select id="manualSettleMethod" class="glass-input stl-card-minor-bg">${r}</select>
                <label class="form-label stl-mt-6">${u(_(`settlement.labelNote`))} <span class="text-subtitle" style="font-weight:500;">${u(_(`settlement.labelNoteOptional`))}</span></label>
                <input type="text" id="manualSettleNote" class="glass-input" maxlength="240" placeholder="${u(_(`settlement.notePlaceholder`))}" class="stl-card-minor">
                <div style="display:flex; gap: var(--space-3); margin-top: var(--space-4);">
                    <button type="button" id="cancelManualSettleBtn" class="btn-neutral" style="flex:1; border-radius: var(--radius-lg);">${u(_(`settlement.cancelBtn`))}</button>
                    <button type="submit" class="btn-primary" style="flex:2; border-radius: var(--radius-lg);">${u(_(`settlement.recordPaymentBtn`))}</button>
                </div>
            </form>
        `});T(m,`#cancelManualSettleBtn`).onclick=()=>h(),T(m,`#manualSettleForm`).onsubmit=n=>{n.preventDefault();let r=T(m,`#manualSettleFrom`).value,o=T(m,`#manualSettleTo`).value,c=parseFloat(T(m,`#manualSettleAmount`).value),l=(T(m,`#manualSettleCurrency`)?.value||i).toUpperCase(),u=T(m,`#manualSettleMethod`).value,d=T(m,`#manualSettleNote`).value.trim();if(r===o){b(_(`settlement.toastSenderEqualsReceiver`));return}let f=Y(t,r,o,l),p=()=>{G(e,r,o,c,l,{method:u,note:d}),h()};if(c>f+.005){s({title:_(`settlement.overpayConfirmTitle`),message:f>.005?_(`settlement.overpayConfirmBody`,{amount:a(c,l),owed:a(f,l),from:r,to:o}):_(`settlement.overpayConfirmBodyNone`,{amount:a(c,l),from:r,to:o}),confirmText:_(`settlement.overpayConfirmBtn`),onConfirm:p});return}p()}}function Y(e,t,n,r){if(!e)return 0;let{byCurrency:i}=p(e),a=i[(r||`EUR`).toUpperCase()];if(!a)return 0;let o=S(a).find(e=>e.from===t&&e.to===n);return o?o.amount:0}function X(e){let t=g.expenses.find(t=>t.id===e);if(!t)return;let n=O(g.trips.find(e=>e.id===t.tripId)),r=n.map(e=>`<option value="${u(e)}" ${t.who===e?`selected`:``}>${u(e)}</option>`).join(``),i=Object.keys(t.splits||{})[0],a=n.map(e=>`<option value="${u(e)}" ${i===e?`selected`:``}>${u(e)}</option>`).join(``),s=D(),{root:d,close:f}=c({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
