import{r as e,t}from"./vendor-react-CYVQMBjw.js";import{B as n,G as r,K as i,X as a,a as o,c as s,d as c,h as l,i as u,l as d,q as f,s as p,t as m,u as h,v as g,y as _}from"../app.bundle.js";var v=e(),y=new Set([`friend_shared_trip`,`friend_reposted_trip`]),b=new Set([`friend_created_trip`,`friend_archived_trip`,`friend_joined_trip`,`new_friendship`]),x={muted:`142,142,147`,like:`255,59,48`,comment:`0,113,227`,repost:`52,199,89`,bookmark:`255,149,0`};function S(e){if(!e)return``;let t=typeof e==`string`&&e.includes(` `)&&!e.includes(`T`)?e.replace(` `,`T`)+`Z`:e,n=new Date(t);return Number.isNaN(n.getTime())?``:n.toISOString().slice(0,10)}function C(e){let t=new Map,n=[];for(let r of e){if(y.has(r.type)){n.push(r);continue}let e=`${r.actor?.id||`anon`}|${r.type}|${S(r.when)}`,i=t.get(e);i||(i=[],t.set(e,i),n.push({__slot:e})),i.push(r)}return n.map(e=>{let n=e.__slot;if(!n)return e;let r=t.get(n)||[];if(r.length===1)return r[0];let i=r[0];return{bundled:!0,id:`bundle_${n}`,type:i.type,actor:i.actor,when:i.when,members:r}})}function w(e){let t=`<strong style="color:#002d5b;">${n(e.actor.name)}</strong>`,r=e.members.length,i=r===1?`trip`:`trips`;switch(e.type){case`friend_created_trip`:return`${t} started planning <strong style="color:#002d5b;">${r} new ${i}</strong>`;case`friend_archived_trip`:return`${t} just completed <strong style="color:#002d5b;">${r} ${i}</strong> 🎉`;case`friend_joined_trip`:return`${t} joined <strong style="color:#002d5b;">${r} ${i}</strong>`;case`new_friendship`:return`You and <strong style="color:#002d5b;">${r} new people</strong> are now friends 🤝`;default:return`${t} did ${r} new things`}}function T(e,t=44){let r=(e?.name||`?`).charAt(0).toUpperCase(),i=`<div style="width:${t}px; height:${t}px; border-radius:50%; background: var(--gradient-day); color:white; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:${Math.round(t*.4)}px; flex-shrink:0; box-shadow: 0 2px 8px rgba(0,113,227,0.18);">${n(r)}</div>`,a=e?.picture?`<img src="${n(e.picture)}" alt="" referrerpolicy="no-referrer"
    ...
    `;let t=()=>{let i=r(e,`#feedList`);if(!i)return;let o=e=>L===`posts`?y.has(e.type):b.has(e.type),s=F.filter(e=>!(!o(e)||R&&!e.is_bookmarked));if(s.length===0){let r,a,o,s;R?(r=L===`posts`?`No bookmarked posts yet`:`No bookmarked actions yet`,a=`Tap 🔖 on any card to save it for later — bookmarks are private and never expire.`,o=`Show all`,s=()=>{R=!1;let n=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);n&&(n.checked=!1),t()}):L===`posts`?(r=`No posts yet`,a=`Posts are trips your friends shared (or reposted) for the world to see. Share one of your own from the trip header to kick things off — or check the <strong>Actions</strong> tab for what's been happening behind the scenes.`,o=`See Actions`,s=()=>{L=`actions`,t(),e.querySelectorAll(`.home-tabnav__tab`).forEach(e=>e.classList.toggle(`is-active`,e.dataset.feedTab===`actions`))}):(r=`Quiet over here`,a=`When your friends create trips, complete adventures or join in on plans, you'll see it here. Add more friends in <strong>Your network</strong> to grow the feed.`,o=`Go to Your network`,s=()=>l(`friends`)),i.innerHTML=`
                <div class="card glass" style="padding: 32px; border-radius: 24px; border: 1.5px dashed rgba(155, 89, 182, 0.35); background: rgba(155, 89, 182, 0.04); text-align:center;">
                    ...
                    <h3 style="margin:0 0 8px; color:#7c3a9e; font-weight:800; font-size: 1.1rem;">${n(r)}</h3>
                    <p style="margin:0; color:var(--text-secondary); font-size:0.9rem; line-height:1.5;">${a}</p>
                    <button id="feedEmptyCtaBtn" class="btn-primary" style="margin-top: 16px; padding: 10px 22px; border-radius: 999px;">${n(o)}</button>
                </div>
            `;let c=i.querySelector(`#feedEmptyCtaBtn`);c&&(c.onclick=s);return}let c=a.user?.id;i.innerHTML=C(s).map(e=>{if(e.bundled){let t=e,r=O(t.type),i=E(t.when),a=N.has(t.id),o=t.members.map(e=>{let t=D(e),r=!!e.is_bookmarked;return`
            ...
            `}).join(``)},_=async()=>{if(a.user)try{let e=await m(`/api/feed`);if(!e.ok)return;let n=await e.json();Array.isArray(n)&&(F=n,t())}catch(e){console.error(`Feed refresh failed:`,e)}};e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(n=>{n.onclick=()=>{let r=n.dataset.feedTab;!r||L===r||(L=r,e.querySelectorAll(`.home-tabnav__tab[data-feed-tab]`).forEach(e=>{e.classList.toggle(`is-active`,e.dataset.feedTab===r)}),t())}});let v=e.querySelector(`#feedBookmarkToggle .apple-toggle__input`);return v&&v.addEventListener(`change`,()=>{R=!!v.checked,t()}),e.addEventListener(`click`,async e=>{let n=e.target;if(!n)return;let r=n.closest(`.feed-avatar-btn`);if(r?.dataset.feedAvatarUserId){l(`profile`,{userId:r.dataset.feedAvatarUserId});return}let a=n.closest(`.feed-trip-card`);if(a?.dataset.tripId){g(a.dataset.tripId);return}let p=n.closest(`.feed-like-btn`);if(p?.dataset.eventId){let e=p.dataset.eventId,t=p.dataset.liked===`1`,n=!t,r=F.find(t=>t.id===e);r&&(r.is_liked=n,r.like_count=Math.max(0,(r.like_count||0)+(t?-1:1))),p.dataset.liked=n?`1`:`0`,p.style.setProperty(`--accent`,n?x.like:x.muted),p.innerHTML=k(`heart`,n),P(p);let i=p.parentElement?.querySelector(`.feed-action-count`),a=e=>e>=3?String(e):``;i&&r&&(i.textContent=a(r.like_count??0));let o=await h(e);o.ok&&o.body&&r&&(r.is_liked=!!o.body.liked,r.like_count=Number(o.body.count)||0,i&&(i.textContent=a(r.like_count)));return}let m=n.closest(`.feed-bookmark-btn`);if(m?.dataset.eventId){let e=m.dataset.eventId,n=m.dataset.bookmarked!==`1`,r=F.find(t=>t.id===e);r&&(r.is_bookmarked=n),m.dataset.bookmarked=n?`1`:`0`,m.style.setProperty(`--accent`,n?x.bookmark:x.muted),m.innerHTML=k(`bookmark`,n),P(m),R&&!n&&t(),await d(e);return}let v=n.closest(`.feed-bundle-toggle`);if(v?.dataset.bundleId){let e=v.dataset.bundleId;N.has(e)?N.delete(e):N.add(e),t();return}let y=n.closest(`.feed-comment-btn`);if(y?.dataset.eventId){let e=y.dataset.eventId,t=y.closest(`.feed-event`)?.querySelector(`.feed-thread`);if(!t)return;if(t.style.display!==`none`){t.style.display=`none`;return}t.style.display=`block`,I[e]?z(t,e,I[e]):(t.innerHTML=`<div style="font-size:0.82rem; color:var(--text-secondary); padding:6px 0;">Loading…</div>`,I[e]=await o(e)||[],z(t,e,I[e]));let n=t.querySelector(`input[name="body"]`);n&&n.focus();return}let b=n.closest(`.feed-comment-delete-btn`);if(b?.dataset.commentId){let e=Number(b.dataset.commentId),t=b.closest(`.feed-comment-row`),n=b.closest(`.feed-thread`),r=n?.dataset.eventId;t&&t.remove(),r&&I[r]&&(I[r]=I[r].filter(t=>t.id!==e));let i=r?F.find(e=>e.id===r):null;if(i){i.comment_count=Math.max(0,(i.comment_count||0)-1);let e=((n?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=i.comment_count>0?String(i.comment_count):``)}(await u(e)).ok||f(`Couldn't delete — try again in a moment.`);return}let S=n.closest(`.feed-unshare-btn`);if(S?.dataset.postId){let e=Number(S.dataset.postId);i({title:`Unshare this trip?`,message:`It'll disappear from your friends' feeds. Any reposts of it will be removed too. This can't be undone.`,confirmText:`Unshare`,onConfirm:async()=>{let t=await c(e);if(!t||!t.ok){f(`Couldn't unshare — try again in a moment.`);return}await _(),f(`Removed from your feed.`)}});return}let C=n.closest(`.feed-repost-btn`);if(C?.dataset.postId){let e=Number(C.dataset.postId),t=C.style.getPropertyValue(`--accent`)||x.muted;C.disabled=!0,C.style.setProperty(`--accent`,x.muted);let n=await s(e);n.ok&&n.body?.status!==`same_user`?(f(n.body?.status===`already_reposted`?`Already reposted`:`Reposted to your feed`),C.style.setProperty(`--accent`,x.repost),C.innerHTML=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>`,P(C)):n.body?.status===`same_user`?(C.disabled=!1,C.style.setProperty(`--accent`,t),f(`That's your own share — no need to repost it.`)):(C.disabled=!1,C.style.setProperty(`--accent`,t),f(`Repost failed — try again in a moment.`));return}}),e.addEventListener(`submit`,async e=>{let t=e.target;if(!t?.classList?.contains(`feed-comment-form`))return;e.preventDefault();let n=t.dataset.eventId;if(!n)return;let r=t.querySelector(`input[name="body"]`),i=r?.value.trim();if(!i)return;let a=t.querySelector(`.feed-comment-submit`);r&&(r.value=``),a&&(a.disabled=!0);let o=await p(n,i);if(a&&(a.disabled=!1),!o.ok||!o.body?.comment){r&&(r.value=i),f(`Couldn't post comment — try again.`);return}let s=o.body.comment;I[n]||(I[n]=[]),I[n].push(s);let c=t.closest(`.feed-thread`);c&&z(c,n,I[n]);let l=c?.querySelector(`input[name="body"]`);l&&l.focus();let u=F.find(e=>e.id===n);if(u){u.comment_count=(u.comment_count||0)+1;let e=((c?.closest(`.feed-event`))?.querySelector(`.feed-comment-btn`))?.parentElement?.querySelector(`.feed-action-count`);e&&(e.textContent=String(u.comment_count))}}),t(),_(),e}var V=t();function H(){let e=(0,v.useRef)(null);return(0,v.useEffect)(()=>{let t=e.current;t&&(t.innerHTML=``,t.appendChild(B()))},[]),(0,V.jsx)(`div`,{ref:e})}function U(e){_(e,(0,v.createElement)(H))}export{U as mountFeed};
//# sourceMappingURL=mount-BuHWSfH6.js.map