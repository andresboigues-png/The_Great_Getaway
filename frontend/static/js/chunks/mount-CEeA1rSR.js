import{r as e,t}from"./vendor-react-CAxw18f3.js";import{At as n,Et as r,Ht as i,Lt as a,Ot as o,Rt as s,St as c,Tt as l,bt as u,et as d,f,jt as p,qt as m,v as h,wt as g,y as _,yt as v}from"../app.bundle.js";import{t as y}from"./store-Bk7vSRF-.js";var b=e();function x(e){if(!e)return{balances:{},roster:[],expenses:[]};let t=(a.expenses||[]).filter(t=>t.tripId===e.id),n=i(e),r=n.length>0?n:Array.from(new Set(t.flatMap(e=>[e.who,...Object.keys(e.splits||{})]).filter(Boolean))),o={};r.forEach(e=>o[e]=0);for(let e of t){let t=e.euroValue||e.value||0;if(o[e.who]!==void 0&&(o[e.who]+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,r]of Object.entries(e.splits))o[n]!==void 0&&(o[n]-=t*(Number(r)/100));else{let e=t/Math.max(r.length,1);r.forEach(t=>{o[t]!==void 0&&(o[t]-=e)})}}return{balances:o,roster:r,expenses:t}}function S(e){let t=[],n=[];for(let[r,i]of Object.entries(e))i>.01?t.push({person:r,amount:i}):i<-.01&&n.push({person:r,amount:Math.abs(i)});t.sort((e,t)=>t.amount-e.amount),n.sort((e,t)=>t.amount-e.amount);let r=[],i=0,a=0;for(;i<n.length&&a<t.length;){let e=n[i],o=t[a],s=Math.min(e.amount,o.amount);r.push({from:e.person,to:o.person,amount:s}),e.amount-=s,o.amount-=s,e.amount<.01&&i++,o.amount<.01&&a++}return r}function C(){let e={};for(let t of[...a.trips,...a.archivedTrips||[]])for(let n of i(t))n in e||(e[n]=0);let t=(a.archivedTrips||[]).flatMap(e=>e.expenses||[]),n=[...a.expenses,...t],r={};for(let e of[...a.trips,...a.archivedTrips||[]])r[e.id]=i(e);for(let t of n){let n=t.euroValue||t.value||0;if(e[t.who]!==void 0&&(e[t.who]+=n),t.splits&&Object.keys(t.splits).length>0)for(let[r,i]of Object.entries(t.splits))e[r]!==void 0&&(e[r]-=n*(Number(i)/100));else{let i=r[t.tripId]||[],a=i.length>0?i:Array.from(new Set([t.who,...Object.keys(t.splits||{})].filter(Boolean))),o=n/Math.max(a.length,1);a.forEach(t=>{e[t]!==void 0&&(e[t]-=o)})}}return e}function w(e){if(!e)return[];let t=(a.expenses||[]).filter(t=>t.tripId===e.id),n=i(e),r={};n.forEach(e=>r[e]={paid:0,share:0});for(let e of t){let t=e.euroValue||e.value||0;if(r[e.who]&&(r[e.who].paid+=t),e.splits&&Object.keys(e.splits).length>0)for(let[n,i]of Object.entries(e.splits))r[n]&&(r[n].share+=t*(Number(i)/100));else{let e=t/Math.max(n.length,1);n.forEach(t=>{r[t]&&(r[t].share+=e)})}}return Object.entries(r).map(([e,t])=>({name:e,paid:t.paid,share:t.share,net:t.paid-t.share}))}function T(e,t,n,r){let i=E(r),a=`
        <div class="ai-page-header">
            <h1 class="gradient-text" style="--g-from: #ffd60a; --g-to: #ff9f0a;">${h(`settlement.title`)}</h1>
            <p>${h(`settlement.subtitle`)}</p>
        </div>
        ${i}
    `;return e?`
        ${a}
    ...
    `:`
            ...
            <div class="card glass" style="text-align: center; padding: 60px 32px; margin-top: 24px; border-radius: 28px;">
                ...
                <h2 style="margin:0 0 6px;">${h(`settlement.noTripsTitle`)}</h2>
                <p class="text-muted">${h(`settlement.noTripsBody`)}</p>
            </div>
        `}function E(e){if(a.trips.length===0)return``;let t=a.trips.find(t=>t.id===e),r=t?(a.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0):0,i=a.trips.map(t=>{let r=(a.expenses||[]).filter(e=>e.tripId===t.id&&e.isSettlement).reduce((e,t)=>e+(t.euroValue||0),0),i=r>0?` — ${n(r,`EUR`)} ${h(`settlement.settledSuffix`)}`:``;return`<option value="${c(t.id)}"${t.id===e?` selected`:``}>${c(t.name)}${i}</option>`}).join(``);return`
        <div class="settlement-trip-picker" style="margin-top: 18px; margin-bottom: 16px; display:flex; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            ${t&&r>0?`
                <span style="display:inline-flex; align-items:center; padding:6px 12px; border-radius:999px; background:rgba(0,113,227,0.08); color:#005bb8; font-size:0.78rem; font-weight:800; flex-shrink:0;">
                    ${n(r,`EUR`)} ${h(`settlement.settledSuffix`)}
                </span>
            `:``}
        </div>
    `}function D(e,t){let n=(a.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).length,r=(e,n,r)=>`
    ...
    `;return`
        <nav style="display:flex; gap:36px; border-bottom: 1px solid rgba(0,113,227,0.25); margin: 22px 0 22px; padding: 0 4px;">
            ${r(`trip`,h(`settlement.tabThisTrip`))}
            ${r(`history`,h(`settlement.tabHistory`),n)}
            ${r(`global`,h(`settlement.tabCrossTrip`))}
        </nav>
    `}function O(e,t){let{balances:r}=x(e),i=S(r),a=w(e),o=a.reduce((e,t)=>e+t.paid,0),s=[...a].sort((e,t)=>t.paid-e.paid)[0],l=[...a].sort((e,t)=>e.net-t.net)[0],u=[...a].sort((e,t)=>t.net-e.net)[0],d=o>0?`
        <div class="card glass" style="margin-bottom: 18px; padding: 22px 26px; border-radius: 28px; background: linear-gradient(135deg, rgba(255,214,10,0.05), rgba(255,159,10,0.03)); border:1px solid rgba(255,159,10,0.18);">
            <div style="display:flex; flex-wrap:wrap; gap:24px; align-items:center; justify-content:space-between;">
                <div style="min-width:0;">
                    ...
                    <div style="font-size:2rem; font-weight:800; color:#002d5b; letter-spacing:-0.02em;">${n(o,`EUR`)}</div>
                </div>
                ${s?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:0.78rem; font-weight:700; color:var(--text-secondary);">${n(s.paid,`EUR`)}</div>
                    </div>
                `:``}
                ${u&&u.net>.01?`
                    <div style="text-align:center; min-width:120px;">
                        ...
                        <div style="font-size:1.1rem; font-weight:800; color:#002d5b; margin-top:4px;">${c(u.name)}</div>
    ...
    `:``,f=Object.entries(r).map(([e,t])=>{let r=t>.01,i=t<-.01;return`
            ...
            <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:16px;">
                <div style="flex:1; min-width:0;">
                    <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                        <span style="font-weight:700; color:var(--text-secondary); font-size:0.78rem;">${c(r.from)}</span>
                        <span style="color:rgba(0,0,0,0.3);">→</span>
                        <span style="font-weight:800; color:#002d5b; font-size:0.95rem;">${c(r.to)}</span>
                    </div>
                    <div style="font-size:1.3rem; font-weight:800; color:#002d5b; letter-spacing:-0.01em; margin-top:2px;">${n(r.amount,`EUR`)}</div>
                </div>
                ${t?`
                    <button class="btn-primary settle-debt-btn" data-trip-id="${c(e.id)}" data-from="${c(r.from)}" data-to="${c(r.to)}" data-amount="${r.amount}"
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:18px; margin-bottom:24px;">
            <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px;">
                    ...
                    <span style="font-size:0.7rem; font-weight:800; color:var(--text-secondary); text-transform:uppercase; letter-spacing:0.1em;">${_(`settlement.peopleCount`,Object.keys(r).length)}</span>
                </div>
        ...
        `:``}
    `}function k(e,t){let r=(a.expenses||[]).filter(t=>t.tripId===e.id&&t.isSettlement).sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime());if(r.length===0)return`
        ...
        `;let i={};for(let e of r){let t=e.date||`undated`;i[t]||(i[t]=[]),i[t].push(e)}let o=new Date().toISOString().slice(0,10),s=new Date;s.setDate(s.getDate()-1);let l=s.toISOString().slice(0,10),u=e=>{if(e===`undated`)return h(`settlement.historyDateNoDate`);if(e===o)return h(`settlement.historyDateToday`);if(e===l)return h(`settlement.historyDateYesterday`);let t=new Date(e);return isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{weekday:`short`,month:`short`,day:`numeric`,year:`numeric`})},d=Object.keys(i).sort((e,t)=>e===`undated`?1:t===`undated`?-1:t.localeCompare(e));return`
        <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:16px;">
                ...
                <span style="font-size:0.7rem; font-weight:800; color:var(--text-secondary); text-transform:uppercase; letter-spacing:0.1em;">${h(`settlement.historyRecorded`,{count:r.length})}</span>
            </div>
            <div style="display:flex; flex-direction:column; gap:18px;">
                ${d.map(r=>{let a=i[r],o=a.reduce((e,t)=>e+(t.euroValue||0),0);return`
                        <div>
                            <div style="display:flex; align-items:baseline; justify-content:space-between; margin-bottom:8px; padding: 0 4px;">
                                <h4 style="margin:0; font-size:0.7rem; font-weight:800; text-transform:uppercase; letter-spacing:0.12em; color:var(--text-secondary);">${c(u(r))}</h4>
                                <span style="font-size:0.72rem; font-weight:700; color:var(--text-secondary);">${_(`settlement.historyDayTotalPlural`,a.length,{amount:n(o,`EUR`)})}</span>
                            </div>
                            <div style="display:flex; flex-direction:column; gap:8px;">
                                ${a.map(r=>{let i=Object.keys(r.splits||{})[0]||`?`;return`
                                        <div style="display:flex; align-items:center; gap:14px; padding:12px 14px; background:white; border:1px solid rgba(0,0,0,0.06); border-radius:14px;">
                                            <div style="width:34px; height:34px; border-radius:50%; background:rgba(52,199,89,0.12); color:#1a6b3c; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:0.95rem; flex-shrink:0;">${c((r.who||`?`).charAt(0).toUpperCase())}</div>
                                            <div style="flex:1; min-width:0;">
                                                <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                                                    <span style="font-weight:800; color:#002d5b; font-size:0.95rem;">${c(r.who)}</span>
                                                    <span style="color:rgba(0,0,0,0.3); font-weight:600;">→</span>
                                                    <span style="font-weight:800; color:#002d5b; font-size:0.95rem;">${c(i)}</span>
                                            ...
                                            ${t?`
                                                <div style="display:flex; gap:6px; flex-shrink:0;">
                                                    <button class="edit-settlement-btn" data-settlement-id="${c(r.id)}" type="button"
                                                    ...
                                                    <button class="unsettle-settlement-btn" data-settlement-id="${c(r.id)}" data-trip-id="${c(e.id)}" type="button"
    ...
    `}function A(){let e=C(),t=Object.entries(e).sort((e,t)=>t[1]-e[1]),r=Math.max(...Object.values(e).map(Math.abs),1),i=t.some(([,e])=>Math.abs(e)>.01);if(t.length===0)return`
        ...
        <div class="card glass" style="padding: 22px 24px; border-radius: 28px;">
            ...
            <div style="display:flex; flex-direction:column; gap:8px;">
                ${t.map(([e,t])=>{let a=i?Math.min(Math.abs(t)/r*100,100):0,o=t>.01,s=t<-.01,l=o?`#1a6b3c`:s?`#a30000`:`var(--text-secondary)`;return`
        ...
        `:``}
    `}function j(e,t,i,c,l){if(t===i){r(h(`settlement.toastSenderEqualsReceiver`));return}if(!Number.isFinite(c)||c<=0){r(h(`settlement.toastAmountInvalid`));return}let u=o(c,l,`EUR`),d={id:g(),tripId:e,label:`Settlement: ${t} → ${i}`,value:c,euroValue:u,currency:l,who:t,categoryId:a.categories[0]?.id??``,country:h(`settlement.expenseCountry`),date:new Date().toISOString().split(`T`)[0]??``,splits:{[i]:100},isSettlement:!0};a.expenses.push(d),s(m.STATE_CHANGED),r(`Recorded ${n(u,`EUR`)} ${t} → ${i}`)}function M(e){v({title:h(`settlement.toastUnsettleConfirmTitle`),message:h(`settlement.toastUnsettleConfirmMessage`),confirmText:h(`settlement.toastUnsettleConfirmBtn`),onConfirm:()=>{a.expenses=a.expenses.filter(t=>t.id!==e),s(m.STATE_CHANGED)}})}function N(e){let t=i(a.trips.find(t=>t.id===e)).map(e=>`<option value="${c(e)}">${c(e)}</option>`).join(``),n=p(),{root:o,close:s}=u({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            <h2 class="h2-display">${h(`settlement.manualTitle`)}</h2>
            ...
            <form id="manualSettleForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">Amount (${c(n)})</label>
        ...
        `});l(o,`#cancelManualSettleBtn`).onclick=()=>s(),l(o,`#manualSettleForm`).onsubmit=t=>{t.preventDefault();let i=l(o,`#manualSettleFrom`).value,a=l(o,`#manualSettleTo`).value,c=parseFloat(l(o,`#manualSettleAmount`).value);if(i===a){r(h(`settlement.toastSenderEqualsReceiver`));return}j(e,i,a,c,n),s()}}function P(e){let t=a.expenses.find(t=>t.id===e);if(!t)return;let n=i(a.trips.find(e=>e.id===t.tripId)),d=n.map(e=>`<option value="${c(e)}" ${t.who===e?`selected`:``}>${c(e)}</option>`).join(``),f=Object.keys(t.splits||{})[0],g=n.map(e=>`<option value="${c(e)}" ${f===e?`selected`:``}>${c(e)}</option>`).join(``),_=p(),{root:v,close:y}=u({variant:`glass-light`,cardStyle:`width: 440px; max-width: calc(100vw - 32px);`,innerHTML:`
            ...
            <form id="editSettlementForm" style="display:flex; flex-direction:column; gap: var(--space-3); margin-top: var(--space-4);">
                ...
                <label class="form-label" style="margin-top:6px;">To</label>
                <select id="editSettleTo" class="glass-input" style="padding: var(--space-3); border-radius: 12px; background:white;">${g}</select>
                <label class="form-label" style="margin-top:6px;">Amount (${c(_)})</label>
                <input type="number" step="0.01" min="0.01" id="editSettleAmount" value="${o(t.euroValue||0,`EUR`,_).toFixed(2)}" class="glass-input" required style="padding: var(--space-3); border-radius: 12px;">
